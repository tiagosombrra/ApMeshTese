...
double SUAVIZACAO = 5; // número de vezes que se dará a suavização laplaciana
...
//==============================================================================
    // ============================= Patch 1 ===================================
        ...
        Ponto* p00 = new Vertice ( -3.0, -3.0,  0.0 );
        Ponto* p10 = new Vertice ( -1.0, -3.0,  0.0 );
        Ponto* p20 = new Vertice (  1.0, -3.0,  0.0 );
        Ponto* p30 = new Vertice (  3.0, -3.0,  0.0 );

        Ponto* p01 = new Vertice ( -3.0, -1.0,  0.0 );
        Ponto* p11 = new Vertice ( -1.0, -1.0,  0.01 );
        Ponto* p21 = new Vertice (  1.0, -1.0,  0.0 );
        Ponto* p31 = new Vertice (  3.0, -1.0,  0.0 );

        Ponto* p02 = new Vertice ( -3.0,  1.0,  0.0 );
        Ponto* p12 = new Vertice ( -1.0,  1.0,  0.0 );
        Ponto* p22 = new Vertice (  1.0,  1.0,  0.0 );
        Ponto* p32 = new Vertice (  3.0,  1.0,  0.0 );

        Ponto* p03 = new Vertice ( -3.0,  3.0,  0.0 );
        Ponto* p13 = new Vertice ( -1.0,  3.0,  0.0 );
        Ponto* p23 = new Vertice (  1.0,  3.0,  0.0 );
        Ponto* p33 = new Vertice (  3.0,  3.0,  0.0 );
...
//==============================================================================
        ...
        /*Ponto* p1 = new Noh ( -0.5, 0.5, 0.0 );
        Ponto* p2 = new Noh ( -0.5, -0.5, 0.0 );

        Ponto* p3 = new Noh ( 0.5, 0.5, 0.0 );
        Ponto* p4 = new Noh ( 0.5, -0.5, 0.0 );

        Vetor* Qu1 = new Vetor ( 0.0, 0.0, 10.0 );
        Vetor* Qu2 = new Vetor ( 0.0, 0.0, -10.0 );

        Vetor* v1 = new Vetor ( -1.0, 1.0, 0.0 );
        Vetor* v2 = new Vetor ( 1.0, 1.0, 0.0 );

        Vetor* tw100 = new Vetor ( -10.0, 10.0, 10.0 );
        Vetor* tw110 = new Vetor ( -10.0, -10.0, 10.0 );
        Vetor* tw101 = new Vetor ( 10.0, 10.0, 10.0 );
        Vetor* tw111 = new Vetor ( 10.0, -10.0, 10.0 );

        Vetor* tw200 = new Vetor ( -10.0, 10.0, -10.0 );
        Vetor* tw210 = new Vetor ( -10.0, -10.0, -10.0 );
        Vetor* tw201 = new Vetor ( 10.0, 10.0, -10.0 );
        Vetor* tw211 = new Vetor ( 10.0, -10.0, -10.0 );

        Curva* c1 = new CurvParamHermite ( *p1, *p3, *Qu1, *Qu2 );
        Curva* c2 = new CurvParamHermite ( *p3, *p4, *v2, *v1 );
        Curva* c3 = new CurvParamHermite ( *p2, *p4, *Qu1, *Qu2 );
        Curva* c4 = new CurvParamHermite ( *p1, *p2, *v1, *v2 );
        Curva* c5 = new CurvParamHermite ( *p3, *p1, *Qu2, *Qu1 );
        Curva* c6 = new CurvParamHermite ( *p4, *p2, *Qu2, *Qu1 );

        Patch* patch1 = new HermitePatch ( c1, c2, c3, c4, *tw100, *tw101, *tw110, *tw111 );
        Patch* patch2 = new HermitePatch ( c5, c4, c6, c2, *tw201, *tw200, *tw211, *tw210 );
        ...
        /*Matriz Gx (((HermitePatch*)patch1)->getGx());
        Matriz Gy (((HermitePatch*)patch1)->getGy());
        Matriz Gz (((HermitePatch*)patch1)->getGz());

        Matriz H (((HermitePatch*)patch1)->getH());
        Matriz Ht (((HermitePatch*)patch1)->getH().transposta () );

        cout << "-------" << endl;
        cout << "Matriz H:" << endl;
        cout << H.getElem ( 0, 0) << " " << H.getElem ( 0, 1) << " " << H.getElem ( 0, 2) << " " << H.getElem ( 0, 3) << endl;
        cout << H.getElem ( 1, 0) << " " << H.getElem ( 1, 1) << " " << H.getElem ( 1, 2) << " " << H.getElem ( 1, 3) << endl;
        cout << H.getElem ( 2, 0) << " " << H.getElem ( 2, 1) << " " << H.getElem ( 2, 2) << " " << H.getElem ( 2, 3) << endl;
        cout << H.getElem ( 3, 0) << " " << H.getElem ( 3, 1) << " " << H.getElem ( 3, 2) << " " << H.getElem ( 3, 3) << endl;
        cout << "-------" << endl;
        cout << "Matriz Ht:" << endl;
        cout << Ht.getElem ( 0, 0) << " " << Ht.getElem ( 0, 1) << " " << Ht.getElem ( 0, 2) << " " << Ht.getElem ( 0, 3) << endl;
        cout << Ht.getElem ( 1, 0) << " " << Ht.getElem ( 1, 1) << " " << Ht.getElem ( 1, 2) << " " << Ht.getElem ( 1, 3) << endl;
        cout << Ht.getElem ( 2, 0) << " " << Ht.getElem ( 2, 1) << " " << Ht.getElem ( 2, 2) << " " << Ht.getElem ( 2, 3) << endl;
        cout << Ht.getElem ( 3, 0) << " " << Ht.getElem ( 3, 1) << " " << Ht.getElem ( 3, 2) << " " << Ht.getElem ( 3, 3) << endl;
        cout << "-------" << endl;

        cout << "-------" << endl;
        cout << "Matriz Gx:" << endl;
        cout << Gx.getElem ( 0, 0) << " " << Gx.getElem ( 0, 1) << " " << Gx.getElem ( 0, 2) << " " << Gx.getElem ( 0, 3) << endl;
        cout << Gx.getElem ( 1, 0) << " " << Gx.getElem ( 1, 1) << " " << Gx.getElem ( 1, 2) << " " << Gx.getElem ( 1, 3) << endl;
        cout << Gx.getElem ( 2, 0) << " " << Gx.getElem ( 2, 1) << " " << Gx.getElem ( 2, 2) << " " << Gx.getElem ( 2, 3) << endl;
        cout << Gx.getElem ( 3, 0) << " " << Gx.getElem ( 3, 1) << " " << Gx.getElem ( 3, 2) << " " << Gx.getElem ( 3, 3) << endl;
        cout << "-------" << endl;
        cout << "Matriz Gy:" << endl;
        cout << Gy.getElem ( 0, 0) << " " << Gy.getElem ( 0, 1) << " " << Gy.getElem ( 0, 2) << " " << Gy.getElem ( 0, 3) << endl;
        cout << Gy.getElem ( 1, 0) << " " << Gy.getElem ( 1, 1) << " " << Gy.getElem ( 1, 2) << " " << Gy.getElem ( 1, 3) << endl;
        cout << Gy.getElem ( 2, 0) << " " << Gy.getElem ( 2, 1) << " " << Gy.getElem ( 2, 2) << " " << Gy.getElem ( 2, 3) << endl;
        cout << Gy.getElem ( 3, 0) << " " << Gy.getElem ( 3, 1) << " " << Gy.getElem ( 3, 2) << " " << Gy.getElem ( 3, 3) << endl;
        cout << "-------" << endl;
        cout << "Matriz Gz:" << endl;
        cout << Gz.getElem ( 0, 0) << " " << Gz.getElem ( 0, 1) << " " << Gz.getElem ( 0, 2) << " " << Gz.getElem ( 0, 3) << endl;
