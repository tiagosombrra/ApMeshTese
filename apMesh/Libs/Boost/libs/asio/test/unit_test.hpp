...
#define BOOST_ASIO_TEST_SUITE(name, tests)                  \
  int main() {                                              \
    ...
    tests return boost::asio::detail::end_test_suite(name); \
  }

#define BOOST_ASIO_TEST_CASE(test) boost::asio::detail::run_test<&test>(#test);
...
#define BOOST_ASIO_TEST_CASE3(test1, test2, test3)                      \
  boost::asio::detail::run_test<&test1, test2, test3>(#test1 "," #test2 \
                                                             "," #test3);
