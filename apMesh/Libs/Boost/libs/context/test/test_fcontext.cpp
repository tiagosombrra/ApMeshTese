...
typedef simple_stack_allocator<8 * 1024 * 1024, 64 * 1024, 8 * 1024>
    stack_allocator;

namespace ctx = boost::context::detail;

typedef simple_stack_allocator<8 * 1024 * 1024,  // 8MB
                               64 * 1024,        // 64kB
                               8 * 1024          // 8kB
                               >
    stack_allocator;
...
void f5(ctx::transfer_t t) { ctx::jump_fcontext(t.fctx, t.data); }
...
void f9(ctx::transfer_t t) {
  ...
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f10);
...
void test_setup() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f1);
  BOOST_CHECK(ctx);
...
void test_jump() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f3);
  BOOST_CHECK(ctx);
  BOOST_CHECK_EQUAL(0, value1);
...
void test_result() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f4);
  BOOST_CHECK(ctx);
  ctx::transfer_t t = ctx::jump_fcontext(ctx, 0);
...
void test_arg() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f5);
  BOOST_CHECK(ctx);
...
void test_transfer() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f6);
  BOOST_CHECK(ctx);
...
void test_exception() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f7);
  BOOST_CHECK(ctx);
...
void test_fp() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f8);
  BOOST_CHECK(ctx);
...
void test_stacked() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f9);
  ctx::jump_fcontext(ctx, 0);
...
void test_ontop() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f12);
  BOOST_CHECK(ctx);
  ctx::transfer_t t = ctx::jump_fcontext(ctx, 0);
  BOOST_CHECK_EQUAL(0, value1);
...
void test_sscanf() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f13);
  BOOST_CHECK(ctx);
  ctx::jump_fcontext(ctx, 0);
  alloc.deallocate(sp, stack_allocator::default_stacksize());
}
...
void test_snprintf() {
  ...
  void *sp = alloc.allocate(stack_allocator::default_stacksize());
  ctx::fcontext_t ctx =
      ctx::make_fcontext(sp, stack_allocator::default_stacksize(), f14);
  ctx::jump_fcontext(ctx, 0);
  alloc.deallocate(sp, stack_allocator::default_stacksize());
}
