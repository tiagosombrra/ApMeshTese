...
#undef BASES
  ...
  /* override */ {
    ...
    boost::contract::check c =
        boost::contract::public_function<override1>(
            v,
            static_cast<void (positive_unary_pack::*)(
                T const&, boost::contract::virtual_*)>(
  ...
  virtual T _1(boost::contract::virtual_* v = 0) const /* override */ {
    ...
    boost::contract::check c =
        boost::contract::public_function<override1>(
            ...
            this)
            .postcondition(
                [&](T const& result) { BOOST_CONTRACT_ASSERT(result > 0); });
