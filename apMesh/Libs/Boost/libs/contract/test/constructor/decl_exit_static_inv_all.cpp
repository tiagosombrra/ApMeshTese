...
#endif
    ok.str("");
    ok << ok_c() << ok_b() << ok_a()  // Test exit a::static_inv failed.
...
#endif
    ok.str("");
    ok << ok_c() << ok_b()  // Test exit b::static_inv failed.
#ifdef BOOST_CONTRACT_NO_EXIT_INVARIANTS
       << ok_a() << ok_end()
#endif
        ;
...
#endif
    ok.str("");
    ok << ok_c()  // Test exit c::static_inv failed.
#ifdef BOOST_CONTRACT_NO_EXIT_INVARIANTS
       << ok_b() << ok_a() << ok_end()
#endif
        ;
...
#endif
    ok.str("");
    ok << ok_c()  // Test exit c::static_inv failed (as all did).
#ifdef BOOST_CONTRACT_NO_EXIT_INVARIANTS
       << ok_b() << ok_a() << ok_end()
#endif
        ;
