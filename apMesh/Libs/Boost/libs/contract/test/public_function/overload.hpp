  ...
  void f(void (* /* x */)(int), boost::contract::virtual_* v = 0) {
    boost::contract::check c =
        boost::contract::public_function(v, this)
            ...
            .old([] { out << "b::f(void (*)(int))::old" << std::endl; })
            .postcondition(
...
#undef BASES
  ...
  void f(int x, boost::contract::virtual_* v = 0) /* override */ {
    boost::contract::check c =
        boost::contract::public_function<override_f>(
            v, static_cast<void (a::*)(int, boost::contract::virtual_*)>(&a::f),
            this, x)
  ...
  void f(boost::contract::virtual_* v = 0) /* override */ {
    ...
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, f0, this)
  ...
  /* not an override */ {
    ...
    boost::contract::check c =
        boost::contract::public_function(v, f0, this)
            .precondition([] { out << "a::f(bool)::pre" << std::endl; })
            .old([] { out << "a::f(bool)::old" << std::endl; })
            .postcondition(
                [](f0_ptr const&) { out << "a::f(bool)::post" << std::endl; });
  ...
  void f(void (*x)(int), boost::contract::virtual_* v = 0) /* override */ {
    boost::contract::check c =
        boost::contract::public_function<override_f>(
            ...
            .old([] { out << "a::f(void (*)(int))::old" << std::endl; })
            .postcondition(
