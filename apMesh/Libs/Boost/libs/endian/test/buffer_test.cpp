...
template <class T>
void test_buffer_type(typename T::value_type v1, typename T::value_type v2) {
  T buffer(v1);
...
void test_construction_and_assignment() {
  ...
  test_buffer_type<big_uint64_buf_at>(0x0102030405060708ULL,
                                      0xFE02030405060708ULL);
  ...
  test_buffer_type<little_int64_buf_at>(0x0102030405060708LL,
                                        -0x0102030405060708LL);
  ...
  test_buffer_type<little_uint64_buf_at>(0x0102030405060708ULL,
                                         0xFE02030405060708ULL);
  ...
  test_buffer_type<big_int64_buf_t>(0x0102030405060708LL,
                                    -0x0102030405060708LL);
  ...
  test_buffer_type<little_uint56_buf_t>(0x01020304050607ULL,
                                        0xFE020304050607ULL);
  test_buffer_type<little_uint64_buf_t>(0x0102030405060708ULL,
                                        0xFE02030405060708ULL);
...
void test_boundary_values_() {
  test_buffer_type<
      endian_buffer<order::big, T, sizeof(T) * CHAR_BIT, align::no> >(
      std::numeric_limits<T>::min(), std::numeric_limits<T>::max());
  test_buffer_type<
      endian_buffer<order::little, T, sizeof(T) * CHAR_BIT, align::no> >(
      std::numeric_limits<T>::min(), std::numeric_limits<T>::max());
  test_buffer_type<
      endian_buffer<order::big, T, sizeof(T) * CHAR_BIT, align::yes> >(
      std::numeric_limits<T>::min(), std::numeric_limits<T>::max());
  test_buffer_type<
      endian_buffer<order::little, T, sizeof(T) * CHAR_BIT, align::yes> >(
      std::numeric_limits<T>::min(), std::numeric_limits<T>::max());
}
