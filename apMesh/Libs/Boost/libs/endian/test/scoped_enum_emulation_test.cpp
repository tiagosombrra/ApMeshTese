...
//  http://www.boost.org/libs/utility/scoped_enum_emulation.html
...
BOOST_SCOPED_ENUM_START(traffic_light){red = 0, yellow, green};
BOOST_SCOPED_ENUM_END

BOOST_SCOPED_ENUM_START(algae){green = 0, red, cyan};
BOOST_SCOPED_ENUM_END

struct color {
  BOOST_SCOPED_ENUM_START(value_t){red, green, blue};
  BOOST_SCOPED_ENUM_END
  BOOST_SCOPED_ENUM(value_t) value;
};

void foo(BOOST_SCOPED_ENUM(algae) arg) { BOOST_ASSERT(arg == algae::cyan); }
