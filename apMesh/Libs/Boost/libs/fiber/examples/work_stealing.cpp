...
void thread() {
  ...
  boost::fibers::use_scheduling_algorithm<boost::fibers::algo::work_stealing>(
      4); /*<
Install the scheduling algorithm `boost::fibers::algo::work_stealing` in order
to join the work sharing.
>*/
  lock_type lk(mtx_count);
...
>*/
      std::thread(thread), std::thread(thread), std::thread(thread)};
  boost::fibers::use_scheduling_algorithm<boost::fibers::algo::work_stealing>(
      4); /*<
Install the scheduling algorithm `boost::fibers::algo::work_stealing` in the
...
>*/
  {
   ...
   >*/
                                                         ...
                                                         otherwise                                                        the other threads would be blocked inside condition_variable::wait()
