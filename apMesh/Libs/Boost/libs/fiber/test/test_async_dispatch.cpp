...
struct A {
  ...
  A(A&& other) : value{other.value} { other.value = 0; }
...
int fn2(int i) { return i; }

int& fn3(int& i) { return i; }

A fn4(A&& a) { return std::forward<A>(a); }

void test_async_1() {
  boost::fibers::future<void> f1 =
      boost::fibers::async(boost::fibers::launch::dispatch, fn1);
...
void test_async_2() {
  ...
  boost::fibers::future<int> f1 =
      boost::fibers::async(boost::fibers::launch::dispatch, fn2, i);
  BOOST_CHECK(f1.valid());
...
void test_async_3() {
  int i = 7;
  boost::fibers::future<int&> f1 =
      boost::fibers::async(boost::fibers::launch::dispatch, fn3, std::ref(i));
  BOOST_CHECK(f1.valid());
...
void test_async_4() {
  A a1;
  a1.value = 7;
  boost::fibers::future<A> f1 =
      boost::fibers::async(boost::fibers::launch::dispatch, fn4, std::move(a1));
  BOOST_CHECK(f1.valid());
...
void test_async_5() {
  ...
  boost::fibers::future<void> f1 = boost::fibers::async(
      boost::fibers::launch::dispatch, std::bind(&X::foo, std::ref(x), 3));
  BOOST_CHECK(f1.valid());
...
void test_async_stack_alloc() {
  boost::fibers::future<void> f1 =
      boost::fibers::async(boost::fibers::launch::dispatch, std::allocator_arg,
                           boost::fibers::fixedsize_stack{}, fn1);
  BOOST_CHECK(f1.valid());
...
void test_async_std_alloc() {
  ...
  boost::fibers::future<void> f1 = boost::fibers::async(
      ...
      boost::fibers::fixedsize_stack{}, std::allocator<none>{}, fn1);
  BOOST_CHECK(f1.valid());
