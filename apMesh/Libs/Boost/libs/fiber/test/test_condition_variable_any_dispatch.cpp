...
void test_one_waiter_notify_one() {
  ...
  boost::fibers::fiber f1(boost::fibers::launch::dispatch, wait_fn,
                          std::ref(mtx), std::ref(cond));
  BOOST_CHECK_EQUAL(0, value1);

  boost::fibers::fiber f2(boost::fibers::launch::dispatch, notify_one_fn,
                          std::ref(cond));
...
void test_two_waiter_notify_one() {
  ...
  boost::fibers::fiber f2(boost::fibers::launch::dispatch, wait_fn,
                          std::ref(mtx), std::ref(cond));
  BOOST_CHECK_EQUAL(0, value1);

  boost::fibers::fiber f3(boost::fibers::launch::dispatch, notify_one_fn,
                          std::ref(cond));
  BOOST_CHECK_EQUAL(0, value1);

  boost::fibers::fiber f4(boost::fibers::launch::dispatch, notify_one_fn,
                          std::ref(cond));
  BOOST_CHECK_EQUAL(1, value1);
...
void test_two_waiter_notify_all() {
  ...
  boost::fibers::fiber f3(boost::fibers::launch::dispatch, notify_all_fn,
                          std::ref(cond));
  BOOST_CHECK_EQUAL(0, value1);

  boost::fibers::fiber f4(boost::fibers::launch::dispatch, wait_fn,
                          std::ref(mtx), std::ref(cond));
  BOOST_CHECK_EQUAL(2, value1);

  boost::fibers::fiber f5(boost::fibers::launch::dispatch, notify_all_fn,
                          std::ref(cond));
  BOOST_CHECK_EQUAL(2, value1);
...
void do_test_condition_wait() {
  ...
  m.lock();
  boost::fibers::fiber f(boost::fibers::launch::dispatch, &fn1, std::ref(m),
                         std::ref(cv));
  BOOST_CHECK(test1 == 0);
...
void test_condition_wait() {
  boost::fibers::fiber(boost::fibers::launch::dispatch, &do_test_condition_wait)
      .join();
...
void do_test_condition_wait_until() {
  ...
  {
    m.lock();
    boost::fibers::fiber f(boost::fibers::launch::dispatch, &fn2, std::ref(m),
                           std::ref(cv));
    BOOST_CHECK(test1 == 0);
    while (test1 == 0) cv.wait(m);
    BOOST_CHECK(test1 != 0);
...
void do_test_condition_wait_until_pred() {
  ...
  {
    m.lock();
    boost::fibers::fiber f(boost::fibers::launch::dispatch, &fn3, std::ref(m),
                           std::ref(cv));
    BOOST_CHECK(test1 == 0);
    while (test1 == 0) cv.wait(m);
    BOOST_CHECK(test1 != 0);
...
void do_test_condition_wait_for() {
  ...
  {
    m.lock();
    boost::fibers::fiber f(boost::fibers::launch::dispatch, &fn4, std::ref(m),
                           std::ref(cv));
    BOOST_CHECK(test1 == 0);
    while (test1 == 0) cv.wait(m);
    BOOST_CHECK(test1 != 0);
...
void do_test_condition_wait_for_pred() {
  ...
  {
    m.lock();
    boost::fibers::fiber f(boost::fibers::launch::dispatch, &fn5, std::ref(m),
                           std::ref(cv));
    BOOST_CHECK(test1 == 0);
    while (test1 == 0) cv.wait(m);
    BOOST_CHECK(test1 != 0);
