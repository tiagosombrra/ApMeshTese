...
struct test_exclusive {
  ...
  void operator()() {
    ...
    mutex_type mtx;
    boost::fibers::fiber f1(boost::fibers::launch::post, &fn1<mutex_type>,
                            std::ref(mtx));
    boost::fibers::fiber f2(boost::fibers::launch::post, &fn2<mutex_type>,
                            std::ref(mtx));
...
void test_recursive_mutex() {
  boost::fibers::fiber(boost::fibers::launch::post, do_test_recursive_mutex)
      .join();
}
...
void do_test_timed_mutex() {
...

  {
    ...
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn3,
                           std::ref(timed_mtx));
    boost::this_fiber::sleep_for(ms(250));
    timed_mtx.unlock();
    f.join();
...

  {
    boost::fibers::timed_mutex timed_mtx;
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn6,
                           std::ref(timed_mtx));
...

  {
    boost::fibers::timed_mutex timed_mtx;
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn7,
                           std::ref(timed_mtx));
    boost::this_fiber::sleep_for(ms(250));
    timed_mtx.unlock();
    f.join();
...

  {
    boost::fibers::timed_mutex timed_mtx;
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn8,
                           std::ref(timed_mtx));
...
void test_timed_mutex() {
  boost::fibers::fiber(boost::fibers::launch::post, &do_test_timed_mutex)
      .join();
}
...
void do_test_recursive_timed_mutex() {
...

  {
    ...
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn9,
                           std::ref(timed_mtx));
    boost::this_fiber::sleep_for(ms(250));
    timed_mtx.unlock();
    f.join();
...

  {
    boost::fibers::recursive_timed_mutex timed_mtx;
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn10,
                           std::ref(timed_mtx));
    boost::this_fiber::sleep_for(ms(250));
    timed_mtx.unlock();
    f.join();
...

  {
    boost::fibers::recursive_timed_mutex timed_mtx;
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn11,
                           std::ref(timed_mtx));
    boost::this_fiber::sleep_for(ms(250));
    timed_mtx.unlock();
    f.join();
...

  {
    boost::fibers::recursive_timed_mutex timed_mtx;
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn12,
                           std::ref(timed_mtx));
...

  {
    boost::fibers::recursive_timed_mutex timed_mtx;
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn13,
                           std::ref(timed_mtx));
    boost::this_fiber::sleep_for(ms(250));
    timed_mtx.unlock();
    f.join();
...

  {
    boost::fibers::recursive_timed_mutex timed_mtx;
    timed_mtx.lock();
    boost::fibers::fiber f(boost::fibers::launch::post, &fn14,
                           std::ref(timed_mtx));
    boost::this_fiber::sleep_for(ms(300));
    timed_mtx.unlock();
    f.join();
