...
struct basic_flyweight_specifier2 {
  ...
  struct apply {
    typedef flyweight<
        T, tag<int>, static_holder_class<boost::mpl::_1>,
        hashed_factory_class<
            boost::mpl::_1, boost::mpl::_2, boost::hash<boost::mpl::_2>,
            std::equal_to<boost::mpl::_2>, std::allocator<boost::mpl::_1> >,
        simple_locking, refcounted>
        type;
  };
};
...
struct basic_flyweight_specifier3 {
  ...
  struct apply {
    typedef flyweight<T,
                      hashed_factory<boost::hash<boost::mpl::_2>,
