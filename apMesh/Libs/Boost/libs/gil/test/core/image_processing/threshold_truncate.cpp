...
void fill_original_gray() {
  ...
  gil::fill_pixels(
      gil::subimage_view(gil::view(original_gray), 0, 0, original_gray.width(),
...
void fill_original_rgb() {
  ...
  // value 150, 205, 106
  gil::fill_pixels(
      gil::subimage_view(gil::view(original_rgb), 0, 0, original_rgb.width(),
...
void threshold_gray_to_gray() {
  ...
  gil::fill_pixels(
      gil::subimage_view(gil::view(expected_gray), 0, 0, original_gray.width(),
                         original_gray.height() / 2),
      gil::gray8_pixel_t(50));
  gil::fill_pixels(gil::subimage_view(
...
void threshold_rgb_to_rgb() {
  ...
  gil::fill_pixels(
      gil::subimage_view(gil::view(expected_rgb), 0, 0, original_rgb.width(),
                         original_rgb.height() / 2),
