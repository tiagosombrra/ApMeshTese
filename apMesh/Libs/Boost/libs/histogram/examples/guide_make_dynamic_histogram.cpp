...
int main() {
  ...
  // and create vector of regular axes, the number of axis is not known at
  // compile-time
  ...
  // with a vector of axis::variant (polymorphic axis type that can hold any one
  // of the template arguments at a time) the types and number of axis can vary
  // at run-time
