...
class node_iter : public boost::iterator_adaptor<
 ...
 private:
  ...
  typedef boost::iterator_adaptor<node_iter<Value>, Value*, boost::use_default,
 ...
 public:
  ...
  explicit node_iter(Value* p) : super_t(p) {}
