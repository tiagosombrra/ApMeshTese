...
int main() {
  {
    ...
    boost::function_requires<
        boost_concepts::RandomAccessTraversalConcept<iter> >();
  }
  {
    typedef boost::iterator_archetype<
        int, boost::iterator_archetypes::readable_writable_iterator_t,
        boost::random_access_traversal_tag>
        iter;
  ...
  {
    typedef boost::iterator_archetype<
        int, boost::iterator_archetypes::writable_lvalue_iterator_t,
        boost::random_access_traversal_tag>
        iter;
