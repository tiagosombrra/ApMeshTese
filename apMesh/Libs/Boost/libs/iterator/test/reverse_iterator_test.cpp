...
int main() {
  ...
  // Adapting old-style iterators
  {
    typedef boost::reverse_iterator<
        boost::bidirectional_iterator_archetype<dummyT> >
        Iter;
  ...
  {
    typedef boost::reverse_iterator<
        boost::mutable_bidirectional_iterator_archetype<dummyT> >
        Iter;
    boost::function_requires<
  ...
  // Test reverse_iterator
  {
    ...
    boost::random_access_iterator_test(
        boost::make_reverse_iterator(reversed + N), N, array);
    ...
    boost::random_access_iterator_test(
        boost::make_reverse_iterator(const_reversed + N), N, array);
  ...
  // Test reverse_iterator again, with traits fully deducible on all platforms
  {
    ...
    typedef boost::reverse_iterator<std::deque<dummyT>::iterator>
        reverse_iterator;
    typedef boost::reverse_iterator<std::deque<dummyT>::const_iterator>
    ...
    !BOOST_WORKAROUND(__GNUC__, <= 2) &&                               \
        !(BOOST_WORKAROUND(__GNUC__, == 3) &&                          \
          BOOST_WORKAROUND(__GNUC_MINOR__, <= 1)) &&                   \
