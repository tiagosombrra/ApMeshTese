...
void testing_boost_containers_string_std_string() {
  ...
  BOOST_CHECK(boost::lexical_cast<boost::container::string>(std_str) ==
              "std_str");
  ...
  BOOST_CHECK(boost::lexical_cast<boost::container::wstring>(std_wstr) ==
              L"std_wstr");
...
void testing_boost_containers_string_widening() {
  ...
  BOOST_CHECK(boost::lexical_cast<boost::container::wstring>(char_array) ==
              wchar_array);
#endif
  ...
  BOOST_CHECK(boost::lexical_cast<boost::container::basic_string<char16_t> >(
                  char_array) == char16_array);
#endif
  ...
  BOOST_CHECK(boost::lexical_cast<boost::container::basic_string<char32_t> >(
                  char_array) == char32_array);
#endif
}
