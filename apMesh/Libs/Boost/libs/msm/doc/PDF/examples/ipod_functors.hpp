...
BOOST_MSM_EUML_ACTION(show_selected_song){
    ...
    operator()(EVT const&, FSM& fsm, SourceState&, TargetState&){
        std::cout << "selecting song:" << fsm.get_attribute(m_SongIndex)
                  << std::endl;
}
}
;
BOOST_MSM_EUML_ACTION(do_fast_forward){
    ...
    operator()(EVT const&, FSM& fsm, SourceState&,
               TargetState&){std::cout << "moving song forward..." << std::endl;
}
}
;
BOOST_MSM_EUML_ACTION(show_playing_song){
    template <class FSM, class EVT, class SourceState, class TargetState> void
    operator()(EVT const&, FSM& fsm, SourceState&, TargetState&){
        std::cout << "playing song:" << fsm.get_attribute(m_SongIndex)
                  << std::endl;
}
}
;
BOOST_MSM_EUML_ACTION(show_player_off){
    template <class FSM, class EVT, class SourceState, class TargetState> void
    operator()(EVT const&, FSM& fsm, SourceState&,
               TargetState&){std::cout << "turning player off" << std::endl;
}
}
;
BOOST_MSM_EUML_ACTION(show_player_on){
    template <class FSM, class EVT, class SourceState, class TargetState> void
    operator()(EVT const&, FSM& fsm, SourceState&,
               TargetState&){std::cout << "turning player on" << std::endl;
}
}
;
#endif
