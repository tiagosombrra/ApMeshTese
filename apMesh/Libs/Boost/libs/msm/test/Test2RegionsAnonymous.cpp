...
BOOST_AUTO_TEST_CASE(my_test) {
  ...
  BOOST_CHECK_MESSAGE(p.get_state<my_machine_::State3&>().exit_counter == 0,
  ...
  BOOST_CHECK_MESSAGE(p.get_state<my_machine_::State1b&>().entry_counter == 1,
                      "State1b entry not called correctly");
  BOOST_CHECK_MESSAGE(p.get_state<my_machine_::State1b&>().exit_counter == 0,
                      "State1b exit not called correctly");
  BOOST_CHECK_MESSAGE(p.get_state<my_machine_::State2b&>().entry_counter == 0,
                      "State2b entry not called correctly");
  BOOST_CHECK_MESSAGE(p.get_state<my_machine_::State2b&>().exit_counter == 0,
                      "State2b exit not called correctly");
}
}  // namespace
