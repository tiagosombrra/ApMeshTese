...
BOOST_AUTO_TEST_CASE(my_test) {
  ...
  BOOST_CHECK_MESSAGE(p2.get_state<player_::Empty&>().data_ == 1,
                      "Wrong Empty value");

  p2.set_states(msm::back::states_ << player_::Empty(5));
  BOOST_CHECK_MESSAGE(p2.get_state<player_::Empty&>().data_ == 5,
                      "Wrong Empty value");

  p2.set_states(msm::back::states_ << player_::Empty(7) << player_::Open(2));
  BOOST_CHECK_MESSAGE(p2.get_state<player_::Empty&>().data_ == 7,
                      "Wrong Empty value");
  BOOST_CHECK_MESSAGE(p2.get_state<player_::Open&>().data_ == 2,
                      "Wrong Open value");
