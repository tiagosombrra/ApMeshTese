...
int test_main(int argc, char* argv[]) {
  ...
  try {
    c = numeric_cast<signed char>(large_value);
  ...
  try {
    c = numeric_cast<signed char>(large_negative_value);
  } catch (numeric::bad_numeric_cast) {
  ...
  caught_exception = false;
  try {
    ul = numeric_cast<unsigned long>(large_negative_value);
  } catch (numeric::bad_numeric_cast) {
  ...
  caught_exception = false;
  try {
    ul = numeric_cast<unsigned long>(small_negative_value);
  } catch (numeric::bad_numeric_cast) {
