...
void test_vector() {
  ...
  test_my_vector<ublas::mapped_vector<
                     std::complex<float>,
  ...
  test_my_vector<ublas::mapped_vector<float, std::map<std::size_t, float> >,
                 3>()();
#endif

#ifdef USE_DOUBLE
  std::cout << "double, std::map" << std::endl;
  test_my_vector<ublas::mapped_vector<double, std::map<std::size_t, double> >,
                 3>()();
#endif
