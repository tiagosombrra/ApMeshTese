...
void test_matrix_vector() {
  ...
  test_my_matrix_vector<
      ublas::mapped_vector<float, ublas::map_array<std::size_t, float> >,
      ublas::mapped_matrix<float, ublas::row_major,
  ...
  test_my_matrix_vector<
      ...
      ublas::mapped_matrix<double, ublas::row_major,
  ...
  test_my_matrix_vector<
      ublas::mapped_vector<std::complex<float>,
  ...
  test_my_matrix_vector<
      ublas::mapped_vector<std::complex<double>,
