...
#ifdef USE_RANGE
      ublas::matrix_range<ublas::banded_adaptor<M> > mr1(
...
#ifdef USE_SLICE
      ublas::matrix_slice<ublas::banded_adaptor<M> > ms1(
...
#ifdef USE_RANGE
      ublas::matrix_range<ublas::diagonal_adaptor<M> > mr1(
...
#ifdef USE_SLICE
      ublas::matrix_slice<ublas::diagonal_adaptor<M> > ms1(
...
void test_matrix() {
  ...
  test_my_matrix<ublas::banded_matrix<float, ublas::row_major,
  ...
  test_my_matrix<ublas::banded_matrix<double, ublas::row_major,
  ...
  test_my_matrix<ublas::banded_matrix<std::complex<float>, ublas::row_major,
  ...
  test_my_matrix<ublas::banded_matrix<std::complex<double>, ublas::row_major,
...
#ifdef USE_FLOAT
  std::cout << "float, bounded_array" << std::endl;
  test_my_matrix<ublas::diagonal_matrix<float, ublas::row_major,
                                        ublas::bounded_array<float, 3 * 3> >,
                 3>()();
#endif
...
#ifdef USE_DOUBLE
  std::cout << "double, bounded_array" << std::endl;
  test_my_matrix<ublas::diagonal_matrix<double, ublas::row_major,
                                        ublas::bounded_array<double, 3 * 3> >,
                 3>()();
#endif
...
#ifdef USE_DOUBLE
  std::cout << "std::complex<double>, bounded_array" << std::endl;
  test_my_matrix<ublas::diagonal_matrix<
...
#ifdef USE_FLOAT
  std::cout << "std::complex<float>, std::vector" << std::endl;
  test_my_matrix<ublas::diagonal_matrix<std::complex<float>, ublas::row_major,
                                        std::vector<std::complex<float> > >,
                 3>()();
#endif
