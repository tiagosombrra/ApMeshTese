...
struct test_my_matrix_vector {
  ...
  void operator()(int) const {
#ifdef USE_ADAPTOR
    {
      ...
      ublas::matrix_row<ublas::triangular_adaptor<M> > mr1(tam1, N - 1),
          mr2(tam1, N - 1);
      test_with(mr1, mr2, tam1);

      ublas::matrix_column<ublas::triangular_adaptor<M> > mc1(tam1, 0),
          mc2(tam1, 0);
      test_with(mc1, mc2, tam1);

#ifdef USE_RANGE
      ublas::matrix_vector_range<ublas::triangular_adaptor<M> > mvr1(
          tam1, ublas::range(0, N), ublas::range(0, N)),
          mvr2(tam1, ublas::range(0, N), ublas::range(0, N));
      test_with(mvr1, mvr2, tam1);
#endif

#ifdef USE_SLICE
      ublas::matrix_vector_slice<ublas::triangular_adaptor<M> > mvs1(
          tam1, ublas::slice(0, 1, N), ublas::slice(0, 1, N)),
...
void test_matrix_vector() {
  ...
  test_my_matrix_vector<
      ...
      ublas::triangular_matrix<float, ublas::lower, ublas::row_major,
  ...
  test_my_matrix_vector<
      ...
      ublas::triangular_matrix<double, ublas::lower, ublas::row_major,
  ...
  test_my_matrix_vector<
      ...
      ublas::triangular_matrix<std::complex<float>, ublas::lower,
                               ublas::row_major,
                               ublas::unbounded_array<std::complex<float> > >,
      3>()();
  test_my_matrix_vector<
  ...
  test_my_matrix_vector<
      ...
      ublas::triangular_matrix<std::complex<double>, ublas::lower,
                               ublas::row_major,
                               ublas::unbounded_array<std::complex<double> > >,
      3>()();
  test_my_matrix_vector<
