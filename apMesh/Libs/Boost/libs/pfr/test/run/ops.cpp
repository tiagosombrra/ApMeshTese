...
inline bool operator<(test_union l, test_union r) noexcept {
  ++test_union_counter;
  return l.i < r.i;
}
inline bool operator<=(test_union l, test_union r) noexcept {
...
inline std::ostream& operator<<(std::ostream& os, test_union src) {
  ++test_union_counter;
  return os << src.i;
}
inline std::istream& operator>>(std::istream& is, test_union& src) {
  ++test_union_counter;
  return is >> src.i;
}
