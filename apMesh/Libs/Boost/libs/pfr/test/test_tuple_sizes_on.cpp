...
void test_counts_on_multiple_chars_impl() {
  ...
  //    error: 'constexpr ubiq_constructor::operator Type&() const [with Type =
  //    test_counts_on_multiple_chars()::t2*]', declared using local type
  //    'test_counts_on_multiple_chars()::t2', is used but never defined
  //    [-fpermissive]
  //
  // Fixed in GCC-9.
...
int main() { test_counts_on_multiple_chars<BOOST_PFR_RUN_TEST_ON>(); }
