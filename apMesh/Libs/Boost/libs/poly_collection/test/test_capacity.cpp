...
void test_capacity() {
  ...
  do_((BOOST_TEST(cp.template capacity<Types>() == cp.capacity(typeid(Types))),
       0)...);
...
void test_capacity() {
  test_capacity<any_types::collection, auto_increment, any_types::t1,
                any_types::t2, any_types::t3, any_types::t4, any_types::t5>();
  test_capacity<base_types::collection, auto_increment, base_types::t1,
                base_types::t2, base_types::t3, base_types::t4,
                base_types::t5>();
  test_capacity<function_types::collection, auto_increment, function_types::t1,
