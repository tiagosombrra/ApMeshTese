...
void test_iterators() {
  ...
  static_assert(is_forward<iterator>::value, "iterator must be forward");
  ...
  static_assert(std::is_base_of<const_segment_traversal_info,
                                segment_traversal_info>::value,
...

  {
    ...
    for (; first != last; ++first, ++cfirst) {
      ...
      const_local_base_iterator clbfirst = cfirst->begin(),
                                clblast = cfirst->end();
...
void test_iterators() {
  test_iterators<any_types::collection, auto_increment, any_types::t1,
                 any_types::t2, any_types::t3, any_types::t4, any_types::t5>();
  test_iterators<base_types::collection, auto_increment, base_types::t1,
                 base_types::t2, base_types::t3, base_types::t4,
                 base_types::t5>();
  test_iterators<function_types::collection, auto_increment, function_types::t1,
