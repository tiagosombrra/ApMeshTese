...
void test_approximation() {
  ...
  desc.add_options()("foo", new untyped_value())("fee", new untyped_value())(
      "baz", new untyped_value())("all-chroots", new untyped_value())(
      "all-sessions", new untyped_value())("all", new untyped_value());
  ...
  desc2.add_options()("help", "display this message")("config", value<string>(),
                                                      "config file name")(
...
void test_approximation_with_multiname_options() {
  ...
  desc.add_options()("foo", new untyped_value())("fee", new untyped_value())(
      ...
      "chroots,all-chroots", new untyped_value())("sessions,all-sessions",
                                                  new untyped_value())(
  ...
  BOOST_CHECK_EQUAL(desc.find("foo", false, false, false).long_names().second,
                    1u);
  BOOST_CHECK_EQUAL(desc.find("foo", false, false, false).long_names().first[0],
                    "foo");

  BOOST_CHECK_EQUAL(desc.find("fe", false, false, false).long_names().second,
                    2u);
  BOOST_CHECK_EQUAL(desc.find("fe", false, false, false).long_names().first[0],
                    "fe");
  BOOST_CHECK_EQUAL(desc.find("baz", false, false, false).long_names().first[1],
                    "baz");

  BOOST_CHECK_EQUAL(desc.find("baz", false, false, false).long_names().second,
                    2u);
  BOOST_CHECK_EQUAL(desc.find("baz", false, false, false).long_names().first[0],
                    "fizbaz");
  BOOST_CHECK_EQUAL(desc.find("baz", false, false, false).long_names().first[1],
                    "baz");
}
...
void test_long_names_for_option_description() {
  options_description desc;
  desc.add_options()("foo", new untyped_value())("fe,baz", new untyped_value())(
      "chroots,all-chroots", new untyped_value())("sessions,all-sessions",
                                                  new untyped_value())(
      "everything,all", new untyped_value())("qux,fo,q", new untyped_value());
  ...
  BOOST_CHECK_EQUAL(desc.find("qux", false, false, false).long_names().second,
                    2u);
  BOOST_CHECK_EQUAL(desc.find("qux", false, false, false).long_names().first[0],
                    "qux");
  BOOST_CHECK_EQUAL(desc.find("qux", false, false, false).long_names().first[1],
                    "fo");
}
...
void test_formatting() {
  ...
  desc.add_options()("test", new untyped_value(),
      ...
      "Values:\n"
      "  Value1: \tdoes this and that, bla bla bla bla bla bla bla bla bla bla "
      "bla bla bla bla bla\n"
  ...
  BOOST_CHECK_EQUAL(
      ss.str(),
      "  --test arg            foo foo foo foo foo foo foo foo foo foo foo foo "
      "foo \n"
      "                        foofoo foo foo foo foo foo foo foo foo foo foo "
      "foo foo \n"
      "                        foofoo foo foo foo foo foo foo foo foo foo foo "
      "foo foo \n"
      "                        foofoo foo foo foo foo foo foo foo foo foo foo "
      ...
      "  --well_formated arg   As you can see this is a very well formatted "
      "option \n"
      "                        description.\n"
      "                        You can do this for example:\n"
      "                        \n"
      ...
      "                                  bla bla bla bla bla bla bla bla bla\n"
      "                        \n"
      "                            This paragraph has a first line indent "
      "only, bla \n"
...
void test_formatting_description_length() {
  {
    ...
    desc.add_options()("an-option-that-sets-the-max",
                       ...
                       "this description sits on the same line, but wrapping "
    ...
    BOOST_CHECK_EQUAL(
        ss.str(),
        "  --an-option-that-sets-the-max arg     this description sits on the "
        "same line,\n"
  ...
  }
  {
    ...
    desc.add_options()("an-option-that-encroaches-description",
                       ...
                       "line, and wrapping should continue as normal");
    ...
    BOOST_CHECK_EQUAL(ss.str(),
                      ...
                      "          this description should always be placed on "
                      "the next line, and \n"
...
void test_word_wrapping() {
  ...
  desc.add_options()(
      ...
      "opt1",
      "this_is_a_sufficiently_long_text_to_require_word-wrapping_but_cannot_be_"
      "wrapped")("opt2",
                 "this_is_a_sufficiently long_text_to_require_word-wrapping")(
      "opt3",
      "this_is_a "
  ...
  BOOST_CHECK_EQUAL(
      ss.str(),
      "Supported options:\n"
      "  --help                               this is a sufficiently long text "
      "to \n"
