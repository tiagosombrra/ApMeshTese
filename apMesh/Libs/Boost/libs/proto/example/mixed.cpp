...
struct begin : proto::callable {
  ...
  struct result<This(Cont)>
      : proto::result_of::as_expr<iterator_wrapper<
            typename boost::remove_reference<Cont>::type::const_iterator> > {};

  template <typename Cont>
  typename result<begin(Cont const &)>::type operator()(
      Cont const &cont) const {
...
struct Begin
    : proto::or_<
          proto::when<proto::terminal<std::vector<_, _> >,
                      begin(proto::_value)>,
...
struct DereferenceCtx {
  ...
  template <typename Expr>
  struct eval<Expr, typename boost::enable_if<proto::matches<
                        Expr, proto::terminal<iterator_wrapper<_> > > >::type> {
...
struct MixedDomain : proto::domain<proto::generator<MixedExpr>, MixedGrammar> {
};
...
template <typename A>
typename proto::result_of::make_expr<proto::tag::function, MixedDomain,
                                     sin_ const, A const &>::type
sin(A const &a) {
  return proto::make_expr<proto::tag::function, MixedDomain>(sin_(),
                                                             boost::ref(a));
}
