...
struct at : proto::callable {
  ...
  struct result<This(Vector, N)>
      : fusion::result_of::at<typename boost::remove_reference<Vector>::type,
                              typename boost::remove_reference<N>::type> {};

  template <class Vector, class N>
  typename fusion::result_of::at<Vector const, N>::type operator()(
      Vector const &vector, N) const {
    ...
    : proto::or_<
          ...
          proto::when<
              ...
              eval_if_else(
                  ...
                  proto::_right(proto::_left(proto::_left)), proto::_right,
                  proto::_data)>,
...
struct eval_if_else : proto::callable {
  ...
  void operator()(If const &if_, Then const &then_, Else const &else_,
...
struct domain : proto::domain<proto::pod_generator<expression> > {};
...
struct arity_of
    : proto::or_<
          ...
          proto::otherwise<proto::fold<
              _, mpl::int_<0>(), mpl::max<arity_of, proto::_state>()> > > {};
...
struct expression {
  ...
  BOOST_PROTO_EXTENDS_MEMBERS(((keyword::else_, else_))(
      (keyword::while_, while_))((keyword::catch_, catch_)))
  ...
  // it isn't nullary.
  typename mpl::eval_if_c<0 != arity, mpl::identity<void>,
                          boost::result_of<grammar(E const &, int const &,
                                                   fusion::vector<> &)> >::type
  operator()() const {
...
#define BOOST_PROTO_LOCAL_MACRO(N, typename_A, A_const_ref, A_const_ref_a, a) \
  ...
  typename boost::result_of<grammar(E const &, int const &,                   \
                                    fusion::vector<A_const_ref(N)> &)>::type  \
...
template <typename E>
typename proto::result_of::make_expr<proto::tag::function, domain, keyword::if_,
                                     E const &>::type const
if_(E const &e) {
  return proto::make_expr<proto::tag::function, domain>(keyword::if_(),
                                                        boost::ref(e));
}
}  // namespace placeholders
