...
struct MakeTest1 : proto::make<type2type<careful<int> > > {};
...
struct MakeTest2 : proto::make<wrapper<proto::_value> > {};
...
// Test that when substitution is done, and there is no nested ::type
// typedef, the result is the wrapper
struct MakeTest3 : proto::make<wrapper<proto::_value>(proto::_value)> {};
...
// Test that when substitution is done, and there is no nested ::type
// typedef, the result is the wrapper
struct MakeTest4 : proto::make<mpl::identity<proto::_value>(proto::_value)> {};
