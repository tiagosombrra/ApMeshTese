...
#define BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(T, actual, expected, \
                                                      tol)                 \
  do {                                                                     \
...
BOOST_CONCEPT_ASSERT((boost::random::test::RandomNumberDistribution<
...
BOOST_AUTO_TEST_CASE(test_constructors) {
  ...
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, dist.probabilities(), boost::assign::list_of(1.0), tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, dist.rates(), boost::assign::list_of(1.0), tol);
  ...
  boost::random::hyperexponential_distribution<> dist_il_p_r = {{1, 2, 3, 4},
                                                                {1, 2, 3, 4}};
  BOOST_CHECK_EQUAL(dist_il_p_r.num_phases(), 4u);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, dist_il_p_r.probabilities(),
      boost::assign::list_of(.1)(.2)(.3)(.4), tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, dist_il_p_r.rates(), boost::assign::list_of(1.)(2.)(3.)(4.), tol);
  ...
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, dist_il_r.probabilities(),
      boost::assign::list_of(.25)(.25)(.25)(.25), tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, dist_il_r.rates(), boost::assign::list_of(1.)(2.)(3.)(4.), tol);
#endif
  ...
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, dist_r.probabilities(),
                                                probs, tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, dist_r.rates(), rates,
                                                tol);

  // Test ctor from iterators
  boost::random::hyperexponential_distribution<> dist_it(
      probs.begin(), probs.end(), rates.begin(), rates.end());
  BOOST_CHECK_EQUAL(dist_it.num_phases(), 4u);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, dist_it.probabilities(),
                                                probs, tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, dist_it.rates(), rates,
                                                tol);

  // Test ctor from rate iterators
  boost::random::hyperexponential_distribution<> dist_r_it(rates.begin(),
                                                           rates.end());
  BOOST_CHECK_EQUAL(dist_r_it.num_phases(), 4u);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, dist_r_it.probabilities(),
      boost::assign::list_of(.25)(.25)(.25)(.25), tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, dist_r_it.rates(),
                                                rates, tol);

  // Test ctor from rate iterators #2
  {
    const double rates2[] = {1.0, 2.0, 3.0, 4.0};
    boost::random::hyperexponential_distribution<> dist_r_it(rates2,
                                                             rates2 + 4);
    BOOST_CHECK_EQUAL(dist_r_it.num_phases(), 4u);
    BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
        double, dist_r_it.probabilities(),
        boost::assign::list_of(.25)(.25)(.25)(.25), tol);
    BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
        double, dist_r_it.rates(), std::vector<double>(rates2, rates2 + 4),
        tol);
  }
  ...
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, dist_r_r.probabilities(),
      boost::assign::list_of(.25)(.25)(.25)(.25), tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, dist_r_r.rates(), rates,
                                                tol);
...
BOOST_AUTO_TEST_CASE(test_param) {
  ...
  boost::random::hyperexponential_distribution<>::param_type param =
      dist.param();
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, dist.probabilities(),
                                                param.probabilities(), tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, dist.rates(),
                                                param.rates(), tol);
  ...
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, param_default.probabilities(), boost::assign::list_of(1.0), tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, param_default.rates(), boost::assign::list_of(1.0), tol);
  BOOST_CHECK(param != param_default);
  BOOST_CHECK(!(param == param_default));
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST) && \
    !defined(BOOST_NO_CXX11_UNIFIED_INITIALIZATION_SYNTAX)
  boost::random::hyperexponential_distribution<>::param_type param_il = {
      {1, 2, 3, 4}, {1, 2, 3, 4}};
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, param_il.probabilities(), boost::assign::list_of(.1)(.2)(.3)(.4),
      tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, param_il.rates(), boost::assign::list_of(1.)(2.)(3.)(4.), tol);
#endif
  boost::random::hyperexponential_distribution<>::param_type param_r(probs,
                                                                     rates);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, param_r.probabilities(),
                                                probs, tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, param_r.rates(), rates,
                                                tol);

  boost::random::hyperexponential_distribution<>::param_type param_it(
      probs.begin(), probs.end(), rates.begin(), rates.end());
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(
      double, param_it.probabilities(), probs, tol);
  BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double, param_it.rates(), rates,
                                                tol);
}
...
BOOST_AUTO_TEST_CASE(test_streaming) {
  ...
  {
    boost::random::hyperexponential_distribution<>::param_type parm(probs,
                                                                    rates);
    std::stringstream ss;
    ss << parm;
  ...
  // - Test with an empty probability vector and ios_base exceptions disabled
  {
    ...
    boost::random::hyperexponential_distribution<>::param_type check_param(
        std::vector<double>(rates.size(), 1), rates);
  ...
  // - Test with an empty rate vector and ios_base exceptions disabled
  {
    ...
    ss >> param;
    boost::random::hyperexponential_distribution<>::param_type check_param(
        probs, std::vector<double>(probs.size(), 1));
    BOOST_CHECK_EQUAL(param, check_param);
  }

  // - Test with an empty probability and rate vectors and ios_base exceptions
  // disabled
  {
    std::stringstream ss;
    boost::random::detail::print_vector(ss, empty_vector);
...
// NOTE: test case commented since normalization check in \c
// hyperexp_detail::check_probabilities has been currently commented
...
//     const std::vector<double> norm_probs =
//     boost::assign::list_of(1023.0/1024.0)(1.0/1024.0);
//
//     boost::random::hyperexponential_distribution<> dist(probs, rates);
//     BOOST_CHECK(
//     boost::random::hyperexp_detail::check_params(dist.probabilities(),
//     dist.rates()) ); BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double,
//     dist.probabilities(), norm_probs, tol);
//
...
//     const std::vector<double> norm_probs2 =
//     boost::assign::list_of(1001.0/1002.0)(1.0/1002.0);
//
//     boost::random::hyperexponential_distribution<> dist2(probs2, rates2);
//     BOOST_CHECK(
//     boost::random::hyperexp_detail::check_params(dist2.probabilities(),
//     dist2.rates()) ); BOOST_RANDOM_HYPEREXP_CHECK_CLOSE_COLLECTIONS(double,
//     dist2.probabilities(), norm_probs2, tol);
// }
...
BOOST_AUTO_TEST_CASE(test_generation) {
  ...
  boost::random::hyperexponential_distribution<> dist;
  boost::random::hyperexponential_distribution<> dist_r(probs, rates);
  typedef boost::random::hyperexponential_distribution<>::result_type
      result_type;
