/*
        ...
        Thanks to Stephen T. Lavavej for his close reading of 26.5.3.3
   [rand.eng.sub]/7
*/
...
BOOST_AUTO_TEST_CASE(test_zero_seed) {
  BOOST_CHECK(boost::random::ranlux24_base(0) ==
  ...
  BOOST_CHECK(boost::random::ranlux48_base(0) ==
              boost::random::ranlux48_base());

  BOOST_CHECK(boost::random::ranlux_base_01(0) ==
              boost::random::ranlux_base_01());
  BOOST_CHECK(boost::random::ranlux64_base_01(0) ==
