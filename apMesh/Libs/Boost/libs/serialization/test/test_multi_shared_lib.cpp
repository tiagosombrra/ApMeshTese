...
// singletons accessed in destructors of other singletons are already
// destructed. Accessing them will then lead to a crash or memory corruption.
// For this we need 2 shared libraries, linked against static boost. They need
// to instantiate extended_type_info_typeid with different types, either by
// serializing 2 types (which will do that internally) or by accessing the
// singletons directly.
