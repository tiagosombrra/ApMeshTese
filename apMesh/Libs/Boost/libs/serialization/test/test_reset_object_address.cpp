...
class B {
 ...
 public:
  bool operator==(const B &rhs) const { return m_i == rhs.m_i; }
  B() : m_i(std::rand()) {}
};
...
class D {
 ...
 public:
  B m_b;
  bool operator==(const D &rhs) const { return m_b == rhs.m_b; }
  D() {}
};
...
class E {
 ...
 public:
  bool operator==(const E &rhs) const { return m_i == rhs.m_i; }
  E() : m_i(std::rand()) {}
  E(const E &rhs) : m_i(rhs.m_i) {}
};
...
class F {
 ...
 public:
  bool operator==(const F &rhs) const { return *m_eptr == *rhs.m_eptr; }
  F &operator=(const F &rhs) {
    *m_eptr = *rhs.m_eptr;
    return *this;
  }
  F() { m_eptr = new E; }
  F(const F &rhs) { *this = rhs; }
  ~F() { delete m_eptr; }
};
...
class G {
 ...
 public:
  bool operator==(const G &rhs) const {
    return m_a1 == rhs.m_a1 && m_a2 == rhs.m_a2 && *m_pa2 == *rhs.m_pa2;
  }
