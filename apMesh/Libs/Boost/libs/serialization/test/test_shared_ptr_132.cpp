...
template <class T>
void save2(const char* testfile, const T& first, const T& second) {
  test_ostream os(testfile, TEST_STREAM_FLAGS);
  test_oarchive oa(os, TEST_ARCHIVE_FLAGS);
...
template <class T>
void load2(const char* testfile, T& first, T& second) {
  test_istream is(testfile, TEST_STREAM_FLAGS);
  test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
...
template <class T>
void save3(const char* testfile, const T& first, const T& second,
           const T& third) {
  test_ostream os(testfile, TEST_STREAM_FLAGS);
  test_oarchive oa(os, TEST_ARCHIVE_FLAGS);
...
template <class T>
void load3(const char* testfile, T& first, T& second, T& third) {
  test_istream is(testfile, TEST_STREAM_FLAGS);
  test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
