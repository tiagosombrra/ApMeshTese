...
struct adder_ {
  ...
  template <typename Arg1T, typename Arg2T, typename ArgT3>
  Arg1T operator()(Arg1T a, Arg2T b, ArgT3 c) const {
    return a + b + c;
  }
};
...
int main() {
  ...
  BOOST_TEST((sqr(arg1) + arg2 - arg3)(i100, i50, i20) ==
             ((i100 * i100) + i50 - i20));
  ...
  BOOST_TEST(((adder(arg1, arg2, arg3) + arg2 - arg3)(i100, i50, i20)) ==
             (i100 + i50 + i20) + i50 - i20);
