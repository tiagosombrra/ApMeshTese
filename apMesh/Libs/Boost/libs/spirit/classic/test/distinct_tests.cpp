...
typedef scanner<char const*, scanner_policies<skipper_iteration_policy<> > >
    scanner_t;
...
void distinct_parser_test() {
  ...
  {
    distinct_parser<
        char, alternative<alnum_parser,
                          sequence<chlit<>, negated_char_parser<chlit<> > > > >
...
void dynamic_distinct_parser_test() {
  ...
  {
    dynamic_distinct_parser<scanner_t> distinct_p(alnum_p |
                                                  ('-' >> ~ch_p('-')));
...
void dynamic_distinct_directive_test() {
  ...
  {
    dynamic_distinct_directive<scanner_t> distinct_d(alnum_p |
                                                     ('-' >> ~ch_p('-')));
