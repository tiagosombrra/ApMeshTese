...
struct my_grammar1 : BOOST_SPIRIT_CLASSIC_NS::grammar<my_grammar1> {
  template <typename Scanner>
  struct definition : BOOST_SPIRIT_CLASSIC_NS::grammar_def<
    ...
    BOOST_SPIRIT_CLASSIC_NS::rule<Scanner> start_rule1, start_rule2;
  };
};
...
int main() {
  ...
  parse("int 5", g1.use_parser<0>() >> g2.use_parser<1>(),
