...
typedef multi_pass<istream_iterator<char>, multi_pass_policies::input_iterator,
...
typedef multi_pass<my_functor, multi_pass_policies::functor_input,
                   multi_pass_policies::first_owner,
...

  {
    ...
    *mp3 = *mp2;
    ...
    try {
      ...
      BOOST_TEST(0);
    } catch (const BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::
                 illegal_backtracking& /*e*/) {
    }
    res << endl;
  }
}
...
void test_first_owner_multi_pass() {
  ...
  istream_iterator<char> end;
  boost::scoped_ptr<first_owner_multi_pass_t> mpend(
      new first_owner_multi_pass_t(end));

  {
    ...
    istream_iterator<char> a(ss);
    boost::scoped_ptr<first_owner_multi_pass_t> mp1(
        new first_owner_multi_pass_t(a));
...

  {
    ...
    ss << "test string";
    istream_iterator<char> b(ss);
    boost::scoped_ptr<first_owner_multi_pass_t> mp2(
        new first_owner_multi_pass_t(b));
    boost::scoped_ptr<first_owner_multi_pass_t> mp3(
        new first_owner_multi_pass_t(*mp2));
...

  {
    ...
    boost::scoped_ptr<first_owner_multi_pass_t> mp1(
        new first_owner_multi_pass_t(a));
    boost::scoped_ptr<first_owner_multi_pass_t> mp2(
        new first_owner_multi_pass_t(*mp1));
