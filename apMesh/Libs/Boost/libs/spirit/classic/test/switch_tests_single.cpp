...
struct switch_grammar_direct_default_single1
  ...
  struct definition {
    definition(switch_grammar_direct_default_single1 const& /*self*/) {
      r = switch_p[default_p(str_p("default"))];
    }
...
struct switch_grammar_parser_single
  ...
  struct definition {
    definition(switch_grammar_parser_single const& /*self*/) {
      r = switch_p(anychar_p)[case_p<'a'>(int_p)];
    }
...
struct switch_grammar_parser_default_single1
  ...
  struct definition {
    definition(switch_grammar_parser_default_single1 const& /*self*/) {
      r = switch_p(anychar_p)[default_p(str_p("default"))];
    }
...
struct switch_grammar_parser_default_single2
  ...
  struct definition {
    definition(switch_grammar_parser_default_single2 const& /*self*/) {
      r = switch_p(anychar_p)[default_p];
    }
...
struct select_result
    : public BOOST_SPIRIT_CLASSIC_NS::closure<select_result, int> {
  member1 val;
};
...
struct switch_grammar_actor_single
  ...
  struct definition {
    definition(switch_grammar_actor_single const& /*self*/) {
      using phoenix::arg1;
      r = select_p('a')[r.val = arg1] >> switch_p(r.val)[case_p<0>(int_p)];
    }

    rule<ScannerT, select_result::context_t> r;
    rule<ScannerT, select_result::context_t> const& start() const { return r; }
  };
};
  ...
  struct definition {
    definition(switch_grammar_actor_default_single1 const& /*self*/) {
      ...
      r = select_p('d')[r.val = arg1] >>
          switch_p(r.val)[default_p(str_p("default"))];
    }
...
struct switch_grammar_actor_default_single2
  ...
  struct definition {
    definition(switch_grammar_actor_default_single2 const& /*self*/) {
      using phoenix::arg1;
      r = select_p('d')[r.val = arg1] >> switch_p(r.val)[default_p];
    }
...
struct check_grammar_default_plain {
  ...
  void operator()(GrammarT) {
    ...
    BOOST_TEST(
        parse(" d", g, space_p).full);  // JDG 10-18-2005 removed trailing ' '
                                        // to avoid post skip problems
  }
};
...
int main() {
  ...
  typedef boost::mpl::list<test_grammars::switch_grammar_direct_single,
  ...
  typedef boost::mpl::list<test_grammars::switch_grammar_direct_default_single1,
  ...
  typedef boost::mpl::list<test_grammars::switch_grammar_direct_default_single2,
