...
inline std::ostream& operator<<(std::ostream& os,
                                std::pair<int const, std::string> v) {
  os << v.first << ": " << v.second;
  return os;
}
}  // namespace std
...
void output_container(std::ostream& os, Container const& c) {
  ...
  os << karma::format(*stream,  // format description
                      c         // data
                      )
     << std::endl
     << std::endl;
  ...
  // output the container as a space separated sequence
  os << karma::format_delimited(*stream,  // format description
                                space,    // delimiter
                                c         // data
                                )
     << std::endl
  ...
  os << karma::format('[' << (+stream | "empty") << ']',  // format description
                      c                                   // data
                      )
     << std::endl
     << std::endl;
  ...
  os << karma::format_delimited("<ol>" << *verbatim["<li>" << stream << "</li>"]
  ...
  os << karma::format_delimited(
            *verbatim["|" << right_align[stream] << "|"],  // format description
            '\n',                                          // delimiter
            c                                              // data
            )
     << std::endl;
