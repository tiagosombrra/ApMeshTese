...
char const* const lexer_state_names_wcl[1] = {"INITIAL"};
...
std::size_t next_token_wcl(std::size_t& /*start_state_*/, bool& /*bol_*/,
  ...
  static const std::size_t lookup_[256] = {
      9, 9, 9, 9, 9, 9, 9, 9, 9, 8, 7, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9,
  ...
  static const std::size_t dfa_[50] = {
      ...
      3, 4, 2, 1, 65536, 0, 0, 0,     0, 0, 0, 0, 2, 1, 65537, 1, 0,
      0, 0, 0, 0, 0,     0, 1, 65538, 2, 0, 0, 0, 0, 0, 0,     0};
...
struct lexer_wcl {
  ...
  static std::size_t state_count() { return lexer_state_count_wcl; }
