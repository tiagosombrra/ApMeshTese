...
struct primary_expr
    : tagged,
      boost::spirit::extended_variant<nil, bool, unsigned int, identifier,
  ...
  primary_expr(primary_expr const& rhs) : base_type(rhs.get()) {}
};

struct operand : tagged,
                 boost::spirit::extended_variant<
                     nil, primary_expr, boost::recursive_wrapper<unary_expr>,
...
typedef boost::variant<nil, variable_declaration, assignment,
...
BOOST_FUSION_ADAPT_STRUCT(client::ast::unary_expr,
                          (client::token_ids::type,
...
BOOST_FUSION_ADAPT_STRUCT(client::ast::function_call,
                          (client::ast::identifier,
                           function_name)(std::list<client::ast::expression>,
                                          args))
...
BOOST_FUSION_ADAPT_STRUCT(client::ast::variable_declaration,
                          (client::ast::identifier,
                           lhs)(boost::optional<client::ast::expression>, rhs))

BOOST_FUSION_ADAPT_STRUCT(client::ast::assignment,
                          (client::ast::identifier,
                           lhs)(client::token_ids::type,
                                operator_)(client::ast::expression, rhs))
...
BOOST_FUSION_ADAPT_STRUCT(
    client::ast::function,
    (std::string, return_type)(client::ast::identifier, function_name)(
        std::list<client::ast::identifier>,
        args)(boost::optional<client::ast::statement_list>, body))
