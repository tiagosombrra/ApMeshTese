...
struct roman : public grammar<roman> {
  ...
  struct definition {
    definition(roman const& self) {
      hundreds.add("C", 100)("CC", 200)("CCC", 300)("CD", 400)("D", 500)(
          "DC", 600)("DCC", 700)("DCCC", 800)("CM", 900);

      tens.add("X", 10)("XX", 20)("XXX", 30)("XL", 40)("L", 50)("LX", 60)(
          "LXX", 70)("LXXX", 80)("XC", 90);

      ones.add("I", 1)("II", 2)("III", 3)("IV", 4)("V", 5)("VI", 6)("VII", 7)(
          "VIII", 8)("IX", 9);
...
int main() {
  {
    ...
    parse_info<std::string::iterator> pi =
        parse(input.begin(), input.end(), int_p);

    if (pi.hit) std::cout << "successful match!\n";
...

  {
    ...
    std::string input(" 1, 1");
    parse_info<std::string::iterator> pi =
        parse(input.begin(), input.end(), int_p, space_p);
...

  {
    ...
    if (pi.hit) std::cout << "successfully matched: " << value << "\n";
    //]
  }
  return 0;
}
