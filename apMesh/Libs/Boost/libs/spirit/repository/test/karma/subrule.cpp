...
int main() {
  ...
  // basic tests
  {
    ...
    start = (sr = char_[_1 = 'a'] << int_[_1 = 10] << double_[_1 = 12.4]);
    ...
    start = (sr = a << b << c, a = char_[_1 = 'a'], b = int_[_1 = 10],
             c = double_[_1 = 12.4]);
    BOOST_TEST(test("a1012.4", start));
  }
  ...
  // basic tests involving a direct parameter
  {
    ...
    start = (sr = (char_ | int_ | double_)[_1 = _r0])[_1 = _val];
...

  {
    ...
    start %= (sr = (char_ | int_ | double_)[_1 = _r0]);
...

  {
    ...
    start = (sr = char_[_1 = _r1] << int_[_1 = _r2] << double_[_1 = _r3])(
        _r1, _r2, _r3);
    ...
    start = (entry = a(_r1) << b(_r2) << c(_r3), a = char_[_1 = _r1],
             b = int_[_1 = _r1], c = double_[_1 = _r1])(_r1, _r2, _r3);
    BOOST_TEST(test("a1012.4", start('a', 10, 12.4)));
  }
