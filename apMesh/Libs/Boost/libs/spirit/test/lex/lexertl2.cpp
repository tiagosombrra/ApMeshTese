...
struct lexertl_test : boost::spirit::lex::lexer<Lexer> {
...
template <typename Lexer>
struct wlexertl_test : boost::spirit::lex::lexer<Lexer> {
...
int main() {
  ...
  // normally not visible/used by the user
  {
    ...
    BOOST_TEST(
        test(lex, "// this is a comment as well\n", lexer_def::CPPCOMMENT));
  }

  {
    ...
    BOOST_TEST(
        test(lex, L"// this is a comment as well\n", lexer_def::CPPCOMMENT));
  }
