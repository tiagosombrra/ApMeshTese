...
int main() {
  ...
  {
    typedef lex::lexertl::token<base_iterator_type, mpl::vector<>, mpl::false_>
        token_type;
  ...
  {
    typedef lex::lexertl::position_token<base_iterator_type, mpl::vector<>,
                                         mpl::false_>
        token_type;
    typedef lex::lexertl::actor_lexer<token_type> lexer_type;
  ...
  {
    typedef lex::lexertl::token<base_iterator_type, mpl::vector<>, mpl::true_>
        token_type;
    typedef lex::lexertl::actor_lexer<token_type> lexer_type;
