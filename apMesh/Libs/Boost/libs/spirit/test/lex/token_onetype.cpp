...
///////////////////////////////////////////////////////////////////////////////
template <typename Token>
inline bool test_token_values(double const* values,
                              std::vector<Token> const& tokens) {
  BOOST_FOREACH (Token const& t, tokens) {
    if (*values == 0.0) return false;  // reached end of expected data
...
int main() {
  ...
  {
    typedef lex::lexertl::token<base_iterator_type, mpl::vector<double>,
                                mpl::false_>
        token_type;
