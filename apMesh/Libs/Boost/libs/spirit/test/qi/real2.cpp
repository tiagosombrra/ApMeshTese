...
int main() {
  ...
  ///////////////////////////////////////////////////////////////////////////
  {
    ...
    BOOST_TEST(
        test_attr("4.9406564584124654e-324", double_, d));  // DBL_DENORM_MIN
    ...
    BOOST_TEST(test_attr("-inf", double_, d) && isinf(d) && signbit(d));
    BOOST_TEST(test_attr("-infinity", double_, d) && isinf(d) && signbit(d));
    BOOST_TEST(test("-INF", double_));
    BOOST_TEST(test("-INFINITY", double_));
    BOOST_TEST(test_attr("-INF", double_, d) && isinf(d) && signbit(d));
    BOOST_TEST(test_attr("-INFINITY", double_, d) && isinf(d) && signbit(d));
    ...
    BOOST_TEST(test_attr("-nan", double_, d) && isnan(d) && signbit(d));
    BOOST_TEST(test("-NAN", double_));
    BOOST_TEST(test_attr("-NAN", double_, d) && isnan(d) && signbit(d));
    ...
    char const* long_number =
        "17976931348623157081452742373170435679807056"
