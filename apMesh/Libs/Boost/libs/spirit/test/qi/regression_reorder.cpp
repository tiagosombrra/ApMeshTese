...
int main() {
  ...
  typedef fusion::vector<optional<double>,  // 0 - U
                         optional<double>,  // 1 - V
                         optional<double>   // 2 - W
                         >
      uvw_type;
  ...
  uvw_type uvw_data;
  {
    ...
    BOOST_TEST(fusion::at_c<0>(uvw_result) &&
               *fusion::at_c<0>(uvw_result) == 1);
    BOOST_TEST(fusion::at_c<1>(uvw_result) &&
               *fusion::at_c<1>(uvw_result) == 2);
    BOOST_TEST(fusion::at_c<2>(uvw_result) &&
               *fusion::at_c<2>(uvw_result) == 3);
  }

  {
    ...
    BOOST_TEST(fusion::at_c<0>(uvw_result) &&
               *fusion::at_c<0>(uvw_result) == 2);
    BOOST_TEST(fusion::at_c<1>(uvw_result) &&
               *fusion::at_c<1>(uvw_result) == 3);
    BOOST_TEST(fusion::at_c<2>(uvw_result) &&
               *fusion::at_c<2>(uvw_result) == 1);
  }
