...
template <typename T>
struct is_bar<bar<T>> : std::true_type {};
}  // namespace check_substitute
...
struct is_substitute<T, U,
                     std::enable_if_t<is_bar<T>::value && is_bar<U>::value>>
...
static_assert(is_substitute<foo<int>, foo<int>>::value,
              "is_substitute problem");
static_assert(!is_substitute<foo<int>, foo<long>>::value,
              "is_substitute problem");
static_assert(is_substitute<bar<int>, bar<int>>::value,
              "is_substitute problem");
static_assert(!is_substitute<bar<int>, bar<long>>::value,
              "is_substitute problem");
}  // namespace check_substitute

x3::rule<class pair_rule, std::pair<std::string, std::string>> const pair_rule(
    "pair");
...
int main() {
  ...
  static_assert(is_associative<std::unordered_set<int>>::value,
                "is_associative problem");
  static_assert(is_associative<boost::unordered_set<int>>::value,
                "is_associative problem");
  static_assert(is_associative<std::multiset<int>>::value,
                "is_associative problem");
  static_assert(is_associative<std::unordered_multiset<int>>::value,
                "is_associative problem");
  static_assert(is_associative<boost::unordered_multiset<int>>::value,
                "is_associative problem");
  static_assert(is_associative<std::map<int, int>>::value,
                "is_associative problem");
  static_assert(is_associative<std::unordered_map<int, int>>::value,
                "is_associative problem");
  static_assert(is_associative<boost::unordered_map<int, int>>::value,
                "is_associative problem");
  static_assert(is_associative<std::multimap<int, int>>::value,
                "is_associative problem");
  static_assert(is_associative<std::unordered_multimap<int, int>>::value,
                "is_associative problem");
  static_assert(is_associative<boost::unordered_multimap<int, int>>::value,
                "is_associative problem");

  static_assert(!is_associative<std::vector<int>>::value,
                "is_associative problem");
  static_assert(!is_associative<std::string>::value, "is_associative problem");
  static_assert(!is_associative<std::deque<int>>::value,
                "is_associative problem");
  static_assert(!is_associative<std::list<int>>::value,
                "is_associative problem");
