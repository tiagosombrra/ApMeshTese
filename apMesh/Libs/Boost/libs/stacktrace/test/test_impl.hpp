...
#if defined(BOOST_LEXICAL_CAST_TRY_LEXICAL_CONVERT_HPP) || \
    defined(BOOST_LEXICAL_CAST_BAD_LEXICAL_CAST_HPP)
...
typedef std::pair<boost::stacktrace::stacktrace, boost::stacktrace::stacktrace>
    st_pair;
