...
BOOST_AUTO_TEST_SUITE(
    ...
    *utf::disabled()  // suite is not disabled because of the
        * utf::description(
              "disabled suite 1")  // extra declaration at the end of the file
        * utf::label("label1") * utf::label("label2"))
...
BOOST_AUTO_TEST_SUITE(s2, *utf::disabled() * utf::label("label1") *
...
boost::test_tools::assertion_result do_it(utf::test_unit_id) { return false; }
...
BOOST_AUTO_TEST_SUITE(
    s14, *utf::depends_on("s2/s23/test3") *
