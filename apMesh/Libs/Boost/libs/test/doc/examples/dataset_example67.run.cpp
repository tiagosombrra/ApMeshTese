...
BOOST_DATA_TEST_CASE(test1, bdata::make(fibonacci()), array_element) {
...
BOOST_DATA_TEST_CASE(test2, bdata::make(vect_2_str(fibonacci())),
                     array_element) {
  std::cout << "test 2: \"" << array_element.first << "\", "
            << array_element.second << std::endl;
