...
typedef boost::mpl::list<my_struct<int, int>, my_struct<int, float>,
                         my_struct<float, float>, my_struct<char, float> >
    test_types;
...
typedef boost::mpl::list<my_struct<float, int>, my_struct<int, float>,
                         my_struct<float, float>, my_struct<char, char> >
    test_types2;
