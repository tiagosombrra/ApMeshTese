...
// Checks the instanciation of template test cases with tuples instead of
// mpl::list See trac #12092 https://svn.boost.org/trac10/ticket/12092
// ***************************************************************************
...
BOOST_AUTO_TEST_CASE(test1_with_9_errors) {
  ...
  typedef std::tuple<mpl::integral_c<int, 0>, mpl::integral_c<int, 1>,
                     mpl::integral_c<int, 2>, mpl::integral_c<int, 3>,
                     mpl::integral_c<int, 4>, mpl::integral_c<int, 5>,
                     mpl::integral_c<int, 6>, mpl::integral_c<int, 7>,
                     mpl::integral_c<int, 8>, mpl::integral_c<int, 9> >
      range_10;
...
typedef std::tuple<mpl::integral_c<int, 1>, mpl::integral_c<int, 3>,
                   mpl::integral_c<int, 5>, mpl::integral_c<int, 6>,
                   mpl::integral_c<int, 7>, mpl::integral_c<int, 8>,
