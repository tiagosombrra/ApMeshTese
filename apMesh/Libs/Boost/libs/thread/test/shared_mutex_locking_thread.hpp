...
class locking_thread {
 ...
 public:
  locking_thread(boost::shared_mutex& rw_mutex_, unsigned& unblocked_count_,
...
class simple_writing_thread {
 ...
 public:
  simple_writing_thread(boost::shared_mutex& rwm_, boost::mutex& finish_mutex_,
...
class simple_reading_thread {
 ...
 public:
  simple_reading_thread(boost::shared_mutex& rwm_, boost::mutex& finish_mutex_,
                        boost::mutex& unblocked_mutex_,
                        unsigned& unblocked_count_)
      : rwm(rwm_),
        finish_mutex(finish_mutex_),
