...
int thr() { throw std::logic_error("123"); }
int p2() {
...
int main() {
  ...
  {       // invalid future copy-constructible
    ...
    BOOST_TEST(!f1.valid());
    BOOST_TEST(f2.valid());
    boost::future<boost::csbl::tuple<boost::future<int>, boost::future<int> > >
  ...
  {  // is_ready shared_future copy-constructible
    ...
    BOOST_TEST(f2.valid());
    BOOST_TEST(f2.is_ready());
    boost::future<boost::csbl::tuple<boost::shared_future<int>,
                                     boost::shared_future<int> > >
        all = boost::when_any(f1, f2);
    BOOST_TEST(f1.valid());
    BOOST_TEST(f2.valid());
    BOOST_TEST(all.valid());
    if (0)  // todo FAILS not yet implemented
      BOOST_TEST(all.is_ready());
    boost::csbl::tuple<boost::shared_future<int>, boost::shared_future<int> >
        res = all.get();
    BOOST_TEST(boost::csbl::get<0>(res).valid());
    BOOST_TEST(boost::csbl::get<1>(res).valid());
    BOOST_TEST(boost::csbl::get<0>(res).is_ready() ||
  ...
  {  // async shared_future copy-constructible
    ...
    boost::shared_future<int> f2 =
        boost::async(boost::launch::async, &p2).share();
    BOOST_TEST(f2.valid());
    boost::future<boost::csbl::tuple<boost::shared_future<int>,
                                     boost::shared_future<int> > >
        all = boost::when_any(f1, f2);
  ...
  {  // deferred shared_future copy-constructible
    boost::shared_future<int> f1 =
        boost::async(boost::launch::deferred, &p1).share();
    boost::shared_future<int> f2 =
        boost::async(boost::launch::deferred, &p2).share();
    boost::future<boost::csbl::tuple<boost::shared_future<int>,
                                     boost::shared_future<int> > >
        all = boost::when_any(f1, f2);
    BOOST_TEST(f1.valid());
  ...
  {  // async futures copy-constructible then()
    ...
    BOOST_TEST(!f2.valid());
    BOOST_TEST(all.valid());
    boost::future<int> sum = all.then(
        [](boost::future<
            boost::csbl::tuple<boost::future<int>, boost::future<int> > >
               f) {
          boost::csbl::tuple<boost::future<int>, boost::future<int> > v =
              f.get();
