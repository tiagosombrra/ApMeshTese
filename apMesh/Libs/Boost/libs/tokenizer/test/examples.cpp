...
int test_main(int /*argc*/, char* /*argv*/[]) {
...

  {
    ...
    std::string answer[] = {"Field 1", "embedded,comma", "quote \"",
                            " escape \\"};
  ...
  // Use token_iterator_generator
  {
    const std::string test_string = "This,,is, a.test..";
    std::string answer[] = {"This", "is", "a", "test"};
    typedef token_iterator_generator<char_delimiters_separator<char> >::type
        Iter;
    Iter begin =
...

  {
    ...
    Iter begin = make_token_iterator<std::string>(
        test_string.begin(), test_string.end(), escaped_list_separator<char>());
    Iter begin_c(begin);
    Iter end;
    BOOST_REQUIRE(std::equal(begin, end, answer));
  ...
  // Test copying
  {
    ...
    beg = make_token_iterator<std::string>(test_string.begin(),
                                           test_string.end(), f);
