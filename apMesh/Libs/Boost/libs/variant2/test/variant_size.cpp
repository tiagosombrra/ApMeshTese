...
template <class T>
using var_size_t = mp_size_t<variant_size<T>::value>;
...
int main() {
  ...
  BOOST_TEST_EQ((variant_size<variant<void, void, void> const volatile>::value),
                3);
  ...
  BOOST_TEST_EQ((variant_size<variant<void, void, void, void> const>::value),
                4);
  BOOST_TEST_EQ((variant_size<variant<void, void, void, void> volatile>::value),
                4);
  BOOST_TEST_EQ(
      (variant_size<variant<void, void, void, void> const volatile>::value), 4);
