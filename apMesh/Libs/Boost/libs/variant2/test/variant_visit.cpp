...
int main() {
...

  {
    ...
    BOOST_TEST_EQ((visit(
                      [](int x1, float x2, double x3) {
                        return (int)(x1 * 100) * 1000000 +
                               (int)(x2 * 100) * 1000 + (int)(x3 * 100);
                      },
                      v1, v2, v3)),
                  100314628);
...

  {
    ...
    BOOST_TEST_EQ((visit(
                      [](int x1, float x2, double x3, char x4) {
                        return (long long)(x1 * 100) * 100000000 +
                               (long long)(x2 * 100) * 100000 +
                               (long long)(x3 * 10000) + (int)x4;
                      },
                      v1, v2, v3, v4)),
                  10031462800 + 'A');
    ...
    visit(
        ...
        std::move(v1), std::move(v2), std::move(v3), std::move(v4));
  }
