...
static Matriz* iniciaMatrizHermite ( )
{
   Matriz *m = new Matriz( 4, 4, "H" );
...
void HermitePatch::mostraMatrizes ( )
{
    ...
    cout << "H:\n" <<
    this->getH().getElem( 0, 0 ) <<" "<< this->getH().getElem( 0, 1 ) <<" "<< this->getH().getElem( 0, 2 ) <<" "<< this->getH().getElem( 0, 3 ) << "\n" <<
	this->getH().getElem( 1, 0 ) <<" "<< this->getH().getElem( 1, 1 ) <<" "<< this->getH().getElem( 1, 2 ) <<" "<< this->getH().getElem( 1, 3 ) << "\n" <<
	this->getH().getElem( 2, 0 ) <<" "<< this->getH().getElem( 2, 1 ) <<" "<< this->getH().getElem( 2, 2 ) <<" "<< this->getH().getElem( 2, 3 ) << "\n" <<
	this->getH().getElem( 3, 0 ) <<" "<< this->getH().getElem( 3, 1 ) <<" "<< this->getH().getElem( 3, 2 ) <<" "<< this->getH().getElem( 3, 3 ) << endl;
...
const Matriz* HermitePatch::H = iniciaMatrizHermite ( );
...
bool sinal_c1, bool sinal_c2, bool sinal_c3, bool sinal_c4 ) : CoonsPatch ( )
{
	...
	Matriz m = this->getH() * this->getGx() * this->getH().transposta();
	delete this->Gx;
	this->Gx = new Matriz(m);

	m = this->getH() * this->getGy() * this->getH().transposta();
	delete this->Gy;
	this->Gy = new Matriz(m);

	m = this->getH() * this->getGz() * this->getH().transposta();
	delete this->Gz;
