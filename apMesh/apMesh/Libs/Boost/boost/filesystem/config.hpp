...
#include <../../Libs/Boost/boost/system/api_config.hpp>  // for BOOST_POSIX_API or BOOST_WINDOWS_API
#include <../../Libs/Boost/boost/detail/workaround.hpp>
...
//
#include <../../Libs/Boost/boost/config/auto_link.hpp>
