...
Method_Sequential::Method_Sequential(int argc, char* argv[])
{
}

Method_Sequential::~Method_Sequential()
{
   // delete *BezierPatch::B;
   // delete &HermitePatch::H;
}

int Method_Sequential::execute(Timer *timer)
{
    bool use_examples = true;
    geraMalha = true;
