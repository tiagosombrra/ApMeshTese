...
/*constexpr UInt Numerical::ISymmetricMatrix::numElements2(UInt rows)
{
...
Numerical::SymmetricMatrix::SymmetricMatrix(UInt rows) :
    Numerical::ISymmetricMatrix::ISymmetricMatrix(),
    Numerical::TDMatrix<Real>::TDMatrix(1, Numerical::ISymmetricMatrix::numElements2(rows))
{
...
{
    this->reallocate(1, Numerical::ISymmetricMatrix::numElements2(rows));
}
