...
class PatchHermite : public PatchCoons,
 ...
 public:
  ...
  //	C4		C2
  //		C1
  PatchHermite(std::shared_ptr<CurveAdaptive> curve1,
               std::shared_ptr<CurveAdaptive> curve2,
               std::shared_ptr<CurveAdaptive> curve3,
               std::shared_ptr<CurveAdaptive> curve4, VectorAdaptive tw00,
               VectorAdaptive tw10, VectorAdaptive tw01, VectorAdaptive tw11,
