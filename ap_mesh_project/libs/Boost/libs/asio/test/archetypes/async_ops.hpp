...
async_op_0(BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void()>::completion_handler_type handler_type;

  boost::asio::async_completion<CompletionToken, void()> completion(token);
...
async_op_ec_0(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(boost::system::error_code)>::completion_handler_type
      handler_type;
  ...
  if (ok) {
    ex.post(bindns::bind(BOOST_ASIO_MOVE_CAST(handler_type)(
...
async_op_ex_0(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(std::exception_ptr)>::completion_handler_type
      handler_type;

  boost::asio::async_completion<CompletionToken, void(std::exception_ptr)>
      completion(token);
...
async_op_1(BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(int)>::completion_handler_type handler_type;

  boost::asio::async_completion<CompletionToken, void(int)> completion(token);
...
async_op_ec_1(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(boost::system::error_code,
                            int)>::completion_handler_type handler_type;
...
async_op_ex_1(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(std::exception_ptr, int)>::completion_handler_type
      handler_type;

  boost::asio::async_completion<CompletionToken, void(std::exception_ptr, int)>
      completion(token);
...
async_op_2(BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(int, double)>::completion_handler_type handler_type;

  boost::asio::async_completion<CompletionToken, void(int, double)> completion(
      token);
...
async_op_ec_2(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(boost::system::error_code, int,
                            double)>::completion_handler_type handler_type;
...
async_op_ex_2(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(std::exception_ptr, int,
                            double)>::completion_handler_type handler_type;
...
async_op_3(BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(int, double, char)>::completion_handler_type
      handler_type;

  boost::asio::async_completion<CompletionToken, void(int, double, char)>
      completion(token);
...
async_op_ec_3(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(boost::system::error_code, int, double,
                            char)>::completion_handler_type handler_type;

  boost::asio::async_completion<CompletionToken, void(boost::system::error_code,
                                                      int, double, char)>
      completion(token);
...
async_op_ex_3(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token) {
  typedef typename boost::asio::async_completion<
      CompletionToken, void(std::exception_ptr, int, double,
                            char)>::completion_handler_type handler_type;
