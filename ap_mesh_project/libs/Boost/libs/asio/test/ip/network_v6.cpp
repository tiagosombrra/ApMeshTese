...
void test() {
  ...
  BOOST_ASIO_CHECK(
      network_v6(make_address_v6("2001:370::10:7344"), 128).network() ==
      make_address_v6("2001:370::10:7344"));
  BOOST_ASIO_CHECK(
      network_v6(make_address_v6("2001:370::10:7344"), 64).network() ==
      make_address_v6("2001:370::"));
  BOOST_ASIO_CHECK(
      network_v6(make_address_v6("2001:370::10:7344"), 27).network() ==
      make_address_v6("2001:360::"));

  // construct address range from string in CIDR notation
  BOOST_ASIO_CHECK(make_network_v6("2001:370::10:7344/128").network() ==
                   make_address_v6("2001:370::10:7344"));
  BOOST_ASIO_CHECK(make_network_v6("2001:370::10:7344/64").network() ==
                   make_address_v6("2001:370::"));
  BOOST_ASIO_CHECK(make_network_v6("2001:370::10:7344/27").network() ==
                   make_address_v6("2001:360::"));
  ...
  // prefix length
  BOOST_ASIO_CHECK(make_network_v6("2001:370::10:7344/128").prefix_length() ==
                   128);
  BOOST_ASIO_CHECK(
      network_v6(make_address_v6("2001:370::10:7344"), 27).prefix_length() ==
      27);
  ...
  BOOST_ASIO_CHECK(
      network_v6(make_address_v6("2001:370::10:7344"), 27).to_string() ==
      std::string("2001:370::10:7344/27"));

  // return host part
  BOOST_ASIO_CHECK(make_network_v6("2001:370::10:7344/64").address() ==
                   make_address_v6("2001:370::10:7344"));
  BOOST_ASIO_CHECK(
      make_network_v6("2001:370::10:7344/27").address().to_string() ==
      "2001:370::10:7344");

  // return network in CIDR notation
  BOOST_ASIO_CHECK(
      make_network_v6("2001:370::10:7344/27").canonical().to_string() ==
      "2001:360::/27");
  ...
  // is real subnet of
  BOOST_ASIO_CHECK(make_network_v6("2001:370::10:3744/64")
                       .is_subnet_of(make_network_v6("2001:370::/16")));
  BOOST_ASIO_CHECK(make_network_v6("2001:370::/64")
                       .is_subnet_of(make_network_v6("2001:370::/16")));
  BOOST_ASIO_CHECK(make_network_v6("2001:0db8:85a3::/64")
                       .is_subnet_of(make_network_v6("2001:0d00::/24")));

  BOOST_ASIO_CHECK(
      !make_network_v6("2001:370::10:3744/128")
           .is_subnet_of(make_network_v6("2001:370::10:3744/128")));
  BOOST_ASIO_CHECK(make_network_v6("2001:0db8:85a3::/64")
                       .is_subnet_of(make_network_v6("2001:0dc0::/24")));
  ...
  BOOST_ASIO_CHECK(std::distance(net14.hosts().begin(), net14.hosts().end()) ==
                   8);
  BOOST_ASIO_CHECK(std::distance(net15.hosts().begin(), net15.hosts().end()) ==
                   512);
  BOOST_ASIO_CHECK(*net12.hosts().begin() == make_address_v6("2001:0370::"));
  BOOST_ASIO_CHECK(
      net12.hosts().end() !=
      net12.hosts().find(make_address_v6("2001:0370::ffff:ffff:ffff:ffff")));
  BOOST_ASIO_CHECK(*net13.hosts().begin() == make_address_v6("2001:0db8::"));
  BOOST_ASIO_CHECK(net13.hosts().end() !=
                   net13.hosts().find(make_address_v6("2001:0db8::1")));
  BOOST_ASIO_CHECK(net13.hosts().end() ==
                   net13.hosts().find(make_address_v6("2001:0db8::2")));
  BOOST_ASIO_CHECK(*net14.hosts().begin() == make_address_v6("2001:0db8::"));
  BOOST_ASIO_CHECK(net14.hosts().end() !=
                   net14.hosts().find(make_address_v6("2001:0db8::7")));
  BOOST_ASIO_CHECK(net14.hosts().end() ==
                   net14.hosts().find(make_address_v6("2001:0db8::8")));
  BOOST_ASIO_CHECK(*net15.hosts().begin() == make_address_v6("2001:0db8::"));
  BOOST_ASIO_CHECK(net15.hosts().end() !=
                   net15.hosts().find(make_address_v6("2001:0db8::01ff")));
  BOOST_ASIO_CHECK(net15.hosts().end() ==
                   net15.hosts().find(make_address_v6("2001:0db8::0200")));
}
...
BOOST_ASIO_TEST_SUITE("ip/network_v6",
