...
int package_0() { return 42; }

int package_ec_0(boost::system::error_code ec) { return ec ? 0 : 42; }

int package_ex_0(std::exception_ptr ex) { return ex ? 0 : 42; }
...
int package_1(int i) { return i; }

int package_ec_1(boost::system::error_code ec, int i) { return ec ? 0 : i; }

int package_ex_1(std::exception_ptr ex, int i) { return ex ? 0 : i; }
...
int package_2(int i, double) { return i; }

int package_ec_2(boost::system::error_code ec, int i, double) {
  return ec ? 0 : i;
}

int package_ex_2(std::exception_ptr ex, int i, double) { return ex ? 0 : i; }
...
int package_3(int i, double, char) { return i; }
...
BOOST_ASIO_TEST_SUITE("use_future", BOOST_ASIO_TEST_CASE(null_test))
