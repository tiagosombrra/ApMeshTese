...
void test_handler() {
  std::string v5 = BOOST_STRINGIZE(BOOST_ASSERT(x5));
  std::string w5 =
      "(BOOST_LIKELY(!!(x5))? ((void)0): ::boost::assertion_failed(\"x5\", "
...
void test_handler_ndebug() {
  std::string v6 = BOOST_STRINGIZE(BOOST_ASSERT(x6));
  std::string w6 =
      "(BOOST_LIKELY(!!(x6))? ((void)0): ::boost::assertion_failed(\"x6\", "
      "BOOST_CURRENT_FUNCTION, \"" +
      quote(__FILE__) + "\", " BOOST_STRINGIZE(__LINE__) "))";
...
void test_debug_handler() {
  std::string v7 = BOOST_STRINGIZE(BOOST_ASSERT(x7));
  std::string w7 =
      "(BOOST_LIKELY(!!(x7))? ((void)0): ::boost::assertion_failed(\"x7\", "
      "BOOST_CURRENT_FUNCTION, \"" +
      quote(__FILE__) + "\", " BOOST_STRINGIZE(__LINE__) "))";
