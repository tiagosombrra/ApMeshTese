...
struct my_exception : public std::runtime_error {
  ...
  my_exception(ctx::continuation&& c_, char const* what)
      : std::runtime_error(what), c{std::move(c_)} {}
};
...
void test_move() {
  ...
  ctx::continuation c1 = ctx::callcc([&i](ctx::continuation&& c) {
    value1 = i;
    c = c.resume();
    value1 = i;
    return std::move(c);
...
void test_bind() {
  ...
  X x;
  ctx::continuation c =
      ctx::callcc(std::bind(&X::foo, x, std::placeholders::_1, 7));
...
void test_exception() {
  {
    ...
    ctx::continuation c = ctx::callcc([&what](ctx::continuation&& c) {
      try {
...
void test_fp() {
  value3 = 0.;
  double d = 7.13;
  ctx::continuation c = ctx::callcc([&d](ctx::continuation&& c) {
    d += 3.45;
    value3 = d;
    return std::move(c);
  });
...
void test_stacked() {
  ...
  ctx::continuation c = ctx::callcc([](ctx::continuation&& c) {
    ctx::continuation c1 = ctx::callcc([](ctx::continuation&& c) {
      value1 = 3;
      return std::move(c);
    });
    value3 = 3.14;
...
void test_prealloc() {
  ...
  int i = 7;
  ctx::continuation c =
      ctx::callcc(std::allocator_arg, ctx::preallocated(sp, size, sctx), alloc,
...
void test_ontop() {
  {
    ...
    c = c.resume_with([&i](ctx::continuation&& c) {
      i -= 10;
      return std::move(c);
    });
    BOOST_CHECK(c);
  ...
  }
  {
    ...
    c = c.resume_with([&c1](ctx::continuation&& c) {
      c1 = std::move(c);
      return std::move(c);
    });
  }
...
void test_ontop_exception() {
  ...
  BOOST_CHECK_EQUAL(3, value1);
  const char* what = "hello world";
  c.resume_with([what](ctx::continuation&& c) {
