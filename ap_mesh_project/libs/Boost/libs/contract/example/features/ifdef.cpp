...
template <typename T>
void pushable<T>::push_back(T const& x
#ifndef BOOST_CONTRACT_NO_PUBLIC_FUNCTIONS
                            ,
...
#undef BASES
...
#ifndef BOOST_CONTRACT_NO_INVARIANTS
  void invariant() const { BOOST_CONTRACT_ASSERT(size() <= capacity()); }
#endif
 ...
 public:
  ...
  virtual void push_back(int const& x
#ifndef BOOST_CONTRACT_NO_PUBLIC_FUNCTIONS
                         ,
                         boost::contract::virtual_* v = 0
#endif
    ...
    boost::contract::check c =
        boost::contract::public_function<override_push_back>(
...
#endif
#ifndef BOOST_CONTRACT_NO_OLDS
            .old([&] { old_size = BOOST_CONTRACT_OLDOF(v, size()); })
#endif
#ifndef BOOST_CONTRACT_NO_POSTCONDITIONS
            .postcondition(
            ...
            .except([&] { BOOST_CONTRACT_ASSERT(size() == *old_size); })
#endif
        ;
#endif
