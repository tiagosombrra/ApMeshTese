...
struct package {
  ...
  explicit package(double _weight_kg, std::string const& _location = "",
                   double _accepted_hour = 0.0, double _delivered_hour = 0.0)
...
#undef BASES
 ...
 public:
  ...
  virtual void deliver(package& package_delivery,
        ...
        boost::contract::public_function(v, this)
            ...
            .postcondition([&] {
              ...
              BOOST_CONTRACT_ASSERT(double(package_delivery.delivered_hour -
                                           package_delivery.accepted_hour) <=
                                    3.0);
...
#define BASES \
 private      \
  boost::contract::constructor_precondition<different_courier>, public courier
    : BASES {
  friend class boost::contract::access;
...
#undef BASES
 ...
 public:
  ...
  virtual void deliver(package& package_delivery,
    ...
    boost::contract::check c =
        boost::contract::public_function<override_deliver>(
