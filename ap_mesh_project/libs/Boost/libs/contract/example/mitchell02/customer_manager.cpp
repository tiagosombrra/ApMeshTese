...
class customer_manager {
 ...
 public:
  ...
  void set_name(customer_info::identifier const& id, std::string const& name) {
    boost::contract::check c =
        boost::contract::public_function(this)
            .precondition([&] {
 ...
 private:
  ...
  struct customer : customer_info {
    ...
    explicit customer(customer_info const& info)
        : customer_info(info), managing_agent(), last_contact() {}
  };
