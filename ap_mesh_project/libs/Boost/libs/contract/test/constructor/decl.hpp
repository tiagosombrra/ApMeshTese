...
#endif
{
  ...
  static void static_invariant() {
    ...
    if (c_entering_static_inv)
      BOOST_CONTRACT_ASSERT(c_entry_static_inv);
    else
      BOOST_CONTRACT_ASSERT(c_exit_static_inv);
...
#define BASES \
 private      \
  boost::contract::constructor_precondition<b>, public c
#else
#define BASES \
 public       \
  c
...
#undef BASES
  ...
  static void static_invariant() {
    ...
    if (b_entering_static_inv)
      BOOST_CONTRACT_ASSERT(b_entry_static_inv);
    else
      BOOST_CONTRACT_ASSERT(b_exit_static_inv);
...
#undef BASES
  ...
  static void static_invariant() {
    ...
    if (a_entering_static_inv)
      BOOST_CONTRACT_ASSERT(a_entry_static_inv);
    else
      BOOST_CONTRACT_ASSERT(a_exit_static_inv);
