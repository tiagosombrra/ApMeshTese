...
int main() {
...
#endif
    ok.str("");
    ok << ok_c() << ok_ba()  // Test a::ctor::post failed.
        ;
    BOOST_TEST(out.eq(ok.str()));
  } catch (...) {
    BOOST_TEST(false);
  ...
  c_post = true;
  {
    ...
    a aa;
    ok.str("");
    ok << ok_c() << ok_ba()  // Test no b::ctor::post so no failure.
        ;
    BOOST_TEST(out.eq(ok.str()));
  }
...
#endif
    ok.str("");
    ok << ok_c()  // Test c::ctor::post failed.
...
#endif
    ok.str("");
    ok << ok_c()  // Test c::ctor::post failed (as all did).
#ifdef BOOST_CONTRACT_NO_POSTCONDITIONS
       << ok_ba()
#endif
        ;
