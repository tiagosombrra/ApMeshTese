...
int main() {
  ...
  c_post = true;
  {
    ...
    a aa;
    ok.str("");
    ok << ok_cb() << ok_a()  // Test no a::ctor::post so no failure.
        ;
    BOOST_TEST(out.eq(ok.str()));
  }
...
#endif
    ok.str("");
    ok << ok_cb()  // Test b::ctor::post failed.
  ...
  c_post = false;
  {
    ...
    a aa;
    ok.str("");
    ok << ok_cb()  // Test no c::ctor::post so no failure.
       << ok_a();
    BOOST_TEST(out.eq(ok.str()));
  }
...
#endif
    ok.str("");
    ok << ok_cb()  // Test b::ctor::post failed (as all did).
#ifdef BOOST_CONTRACT_NO_POSTCONDITIONS
       << ok_a()
#endif
        ;
