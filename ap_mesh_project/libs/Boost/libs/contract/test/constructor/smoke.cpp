...
#define BASES                                                  \
 private                                                       \
  boost::contract::constructor_precondition<c>, public t<'d'>, \
      protected t<'p'>, private t<'q'>, public t<'e'>
    : BASES {
  typedef BOOST_CONTRACT_BASE_TYPES(BASES) base_types;
#undef BASES
...
#define BASES \
 private      \
  boost::contract::constructor_precondition<a>, public b, public c
    : BASES {
  typedef BOOST_CONTRACT_BASE_TYPES(BASES) base_types;
#undef BASES
  ...
  explicit a(x_type& x, c::y_type& y, t<'d'>::z_type& dz, t<'p'>::z_type& pz,
             t<'q'>::z_type& qz, t<'e'>::z_type& ez)
