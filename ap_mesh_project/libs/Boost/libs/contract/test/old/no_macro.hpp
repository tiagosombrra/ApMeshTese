...
struct i_tag;
typedef boost::contract::test::detail::counter<i_tag, int> i_type;
struct j_tag;
typedef boost::contract::test::detail::counter<j_tag, int> j_type;
...
void b::swap(i_type& i, j_type& j, boost::contract::virtual_* v) {
  BOOST_CONTRACT_TEST_OLD_PTR_TYPE<i_type> old_i = boost::contract::make_old(
      v, boost::contract::copy_old(v) ? i_type::eval(i)
  ...
  boost::contract::check c =
      boost::contract::public_function(v, this)
          ...
          .old([&] {
            ...
            old_j = boost::contract::make_old(
                v, boost::contract::copy_old(v) ? j_type::eval(j)
                                                : boost::contract::null_old());
          })
          .postcondition([&] {
...
#undef BASES
  ...
  /* override */ {
    boost::contract::check c = boost::contract::public_function<override_swap>(
        v, &a::swap, this, i, j);
...
void swap(x_type& x, y_type& y) {
  BOOST_CONTRACT_TEST_OLD_PTR_TYPE<x_type> old_x = boost::contract::make_old(
      boost::contract::copy_old() ? x_type::eval(x)
                                  : boost::contract::null_old());
  ...
  boost::contract::check c =
      boost::contract::function()
          ...
          .old([&] {
            ...
            old_y = boost::contract::make_old(
                boost::contract::copy_old() ? y_type::eval(y)
                                            : boost::contract::null_old());
          })
          .postcondition([&] {
