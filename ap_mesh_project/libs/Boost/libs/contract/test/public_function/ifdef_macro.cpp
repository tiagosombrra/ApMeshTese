...
struct b {
  BOOST_CONTRACT_STATIC_INVARIANT({
    boost::contract::test::detail::unprotected_commas<void, void, void>::call();
...
void b::f(int x, boost::contract::virtual_* v) {
  BOOST_CONTRACT_OLD_PTR(
      boost::contract::test::detail::unprotected_commas<int, void, void>::type1)
  ((boost::contract::test::detail::unprotected_commas<void, void, void>::same(
       v)),
   old_x,
   (boost::contract::test::detail::unprotected_commas<void, void, void>::same(
       x)));
...
#define BASES \
 public       \
  boost::contract::test::detail::unprotected_commas<b, void, void>::type1
    : BASES {
