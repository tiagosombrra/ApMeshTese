...
#define BOOST_CONTRACT_TEST_MAX_ARGS_N_(z, n, unused) n
...
#define BOOST_CONTRACT_TEST_MAX_ARGS_B_F_(z, n, unused)                        \
  virtual int BOOST_PP_CAT(f, n)(                                              \
      BOOST_PP_REPEAT_##z(n, BOOST_CONTRACT_TEST_MAX_ARGS_PARAM_COMMA_, ~)     \
    ...
    boost::contract::check c =                                                 \
        boost::contract::public_function(v, result, this)                      \
            .precondition([] {                                                 \
              out << "b::"                                                     \
                  << BOOST_PP_STRINGIZE(BOOST_PP_CAT(f, n))                    \
                                                     << "::pre" << std::endl;  \
            })                                                                 \
            .old([] {                                                          \
              out << "b::"                                                     \
    ...
    out << "b::"                                                               \
        << BOOST_PP_STRINGIZE(BOOST_PP_CAT(f, n)) << "::body" << std::endl;    \
    return result;                                                             \
  }
...
#define BOOST_CONTRACT_TEST_MAX_ARGS_A_F_(z, n, unused)                        \
  int BOOST_PP_CAT(f, n)(                                                      \
    ...
    int result = 0;                                                            \
    boost::contract::check c =                                                 \
        boost::contract::public_function<BOOST_PP_CAT(override_,               \
                                                      BOOST_PP_CAT(f, n))>(    \
            v, result, &a::BOOST_PP_CAT(f, n),                                 \
            this BOOST_PP_REPEAT_##z(                                          \
...
#define BOOST_CONTRACT_TEST_MAX_ARGS_TEST_(z, n, unused)                                              \
  out.str("");                                                                                        \
  aa.BOOST_PP_CAT(                                                                                    \
      f, n)(BOOST_PP_ENUM_##z(n, BOOST_CONTRACT_TEST_MAX_ARGS_N_, ~));                                \
  ok.str("");                                                                                         \
  ok BOOST_PP_EXPR_IIF(BOOST_CONTRACT_TEST_entry_inv, << "b::static_inv\n"                            \
                                                      << "b::inv\n"                                   \
                                                      << "a::static_inv\n"                            \
                                                      << "a::inv\n")                                  \
      BOOST_PP_EXPR_IIF(                                                                              \
          BOOST_CONTRACT_TEST_pre,                                                                    \
          << "b::" << BOOST_PP_STRINGIZE(BOOST_PP_CAT(f, n)) << "::pre\n")                            \
                 BOOST_PP_EXPR_IIF(                                                                   \
                     BOOST_CONTRACT_TEST_old,                                                         \
                     << "b::"                                                                         \
                     << BOOST_PP_STRINGIZE(BOOST_PP_CAT(f, n))                                        \
                            << "::old\n"                                                              \
                            << "a::"                                                                  \
