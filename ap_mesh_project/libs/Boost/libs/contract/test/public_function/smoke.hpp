...
#define BASES \
 public       \
  t<'d'>, protected t<'p'>, private t<'q'>, public t<'e'>
    : BASES {
...
#undef BASES
  ...
  /* override */ {
    ...
    boost::contract::old_ptr<s_type> old_s;
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, result, &c::f, this, s)
            .precondition([&] {
...
#pragma clang diagnostic ignored "-Woverloaded-virtual"  // For a::f.
  ...
  /* override */ {
    ...
    boost::contract::old_ptr<s_type> old_s;
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, result, &a::f, this, s)
            .precondition([&] {
