...
#undef BASES
  ...
  virtual void f(char ch, boost::contract::virtual_* v = 0) /* override */ {
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, &h::f, this, ch)
            .precondition([&] {
...
#undef BASES
  ...
  virtual void f(char ch, boost::contract::virtual_* v = 0) /* override */ {
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, &e::f, this, ch)
            .precondition([&] {
...
#define BASES \
 public       \
  b, public x, public e, protected y, public h, private z
    : BASES {
  typedef BOOST_CONTRACT_BASE_TYPES(BASES) base_types;
#undef BASES
  ...
  virtual void f(char ch, boost::contract::virtual_* v = 0) /* override */ {
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, &a::f, this, ch)
            .precondition([&] {
