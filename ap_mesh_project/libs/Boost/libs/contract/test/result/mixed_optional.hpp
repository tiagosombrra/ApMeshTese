...
struct d {
  ...
  virtual BOOST_CONTRACT_TEST_CH_TYPE f(ch_type& ch,
...
#undef BASES
  ...
  virtual BOOST_CONTRACT_TEST_CH_TYPE f(
    ...
    boost::optional<BOOST_CONTRACT_TEST_CH_TYPE> result;
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, result, &c::f, this, ch)
            .precondition([&] {
...
#undef BASES
  ...
  virtual BOOST_CONTRACT_TEST_CH_TYPE f(
    ...
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, result, &b::f, this, ch)
            .precondition([&] {
...
#undef BASES
  ...
  virtual BOOST_CONTRACT_TEST_CH_TYPE f(
    ...
    boost::optional<BOOST_CONTRACT_TEST_CH_TYPE> result;
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, result, &a::f, this, ch)
            .precondition([&] {
...
#undef BASES
  ...
  virtual BOOST_CONTRACT_TEST_CH_TYPE f(
    ...
    BOOST_CONTRACT_TEST_CH_TYPE result BOOST_CONTRACT_TEST_CH_INIT;
    boost::contract::check c =
        boost::contract::public_function<override_f>(v, result, &e::f, this, ch)
            .precondition([&] {
