...
int main(int, char const*[]) {
  ...
  BOOST_TEST("12xxx" ==
             convert<string>(12, cnv(arg::width = 5)(arg::fill = 'x')(
                                     arg::adjust = cnv::adjust::left))
                 .value());
  BOOST_TEST(L"12xxx" ==
             convert<wstring>(12, cnv(arg::width = 5)(arg::fill = 'x')(
                                      arg::adjust = cnv::adjust::left))
                 .value());
  BOOST_TEST(
      "x12xx" ==
      convert<string>(12, cnv(arg::adjust = cnv::adjust::center)).value());
  BOOST_TEST(
      L"x12xx" ==
      convert<wstring>(12, cnv(arg::adjust = cnv::adjust::center)).value());
