...
struct node {
  ...
  // construct leaf
  node(const std::string& v) : left(), right(), value(v) {}
...
node::ptr_t create_left_tree_from(const std::string& root) {
  ...
  return node::create(node::create(node::create("a"), "b", node::create("c")),
                      root, node::create("e"));
}
...
node::ptr_t create_right_tree_from(const std::string& root) {
  ...
  return node::create(node::create("a"), root,
                      node::create(node::create("c"), "d", node::create("e")));
}
...
int main() {
  {
    ...
    node::ptr_t right_x(create_right_tree_from("x"));
    {
      ...
      std::copy(std::begin(left_d_reader), std::end(left_d_reader),
      ...
      std::copy(std::begin(right_b_reader), std::end(right_b_reader),
                std::ostream_iterator<std::string>(std::cout, " "));
      std::cout << std::endl;
      ...
      std::copy(std::begin(right_x_reader), std::end(right_x_reader),
                std::ostream_iterator<std::string>(std::cout, " "));
      std::cout << std::endl;
    }
  }
  {
    ...
    node::ptr_t right_b(create_right_tree_from("b"));
    {
      ...
      std::cout << "left tree from d == right tree from b? " << std::boolalpha
  ...
  }
  {
    ...
    node::ptr_t right_x(create_right_tree_from("x"));
    {
      ...
      std::cout << "left tree from d == right tree from x? " << std::boolalpha
                << std::equal(std::begin(left_d_reader),
                              std::end(left_d_reader),
