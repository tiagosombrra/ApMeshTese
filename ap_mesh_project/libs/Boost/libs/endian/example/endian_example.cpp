...
int main(int, char*[]) {
  ...
  //  sometimes used for binary file operations when ultimate efficiency is
  //  important. Such I/O is often performed in some C++ wrapper class, but to
  //  drive home the point that endian integers are often used in fairly
  //  low-level code that does bulk I/O operations, <cstdio> fopen/fwrite is
  //  used for I/O in this example.
