...
template <BOOST_SCOPED_ENUM(boost::endian::order) Order,
          BOOST_SCOPED_ENUM(boost::endian::align) Align, class T>
void test_arithmetic_(T const& x) {
...
template <class T>
void test_arithmetic(T const& x) {
