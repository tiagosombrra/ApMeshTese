...
class byte_span {
 ...
 public:
  ...
  explicit byte_span(unsigned char const (&a)[N]) : p_(a), n_(N) {}
...
void test_3() {
  {
    ...
    boost::endian::endian_store<T, 3, boost::endian::order::little>(v,
                                                                    0x010203);
...
void test_4() {
  {
    ...
    boost::endian::endian_store<T, 4, boost::endian::order::little>(v,
                                                                    0x01020304);
...
void test_5() {
  {
    ...
    boost::endian::endian_store<T, 5, boost::endian::order::little>(
        v, 0x0102030405);
...

  {
    ...
    boost::endian::endian_store<T, 5, boost::endian::order::big>(v,
                                                                 0x0102030405);
...
void test_6() {
  {
    ...
    boost::endian::endian_store<T, 6, boost::endian::order::little>(
        v, 0x010203040506);
...

  {
    ...
    boost::endian::endian_store<T, 6, boost::endian::order::big>(
        v, 0x010203040506);
...
void test_7() {
  {
    ...
    boost::endian::endian_store<T, 7, boost::endian::order::little>(
        v, 0x01020304050607);
...

  {
    ...
    boost::endian::endian_store<T, 7, boost::endian::order::big>(
        v, 0x01020304050607);
...
void test_8() {
  {
    ...
    boost::endian::endian_store<T, 8, boost::endian::order::little>(
...

  {
    ...
    boost::endian::endian_store<T, 8, boost::endian::order::big>(
        v, 0x0102030405060708);
