  ...
  }
  {
    ...
    if (x != total)
      throw std::logic_error(
          "integer approach total != conversion approach total");
    cout << "<td align=\"right\">" << t.format(places, "%t") << " s</td>";
  }
}
...
int cpp_main(int argc, char* argv[]) {
  ...
  cout << "<html>\n<head>\n<title>Endian Loop Time "
          "Test</title>\n</head>\n<body>\n"
       << "<!-- boost-no-inspect -->\n"
       << "<div align=\"center\"> <center>\n"
       << "<table border=\"1\" cellpadding=\"5\" cellspacing=\"0\""
       << "style=\"border-collapse: collapse\" bordercolor=\"#111111\">\n"
       << "<tr><td colspan=\"6\" align=\"center\"><b>" << BOOST_COMPILER
       << "</b></td></tr>\n"
       << "<tr><td colspan=\"6\" align=\"center\"><b>"
       << " Iterations: " << with_digit_separator(n)
       << ", Intrinsics: " BOOST_ENDIAN_INTRINSIC_MSG << "</b></td></tr>\n"
