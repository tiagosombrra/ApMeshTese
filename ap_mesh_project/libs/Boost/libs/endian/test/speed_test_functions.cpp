...
//  These functions are in a separate compilation unit partially to defeat
//  optimizers and partially to create a worst case scenario. They are in a user
//  namespace for realism.
...
int16_t return_x_little_int16(int16_t x, little_int16_t) BOOST_NOEXCEPT {
  return x;
}
...
int16_t return_x_inplace_little_int16(int16_t x,
                                      little_int16_t) BOOST_NOEXCEPT {
...
int32_t return_x_little_int32(int32_t x, little_int32_t) BOOST_NOEXCEPT {
  return x;
}
...
int32_t return_x_inplace_little_int32(int32_t x,
                                      little_int32_t) BOOST_NOEXCEPT {
  conditional_reverse_inplace<order::native, order::little>(x);
  return x;
}
...
int64_t return_x_little_int64(int64_t x, little_int64_t) BOOST_NOEXCEPT {
  return x;
}
...
int64_t return_x_inplace_little_int64(int64_t x,
                                      little_int64_t) BOOST_NOEXCEPT {
  conditional_reverse_inplace<order::native, order::little>(x);
  return x;
}
