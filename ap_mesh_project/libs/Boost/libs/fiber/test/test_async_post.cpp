...
void test_async_1() {
  boost::fibers::future<void> f1 =
      boost::fibers::async(boost::fibers::launch::post, fn1);
...
void test_async_2() {
  ...
  boost::fibers::future<int> f1 =
      boost::fibers::async(boost::fibers::launch::post, fn2, i);
  BOOST_CHECK(f1.valid());
...
void test_async_3() {
  int i = 7;
  boost::fibers::future<int&> f1 =
      boost::fibers::async(boost::fibers::launch::post, fn3, std::ref(i));
  BOOST_CHECK(f1.valid());
...
void test_async_4() {
  ...
  boost::fibers::future<A> f1 =
      boost::fibers::async(boost::fibers::launch::post, fn4, std::move(a1));
  BOOST_CHECK(f1.valid());
...
void test_async_5() {
  ...
  boost::fibers::future<void> f1 = boost::fibers::async(
      boost::fibers::launch::post, std::bind(&X::foo, std::ref(x), 3));
  BOOST_CHECK(f1.valid());
