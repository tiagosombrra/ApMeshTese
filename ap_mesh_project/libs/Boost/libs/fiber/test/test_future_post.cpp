...
void test_future_wait_for() {
  ...
  boost::fibers::fiber(boost::fibers::launch::post, fn11, std::move(p1))
      .detach();
...
void test_future_wait_for_ref() {
  ...
  boost::fibers::fiber(boost::fibers::launch::post, fn12, std::move(p1))
      .detach();
...
void test_future_wait_for_void() {
  ...
  boost::fibers::fiber(boost::fibers::launch::post, fn13, std::move(p1))
      .detach();
