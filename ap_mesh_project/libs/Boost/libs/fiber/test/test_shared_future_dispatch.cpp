...
struct my_exception : public std::runtime_error {
  my_exception() : std::runtime_error("my_exception") {}
};
...
void fn6() { boost::throw_exception(my_exception()); }

int& fn7() { return gi; }

int fn8(int i) { return i; }
...
void test_shared_future_wait_for() {
  ...
  boost::fibers::fiber(boost::fibers::launch::dispatch, fn11, std::move(p1))
      .detach();
...
void test_shared_future_wait_for_ref() {
  ...
  boost::fibers::fiber(boost::fibers::launch::dispatch, fn12, std::move(p1))
      .detach();
...
void test_shared_future_wait_for_void() {
  ...
  boost::fibers::fiber(boost::fibers::launch::dispatch, fn13, std::move(p1))
      .detach();
