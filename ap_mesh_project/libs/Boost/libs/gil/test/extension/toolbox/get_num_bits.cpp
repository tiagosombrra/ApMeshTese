...
void test_get_num_bits() {
  ...
  using const_channel_t =
      gil::channel_type<image_t::const_view_t::reference>::type;
  ...
  using gray8_channel_t =
      gil::channel_type<gil::gray8_image_t::view_t::value_type>::type;
  static_assert(gil::get_num_bits<gray8_channel_t>::value == 8, "");

  using rgba32_channel_t =
      gil::channel_type<gil::rgba32_image_t::view_t::value_type>::type;
  static_assert(gil::get_num_bits<rgba32_channel_t>::value == 32, "");
}

int main() { test_get_num_bits(); }
