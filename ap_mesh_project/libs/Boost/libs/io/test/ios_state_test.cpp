...
void saver_tests_1(int index, std::istream& input, std::ostream& output,
                   std::ostream& err) {
...
void saver_tests_2(int index, std::istream& input, std::ostream& output,
                   std::ostream& err) {
  ...
  boost::io::ios_flags_saver ifls(
      output, (output.flags() & ~std::ios_base::adjustfield) |
