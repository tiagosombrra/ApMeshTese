...
struct new_random_access : std::random_access_iterator_tag,
...
int main() {
  ...
  boost::function_requires<boost_concepts::WritableIteratorConcept<int*> >();
  boost::function_requires<boost_concepts::LvalueIteratorConcept<int*> >();
