...
int main() {
  {
    ...
    boost::function_requires<
        boost_concepts::WritableIteratorConcept<rev_iter> >();
    boost::function_requires<
        boost_concepts::LvalueIteratorConcept<rev_iter> >();
    boost::function_requires<
        boost_concepts::RandomAccessTraversalConcept<rev_iter> >();
    boost::function_requires<boost::RandomAccessIteratorConcept<rev_iter> >();
    boost::function_requires<
        boost_concepts::InteroperableIteratorConcept<rev_iter, c_rev_iter> >();
  }
        ...
        !BOOST_WORKAROUND(BOOST_DINKUMWARE_STDLIB, <= 1)
  {
    ...
    boost::function_requires<
        boost_concepts::ReadableIteratorConcept<c_rev_iter> >();
    boost::function_requires<
        boost_concepts::LvalueIteratorConcept<c_rev_iter> >();
    boost::function_requires<
        boost_concepts::BidirectionalTraversalConcept<c_rev_iter> >();
    boost::function_requires<
        boost::BidirectionalIteratorConcept<c_rev_iter> >();
    boost::function_requires<
        boost_concepts::InteroperableIteratorConcept<rev_iter, c_rev_iter> >();
  }
#endif
