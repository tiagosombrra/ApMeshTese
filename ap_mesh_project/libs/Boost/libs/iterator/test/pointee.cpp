...
int main() {
  ...
  STATIC_ASSERT_SAME(boost::pointee<proxy_ref_ptr<int const> >::type,
                     int const);
  ...
  STATIC_ASSERT_SAME(boost::pointee<proxy_value_ptr<int const> >::type,
                     int const);
  ...
  STATIC_ASSERT_SAME(boost::pointee<std::auto_ptr<int const> >::type,
                     int const);
  ...
  STATIC_ASSERT_SAME(boost::pointee<std::unique_ptr<int const> >::type,
                     int const);
  ...
  STATIC_ASSERT_SAME(boost::pointee<std::list<int>::const_iterator>::type,
                     int const);
  STATIC_ASSERT_SAME(boost::pointee<std::list<X>::const_iterator>::type,
                     X const);
  return 0;
}
