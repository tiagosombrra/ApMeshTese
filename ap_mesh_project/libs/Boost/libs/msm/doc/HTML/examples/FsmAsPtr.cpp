...
BOOST_MSM_EUML_METHOD(ActivateEmpty_, activate_empty, activate_empty_, void,
                      void)
...
// it is also possible to use a plain functor, with default-constructor in the
// transition table
struct start_play {
...
player::player() : fsm_(new my_machine_impl) {
