...
struct parsing_ : public msm::front::state_machine_def<parsing_> {
  ...
  struct Waiting : public msm::front::state<> {
    ...
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Waiting" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Waiting" << std::endl;}
  };
  struct Digit1 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit1" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit1" << std::endl;}
  };
  struct Digit2 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit2" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit2" << std::endl;}
  };
  struct Digit3 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit3" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit3" << std::endl;}
  };
  struct Digit4 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit4" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit4" << std::endl;}
  };
  struct MinusChar1 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: MinusChar1" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: MinusChar1" << std::endl;}
  };
  struct Digit5 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit5" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit5" << std::endl;}
  };
  struct Digit6 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit6" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit6" << std::endl;}
  };
  struct Digit7 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit7" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit7" << std::endl;}
  };
  struct Digit8 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit8" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit8" << std::endl;}
  };
  struct MinusChar2 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: MinusChar2" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: MinusChar2" << std::endl;}
  };
  struct Digit9 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit9" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit9" << std::endl;}
  };
  struct Digit10 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit10" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit10" << std::endl;}
  };
  struct Digit11 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit11" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit11" << std::endl;}
  };
  struct Digit12 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit12" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit12" << std::endl;}
  };
  struct MinusChar3 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: MinusChar3" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: MinusChar3" << std::endl;}
  };
  struct Digit13 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit13" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit13" << std::endl;}
  };
  struct Digit14 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit14" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit14" << std::endl;}
  };
  struct Digit15 : public msm::front::state<> {
    // optional entry/exit methods
    // template <class Event,class FSM>
    // void on_entry(Event const&,FSM& ) {std::cout << "entering: Digit15" <<
    // std::endl;} template <class Event,class FSM> void on_exit(Event
    // const&,FSM& ) {std::cout << "leaving: Digit15" << std::endl;}
  };
  ...
  struct transition_table
      : mpl::vector<
            ...
            //    +-------------+-------------------+---------+---------------------+----------------------+
            Row<Waiting, digit, Digit1>, Row<Digit1, digit, Digit2>,
            Row<Digit2, digit, Digit3>, Row<Digit3, digit, Digit4>,
            Row<Digit4, event_char<'-'>, MinusChar1>,
            Row<MinusChar1, digit, Digit5>, Row<Digit5, digit, Digit6>,
            Row<Digit6, digit, Digit7>, Row<Digit7, digit, Digit8>,
            Row<Digit8, event_char<'-'>, MinusChar2>,
            Row<MinusChar2, digit, Digit9>, Row<Digit9, digit, Digit10>,
            Row<Digit10, digit, Digit11>, Row<Digit11, digit, Digit12>,
            Row<Digit12, event_char<'-'>, MinusChar3>,
            Row<MinusChar3, digit, Digit13>, Row<Digit13, digit, Digit14>,
            Row<Digit14, digit, Digit15>, Row<Digit15, eos, Parsed>,
