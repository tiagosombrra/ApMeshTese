...
struct player_ : public msm::front::state_machine_def<player_> {
  ...
  struct Stopped : public msm::front::state<msm::front::default_base_state,
    ...
    void start_playback(play const&) {
      std::cout << "Stopped::start_playback\n";
    }
  ...
  struct Paused : public msm::front::state<> {
    void pause_playback(pause const&) {
      std::cout << "Paused::pause_playback\n";
    }
    void resume_playback(end_pause const&) {
      std::cout << "Paused::resume_playback\n";
    }
  };
  ...
  struct transition_table
      : mpl::vector<
            ...
            irow2<Empty, cd_detected, Empty, &Empty::internal_action, Empty,
                  &Empty::internal_guard>,
            ...
            //  +---------+-------------+---------+---------------------+----------------------+
            a_row2<Paused, end_pause, Playing, Paused,
