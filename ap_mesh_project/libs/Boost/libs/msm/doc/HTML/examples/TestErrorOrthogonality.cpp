...
struct player_ : public msm::front::state_machine_def<player_> {
  ...
  struct transition_table
      : mpl::vector<
            ...
            //    Guard
            //  +---------+-------------+---------+---------------------+----------------------+
            // adding this line makes non-reachable states and should cause a
            // static assert
            //_row < State1  , open_close  , State2 >,
            // adding this line makes non-orthogonal regions and should cause a
            // static assert
            ...
            _row<Paused, open_close, Open>, _row<AllOk, error_found, ErrorMode>
            //  +---------+-------------+---------+---------------------+----------------------+
            > {};
...
// Pick a back-end
typedef msm::back::state_machine<player_, msm::back::mpl_graph_fsm_check>
    player;
