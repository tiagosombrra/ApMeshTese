...
struct player_ : public msm::front::state_machine_def<player_> {
  ...
  // definition of Empty
  struct Empty_tag {};
  typedef msm::front::euml::func_state<Empty_tag, Empty_Entry, Empty_Exit>
      Empty;
  ...
  // states without entry/exit actions (can be declared as functor state, just
  // without functors ;-) )
  struct Stopped_tag {};
  ...
  bool auto_start(cd_detected const& evt) { return false; }
