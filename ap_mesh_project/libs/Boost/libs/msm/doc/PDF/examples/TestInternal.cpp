...
struct player_ : public msm::front::state_machine_def<player_> {
  ...
  void internal_action(internal_event const&) {
    std::cout << "Playing::internal action\n";
  }
  ...
  struct Empty : public msm::front::state<> {
    ...
    struct internal_transition_table
        : mpl::vector<
              ...
              Row<Empty, cd_detected, none, internal_action_fct,
                  internal_guard_fct>,
  ...
  struct Playing_ : public msm::front::state_machine_def<Playing_> {
    ...
    void start_next_song(NextSong const&) {
      std::cout << "Playing: start_next_song" << std::endl;
    }
    void start_prev_song(PreviousSong const&) {
      std::cout << "Playing: start_prev_song" << std::endl;
    }
    // guard conditions
    ...
    struct internal_transition_table
        : mpl::vector<
              ...
              //    Start     Event            Next      Action Guard
              Internal<internal_event, playing_internal_fct,
                       playing_internal_guard>,
  ...
  struct transition_table
      : mpl::vector<
            ...
            // conflict between a normal and 2 internal transitions
            // (irow/g_irow)
...
void test() {
  ...
  std::cout << "conflict between the internal and normal transition. Internal "
               "is tried last"
            << std::endl;
