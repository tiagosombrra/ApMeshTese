...
struct player_ : public msm::front::state_machine_def<player_> {
  ...
  struct row_to_incidence
      : mpl::vector<mpl::pair<typename Row::Target, typename Row::Evt>,
                    typename Row::Source, typename Row::Target> {};

  typedef mpl::fold<player_::transition_table, mpl::vector<>,
  ...
  typedef mpl::first<mpl_graph::depth_first_search<
      transition_graph, preordering_dfs_visitor, mpl::vector<>,
      player_::initial_state>::type>::type dfs_from_initial_state;

  BOOST_MPL_ASSERT(
      (mpl::equal<dfs_from_initial_state,
  ...
  typedef mpl::first<mpl_graph::breadth_first_search<
      transition_graph, preordering_bfs_visitor, mpl::vector<>,
      player_::initial_state>::type>::type bfs_from_initial_state;

  // yawn, BFS happens to produce the same result as DFS for this example
  BOOST_MPL_ASSERT(
      (mpl::equal<bfs_from_initial_state,
                  mpl::vector<Empty, Open, Stopped, Playing, Paused> >));
};
// Pick a back-end
