...
BOOST_MSM_EUML_ACTION(State2ToState3){
    ...
    operator()(EVT const&, FSM& fsm, SourceState&,
               TargetState&){++fsm.get_attribute(state2_to_state3_counter);
}  // namespace
}
;
BOOST_MSM_EUML_ACTION(State3ToState4){
    template <class FSM, class EVT, class SourceState, class TargetState> void
    operator()(EVT const&, FSM& fsm, SourceState&,
               TargetState&){++fsm.get_attribute(state3_to_state4_counter);
}
}
;
// guard conditions
BOOST_MSM_EUML_ACTION(always_true){
    ...
    operator()(EVT const&, FSM& fsm, SourceState&,
               TargetState&){++fsm.get_attribute(always_true_counter);
return true;
}
}
;
BOOST_MSM_EUML_ACTION(always_false){
    template <class FSM, class EVT, class SourceState, class TargetState> bool
    operator()(EVT const&, FSM& fsm, SourceState&,
               TargetState&){++fsm.get_attribute(always_false_counter);
return false;
}
}
;
...
BOOST_MSM_EUML_TRANSITION_TABLE(
    (State2 == State1, State3 == State2 / State2ToState3,
     State4 == State3[always_true] / State3ToState4,
     State4 == State3[always_false], State1 == State4 + event1
     //  +------------------------------------------------------------------------------+
     ),
    transition_table)
...
BOOST_AUTO_TEST_CASE(my_test) {
  ...
  BOOST_CHECK_MESSAGE(
      p.get_state<BOOST_MSM_EUML_STATE_NAME(State1)&>().get_attribute(
          exit_counter) == 1,
  ...
  BOOST_CHECK_MESSAGE(
      p.get_state<BOOST_MSM_EUML_STATE_NAME(State2)&>().get_attribute(
          exit_counter) == 1,
  ...
  BOOST_CHECK_MESSAGE(
      p.get_state<BOOST_MSM_EUML_STATE_NAME(State3)&>().get_attribute(
          exit_counter) == 1,
  ...
  BOOST_CHECK_MESSAGE(
      p.get_state<BOOST_MSM_EUML_STATE_NAME(State4)&>().get_attribute(
          entry_counter) == 1,
      "State4 entry not called correctly");
  BOOST_CHECK_MESSAGE(p.get_attribute(always_true_counter) == 1,
                      "guard not called correctly");
  BOOST_CHECK_MESSAGE(p.get_attribute(always_false_counter) == 1,
                      "guard not called correctly");
  BOOST_CHECK_MESSAGE(p.get_attribute(state2_to_state3_counter) == 1,
                      "action not called correctly");
  BOOST_CHECK_MESSAGE(p.get_attribute(state3_to_state4_counter) == 1,
                      "action not called correctly");
  ...
  BOOST_CHECK_MESSAGE(
      p.get_state<BOOST_MSM_EUML_STATE_NAME(State4)&>().get_attribute(
          entry_counter) == 2,
      "State4 entry not called correctly");
  BOOST_CHECK_MESSAGE(p.get_attribute(always_true_counter) == 2,
                      "guard not called correctly");
  BOOST_CHECK_MESSAGE(p.get_attribute(always_false_counter) == 2,
                      "guard not called correctly");
  BOOST_CHECK_MESSAGE(p.get_attribute(state2_to_state3_counter) == 2,
                      "action not called correctly");
  BOOST_CHECK_MESSAGE(p.get_attribute(state3_to_state4_counter) == 2,
                      "action not called correctly");
}
}
