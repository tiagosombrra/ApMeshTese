...
BOOST_AUTO_TEST_CASE(my_test) {
  ...
  BOOST_CHECK_MESSAGE(p2.get_state<player_::Empty&>().some_dummy_data == 3,
                      "Empty not deserialized correctly");
  BOOST_CHECK_MESSAGE(p2.front_end_data == 4,
                      "Front-end not deserialized correctly");
