...
BOOST_AUTO_TEST_CASE(my_test) {
  ...
  BOOST_CHECK_MESSAGE(p2.current_state()[0] == 3,
                      "Playing should be active");  // Playing
  BOOST_CHECK_MESSAGE(p2.get_state<player_::Playing&>().current_state()[0] == 1,
                      "Song2 should be active");

  p2.process_event(pause());
  BOOST_CHECK_MESSAGE(p2.current_state()[0] == 4,
                      "Paused should be active");  // Paused

  p2.process_event(stop());
  BOOST_CHECK_MESSAGE(p2.current_state()[0] == 0,
                      "Stopped should be active");  // Stopped
  ...
  BOOST_CHECK_MESSAGE(p2.get_state<player_::Playing&>().current_state()[0] == 0,
                      "Song1 should be active");
}
}  // namespace
