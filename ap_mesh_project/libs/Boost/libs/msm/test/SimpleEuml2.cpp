...
BOOST_MSM_EUML_TRANSITION_TABLE(
    (Stopped + play /
                   (++fsm_(start_playback_counter), ++fsm_(test_fct_counter)) ==
         Playing,
     Paused + end_pause == Playing,
     //  +------------------------------------------------------------------------------+
     Open + open_close / ++fsm_(can_close_drawer_counter) == Empty,
     //  +------------------------------------------------------------------------------+
     Empty + open_close == Open, Paused + open_close == Open,
     Stopped + open_close == Open, Playing + open_close == Open,
     //  +------------------------------------------------------------------------------+
     Playing + pause == Paused,
     //  +------------------------------------------------------------------------------+
     Playing + stop == Stopped, Paused + stop == Stopped,
