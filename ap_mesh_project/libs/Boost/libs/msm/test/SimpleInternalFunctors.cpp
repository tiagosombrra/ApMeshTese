...
BOOST_AUTO_TEST_CASE(my_test) {
  ...
  BOOST_CHECK_MESSAGE(p.internal_action_counter == 1,
                      "Internal action not called correctly");
  BOOST_CHECK_MESSAGE(p.internal_guard_counter == 1,
                      "Internal guard not called correctly");
  BOOST_CHECK_MESSAGE(
      p.get_state<player_::Empty&>().empty_internal_action_counter == 0,
      "Empty internal action not called correctly");
  BOOST_CHECK_MESSAGE(
      p.get_state<player_::Empty&>().empty_internal_guard_counter == 1,
  ...
  BOOST_CHECK_MESSAGE(p.get_state<player_::Empty&>().entry_counter == 2,
                      "Empty entry not called correctly");
  BOOST_CHECK_MESSAGE(p.internal_guard_counter == 2,
                      "Internal guard not called correctly");
  ...
  BOOST_CHECK_MESSAGE(p.internal_guard_counter == 3,
                      "Internal guard not called correctly");
