...
// This is extended version of the state machine available in the boost::mpl
// library Distributed under the same license as the original. Copyright for the
// original version: Copyright 2010 Christophe Henry henry UNDERSCORE christophe
// AT hotmail DOT com This is an extended version of the state machine available
// in the boost::mpl library Distributed under the same license as the original.
...
struct bistable_switch_
    : public msm::front::state_machine_def<bistable_switch_> {
