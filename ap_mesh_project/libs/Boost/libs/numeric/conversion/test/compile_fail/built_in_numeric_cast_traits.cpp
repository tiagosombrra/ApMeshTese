...
#define BOOST_NUMERIC_CONVERSION_GENERATE_CAST_TRAITS(r, state)      \
  template <>                                                        \
  struct numeric_cast_traits<BOOST_PP_SEQ_ELEM(                      \
...
#define BOOST_NUMERIC_CONVERSION_GENERATE_BUILTIN_CAST_TRAITS(types) \
  BOOST_PP_FOR((0, BOOST_PP_SEQ_SIZE(types), types, _),              \
               BOOST_NUMERIC_CONVERSION_TUPLE_SENTINAL,              \
               BOOST_NUMERIC_CONVERSION_INC_OP,                      \
...
BOOST_NUMERIC_CONVERSION_GENERATE_BUILTIN_CAST_TRAITS(
    (char)(boost::int8_t)(boost::uint8_t)(boost::int16_t)(boost::uint16_t)(
        boost::int32_t)(boost::uint32_t)(boost::int64_t)(boost::uint64_t)(
        float)(double)(long double))
#else
BOOST_NUMERIC_CONVERSION_GENERATE_BUILTIN_CAST_TRAITS(
    (char)(boost::int8_t)(boost::uint8_t)(boost::int16_t)(boost::uint16_t)(
        boost::int32_t)(boost::uint32_t)(float)(double)(long double))
#endif
}  // namespace numeric
}  // namespace boost
