...
class stepper_types
    : public mpl::vector<
          ...
          runge_kutta_cash_karp54<state_type, value_type, deriv_type,
                                  time_type>,
...
class error_stepper_types
    : public mpl::vector<runge_kutta_cash_karp54_classic<state_type, value_type,
...
class controlled_stepper_types
    : public mpl::vector<
          controlled_runge_kutta<runge_kutta_cash_karp54_classic<
              state_type, value_type, deriv_type, time_type> >,
          controlled_runge_kutta<runge_kutta_dopri5<state_type, value_type,
                                                    deriv_type, time_type> >,
