...
BOOST_AUTO_TEST_CASE(integrate_const_controlled_rk54) {
  ...
  typedef odeint::runge_kutta_cash_karp54<state_type, double, state_type,
  ...
  odeint::integrate_const(controlled_stepper_type(), sys_func(R), X, 0.0, t_max,
                          dt);
...
BOOST_AUTO_TEST_CASE(integrate_const_dense_output_dopri5) {
  ...
  typedef odeint::runge_kutta_dopri5<state_type, double, state_type, double,
  ...
  odeint::integrate_const(dense_output_stepper_type(), sys_func(R), X, 0.0,
                          t_max, dt);
