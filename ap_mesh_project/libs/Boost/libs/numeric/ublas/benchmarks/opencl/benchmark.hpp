...
struct data_factory<ublas::matrix<T, L>, true> {
  ...
  typedef std::unique_ptr<type> ptr_type;
  static ptr_type create(long l) { return ptr_type(new type(l, l)); }
};
template <typename T, typename L>
...
class benchmark<R(O), true> : public base, public ublas::benchmark::benchmark {
 public:
  benchmark(std::string const &name)
      : base(), ublas::benchmark::benchmark(name + " with copy") {}
...
class benchmark<R(O1, O2), true> : public base,
                                   public ublas::benchmark::benchmark {
 public:
  benchmark(std::string const &name)
      : base(), ublas::benchmark::benchmark(name + " with copy") {}
  virtual void setup(long l) {
...
class benchmark<R(O1, O2, O3), true> : public base,
                                       public ublas::benchmark::benchmark {
 public:
  benchmark(std::string const &name)
      : base(), ublas::benchmark::benchmark(name + " with copy") {}
...
class benchmark<R(O), false> : public base, public ublas::benchmark::benchmark {
 public:
  benchmark(std::string const &name)
      : base(), ublas::benchmark::benchmark(name + " w/o copy") {}
  virtual void setup(long l) {
...
template <typename R, typename O1, typename O2>
class benchmark<R(O1, O2), false> : public base,
                                    public ublas::benchmark::benchmark {
 public:
  benchmark(std::string const &name)
      : base(), ublas::benchmark::benchmark(name + " w/o copy") {}
...
template <typename R, typename O1, typename O2, typename O3>
class benchmark<R(O1, O2, O3), false> : public base,
                                        public ublas::benchmark::benchmark {
 public:
  benchmark(std::string const &name)
      : base(), ublas::benchmark::benchmark(name + " w/o copy") {}
