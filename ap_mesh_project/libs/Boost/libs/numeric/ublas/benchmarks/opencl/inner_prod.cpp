...
void benchmark(std::string const &type, bool copy) {
  ...
  std::vector<long> sizes({1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048,
...
int main(int argc, char **argv) {
  ...
  try {
    ...
    desc.add_options()("copy,c", po::value<bool>(),
                       "include host<->device copy in timing");
