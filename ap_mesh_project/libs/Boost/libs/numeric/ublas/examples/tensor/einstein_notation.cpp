...
int main() {
  ...
  // Tensor-Vector-Multiplications - Including Transposition
  {
    ...
    std::cout << "% C1(j,k) = B1(j,k) + A(i,j,k)*v1(i);" << std::endl
              << std::endl;
  ...
  // Tensor-Matrix-Multiplications - Including Transposition
  {
    ...
    std::cout << "% --------------------------- " << std::endl;
    std::cout << "% --------------------------- " << std::endl << std::endl;
    std::cout << "% C1(l,j,k) = B(j,k,l) + A(i,j,k)*B1(l,i);" << std::endl
              << std::endl;
    //		std::cout << "C1=" << C1 << ";" << std::endl << std::endl;
    ...
    std::cout << "% --------------------------- " << std::endl;
    std::cout << "% --------------------------- " << std::endl << std::endl;
    std::cout << "% C2(i,l,k) = A(i,j,k)*B2(l,j) + 4;" << std::endl
              << std::endl;
    //		std::cout << "C2=" << C2 << ";" << std::endl << std::endl;
    ...
    //		std::cout << "% --------------------------- " << std::endl;
    //		std::cout << "% --------------------------- " << std::endl <<
    //std::endl; 		std::cout << "% C3(i,l1,l2) = A(i,j,k)*T1(l1,j)*T2(l2,k);" <<
    //std::endl << std::endl; 		std::cout << "C3=" << C3 << ";" << std::endl <<
    //std::endl;
  }
  ...
  // Tensor-Tensor-Multiplications Including Transposition
  {
    ...
    std::cout << "% --------------------------- " << std::endl;
    std::cout << "% --------------------------- " << std::endl << std::endl;
    std::cout << "% C1(k,l) = T1(k,l) + A(i,j,k)*A(i,j,l) + 5;" << std::endl
              << std::endl;
    //		std::cout << "C1=" << C1 << ";" << std::endl << std::endl;
    ...
    std::cout << "% --------------------------- " << std::endl;
    std::cout << "% --------------------------- " << std::endl << std::endl;
    std::cout << "%  C2(k,l,m) = T2(k,l,m) + A(i,j,k)*B(j,l,i,m) + 5;"
              << std::endl
              << std::endl;
    //		std::cout << "C2=" << C2 << ";" << std::endl << std::endl;
  }
