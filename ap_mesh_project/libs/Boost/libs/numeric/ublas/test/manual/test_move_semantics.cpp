...
void test1() {
  ...
  a = doubleit(a);
  std::cout << "Pointer (must be equal to temp. pointer if move semantics are "
               "enabled) : "
            << &a[0] << std::endl;
  ...
  f = doubleit(e);
  std::cout << "Pointer (c_vector swaps by copy this should be different than "
               "temp. pointer) : "
            << &f[0] << std::endl;
  f(1) = 0;
  std::cout << e << std::endl;
...
void test2() {
  ...
  std::cout
      << "bounded_matrix<double,2, 3> "
         "--------------------------------------------------------------------"
      << std::endl;
  ublas::bounded_matrix<double, 2, 3> b(
      ublas::scalar_matrix<double>(2, 3, 2.0));
  ublas::bounded_matrix<double, 2, 3> c;
  noalias(c) = doubleit(b);
  std::cout << "Pointer (bounded_matrix swaps by copy this should be different "
               "than temp. pointer) : "
            << &(c(0, 0)) << std::endl;
  c(1, 1) = 0.0;
  std::cout << b << std::endl;
  ...
  f = doubleit(e);
  std::cout << "Pointer (c_matrix swaps by copy this should be different than "
               "temp. pointer) : "
            << &(f(0, 0)) << std::endl;
  f(1, 1) = 0;
  std::cout << e << std::endl;
