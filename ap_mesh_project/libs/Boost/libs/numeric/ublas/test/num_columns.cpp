...
BOOST_UBLAS_TEST_DEF(test_row_major_matrix_container) {
  ...
  BOOST_UBLAS_DEBUG_TRACE("num_columns(A) = "
                          << boost::numeric::ublas::num_columns(A) << " ==> "
                          << A.size2());
...
BOOST_UBLAS_TEST_DEF(test_matrix_expression) {
  ...
  BOOST_UBLAS_DEBUG_TRACE("num_columns(A') = "
                          << boost::numeric::ublas::num_columns(
                                 boost::numeric::ublas::trans(A))
                          << " ==> "
                          << boost::numeric::ublas::trans(A).size2());
  BOOST_UBLAS_TEST_CHECK(
      boost::numeric::ublas::num_columns(boost::numeric::ublas::trans(A)) ==
      boost::numeric::ublas::trans(A).size2());
}
...
BOOST_UBLAS_TEST_DEF(test_matrix_reference) {
  ...
  BOOST_UBLAS_DEBUG_TRACE(
      "num_columns(reference(A)) = "
      << boost::numeric::ublas::num_columns(matrix_reference_type(A)) << " ==> "
