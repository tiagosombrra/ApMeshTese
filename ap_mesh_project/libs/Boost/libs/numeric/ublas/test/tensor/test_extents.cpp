...
BOOST_FIXTURE_TEST_CASE(test_extents_copy_ctor, fixture,
                        *boost::unit_test::label("extents") *
...
BOOST_FIXTURE_TEST_CASE(test_extents_is, fixture,
                        *boost::unit_test::label("extents") *
...
BOOST_FIXTURE_TEST_CASE(test_extents_squeeze, fixture,
                        *boost::unit_test::label("extents") *
                            boost::unit_test::label("squeeze")) {
  BOOST_REQUIRE_EQUAL(extents.size(), 13);
...
BOOST_FIXTURE_TEST_CASE(test_extents_valid, fixture,
                        *boost::unit_test::label("extents") *
                            boost::unit_test::label("valid")) {
  using namespace boost::numeric;
  ...
  BOOST_CHECK_THROW(ublas::basic_extents<unsigned>({1, 0, 1}),
                    std::length_error);
}

BOOST_FIXTURE_TEST_CASE(test_extents_product, fixture,
                        *boost::unit_test::label("extents") *
