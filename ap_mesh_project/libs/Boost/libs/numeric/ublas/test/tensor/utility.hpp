...
struct zip_helper<std::tuple<types3...>, type1, types1...> {
  ...
  struct with {
    ...
    using type = typename zip_helper<next_tuple,
                                     types1...>::template with<types2...>::type;
  };
...
// using test_types = std::tuple< std::pair<float, first_order>,
// std::pair<float, last_order >, std::pair<double,first_order>,
// std::pair<double,last_order >
//>;
// static_assert(std::is_same<
// std::tuple_element_t<0,std::tuple_element_t<0,test_types2>>,
// float>::value,"should be float "); static_assert(std::is_same<
// std::tuple_element_t<1,std::tuple_element_t<0,test_types2>>,
// boost::numeric::ublas::first_order>::value,"should be
