...
void test_matrix_vector() {
  ...
  test_my_matrix_vector<
      ...
      ublas::matrix<std::complex<float>, ublas::row_major,
  ...
  test_my_matrix_vector<
      ...
      ublas::matrix<std::complex<double>, ublas::row_major,
  ...
  test_my_matrix_vector<
      ublas::vector<float, ublas::unbounded_array<float> >,
      ublas::matrix<float, ublas::row_major, ublas::unbounded_array<float> >,
      3>()();
#endif
  ...
  test_my_matrix_vector<
      ...
      ublas::matrix<double, ublas::row_major, ublas::unbounded_array<double> >,
      3>()();
#endif
  ...
  test_my_matrix_vector<ublas::bounded_vector<std::complex<float>, 3>,
                        ublas::bounded_matrix<std::complex<float>, 3, 3>,
                        3>()();
#endif
  ...
  test_my_matrix_vector<ublas::bounded_vector<std::complex<double>, 3>,
                        ublas::bounded_matrix<std::complex<double>, 3, 3>,
                        3>()();
#endif
#endif
#endif
  ...
  test_my_matrix_vector<
      ...
      ublas::vector_of_vector<
          ...
          ublas::bounded_array<ublas::bounded_array<float, 3>, 3 + 1> >,
      3>()();
#endif
  ...
  test_my_matrix_vector<
      ...
      ublas::vector_of_vector<
          ...
          ublas::bounded_array<ublas::bounded_array<double, 3>, 3 + 1> >,
      3>()();
#endif
  ...
  test_my_matrix_vector<
      ...
      ublas::vector_of_vector<
          ...
          ublas::bounded_array<ublas::bounded_array<std::complex<float>, 3>,
                               3 + 1> >,
      3>()();
#endif
  ...
  test_my_matrix_vector<
      ...
      ublas::vector_of_vector<
          ...
          ublas::bounded_array<ublas::bounded_array<std::complex<double>, 3>,
                               3 + 1> >,
      3>()();
#endif
#endif
  ...
  test_my_matrix_vector<
      ...
      ublas::vector_of_vector<
          float, ublas::row_major,
          ublas::unbounded_array<ublas::unbounded_array<float> > >,
      3>()();
#endif
  ...
  test_my_matrix_vector<
      ...
      ublas::vector_of_vector<
          double, ublas::row_major,
          ublas::unbounded_array<ublas::unbounded_array<double> > >,
      3>()();
#endif
  ...
  test_my_matrix_vector<
      ublas::vector<std::complex<float>,
                    ublas::unbounded_array<std::complex<float> > >,
      ublas::vector_of_vector<std::complex<float>, ublas::row_major,
                              ublas::unbounded_array<ublas::unbounded_array<
                                  std::complex<float> > > >,
      3>()();
#endif
  ...
  test_my_matrix_vector<
      ublas::vector<float, std::vector<float> >,
      ublas::vector_of_vector<float, ublas::row_major,
  ...
  test_my_matrix_vector<
      ublas::vector<double, std::vector<double> >,
      ublas::vector_of_vector<double, ublas::row_major,
