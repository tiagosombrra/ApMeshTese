...
void test_matrix() {
  ...
  test_my_matrix<ublas::matrix<float, ublas::row_major,
  ...
  test_my_matrix<ublas::matrix<double, ublas::row_major,
  ...
  test_my_matrix<ublas::matrix<std::complex<float>, ublas::row_major,
  ...
  test_my_matrix<ublas::matrix<std::complex<double>, ublas::row_major,
  ...
  test_my_matrix<ublas::matrix<float, ublas::row_major, std::vector<float> >,
                 3>()();
#endif

#ifdef USE_DOUBLE
  std::cout << "double, std::vector" << std::endl;
  test_my_matrix<ublas::matrix<double, ublas::row_major, std::vector<double> >,
                 3>()();
#endif
  ...
  test_my_matrix<ublas::vector_of_vector<
                     ...
                     ublas::bounded_array<
                         ublas::bounded_array<std::complex<float>, 3>, 3 + 1> >,
                 3>()();
#endif
...
#ifdef USE_FLOAT
  std::cout << "float, std::vector" << std::endl;
  test_my_matrix<ublas::vector_of_vector<float, ublas::row_major,
...
#ifdef USE_DOUBLE
  std::cout << "double, std::vector" << std::endl;
  test_my_matrix<ublas::vector_of_vector<double, ublas::row_major,
