...
void test_blas_3<M, N>::test() {
  {
    ...
    std::cout << "tsm (m1, 1, m2) = " << m1 << " "
              << ublas::prod(m2, m1) - value_type(1) * m3 << std::endl;
    initialize_matrix(m1);
    initialize_matrix(m2, ublas::upper_tag());
    ublas::blas_3::tsm(m1, value_type(1), ublas::trans(m2), ublas::lower_tag());
    std::cout << "tsm (m1, 1, trans (m2)) = " << m1 << " "
              << ublas::prod(ublas::trans(m2), m1) - value_type(1) * m3
              << std::endl;
#ifdef USE_STD_COMPLEX
    initialize_matrix(m1);
    initialize_matrix(m2, ublas::upper_tag());
    ublas::blas_3::tsm(m1, value_type(1), ublas::herm(m2), ublas::lower_tag());
    std::cout << "tsm (m1, 1, herm (m2)) = " << m1 << " "
              << ublas::prod(ublas::herm(m2), m1) - value_type(1) * m3
              << std::endl;
#endif
    initialize_matrix(m1);
    initialize_matrix(m2, ublas::upper_tag());
    ...
    initialize_matrix(m2);
    initialize_matrix(m3);
    ublas::blas_3::gmm(m1, value_type(1), value_type(1), ublas::trans(m2),
                       ublas::trans(m3));
    ...
    initialize_matrix(m2);
    initialize_matrix(m3);
    ublas::blas_3::gmm(m1, value_type(1), value_type(1), ublas::herm(m2),
                       ublas::trans(m3));
    ...
    initialize_matrix(m2);
    initialize_matrix(m3);
    ublas::blas_3::sr2k(m1, value_type(1), value_type(1), ublas::trans(m2),
                        ublas::trans(m3));
    std::cout << "sr2k (m1, 1, 1, trans (m2), trans (m3)) = " << m1
              << std::endl;
    ...
    initialize_matrix(m2);
    initialize_matrix(m3);
    ublas::blas_3::hr2k(m1, value_type(1), value_type(1), ublas::herm(m2),
                        ublas::herm(m3));
