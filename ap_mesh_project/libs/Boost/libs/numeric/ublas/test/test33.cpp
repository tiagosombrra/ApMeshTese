  ...
  void test_with(MP &m1, MP &m2, MP &m3) const {
    {
      ...
      project(m1, ublas::range(0, 1), ublas::range(0, 1)) =
          project(m2, ublas::range(0, 1), ublas::range(0, 1));
      project(m1, ublas::range(0, 1), ublas::range(0, 1)) =
...
void test_matrix() {
  ...
  test_my_matrix<ublas::mapped_matrix<float, ublas::row_major,
                                      ublas::map_array<std::size_t, float> >,
                 3>()();
#endif

#ifdef USE_DOUBLE
  std::cout << "double, mapped_matrix map_array" << std::endl;
  test_my_matrix<ublas::mapped_matrix<double, ublas::row_major,
                                      ublas::map_array<std::size_t, double> >,
                 3>()();
#endif
  ...
  test_my_matrix<ublas::mapped_matrix<
                     std::complex<float>, ublas::row_major,
                     ublas::map_array<std::size_t, std::complex<float> > >,
                 3>()();
#endif
  ...
  test_my_matrix<
      ublas::mapped_matrix<std::complex<float>, ublas::row_major,
                           std::map<std::size_t, std::complex<float> > >,
      3>()();
#endif
...
#ifdef USE_STD_COMPLEX
#ifdef USE_FLOAT
  std::cout << "std::complex<float>, mapped_vector_of_mapped_vector map_array"
            << std::endl;
  test_my_matrix<
...
#ifdef USE_DOUBLE
  std::cout << "std::complex<double>, mapped_vector_of_mapped_vectormap_array"
            << std::endl;
  test_my_matrix<
      ublas::mapped_vector_of_mapped_vector<
          std::complex<double>, ublas::row_major,
...
#ifdef USE_STD_COMPLEX
#ifdef USE_FLOAT
  std::cout << "std::complex<float>, mapped_vector_of_mapped_vector std::map"
            << std::endl;
  test_my_matrix<
      ublas::mapped_vector_of_mapped_vector<
          std::complex<float>, ublas::row_major,
          std::map<std::size_t, std::map<std::size_t, std::complex<float> > > >,
      3>()();
#endif

#ifdef USE_DOUBLE
  std::cout << "std::complex<double>, mapped_vector_of_mapped_vector std::map"
            << std::endl;
  test_my_matrix<ublas::mapped_vector_of_mapped_vector<
                     std::complex<double>, ublas::row_major,
                     std::map<std::size_t,
  ...
  test_my_matrix<ublas::generalized_vector_of_vector<
                     float, ublas::row_major,
                     ublas::vector<ublas::mapped_vector<
                         float, ublas::map_array<std::size_t, float> > > >,
                 3>()();
  test_my_matrix<
      ublas::generalized_vector_of_vector<
          float, ublas::row_major,
          ublas::mapped_vector<
              ublas::mapped_vector<float,
                                   ublas::map_array<std::size_t, float> >,
              ublas::map_array<
                  std::size_t,
                  ublas::mapped_vector<
  ...
  test_my_matrix<ublas::generalized_vector_of_vector<
                     double, ublas::row_major,
                     ublas::vector<ublas::mapped_vector<
                         double, ublas::map_array<std::size_t, double> > > >,
                 3>()();
  test_my_matrix<
      ublas::generalized_vector_of_vector<
          double, ublas::row_major,
          ublas::mapped_vector<
              ublas::mapped_vector<double,
                                   ublas::map_array<std::size_t, double> >,
              ublas::map_array<
                  std::size_t,
                  ublas::mapped_vector<
...
#ifdef USE_STD_COMPLEX
#ifdef USE_FLOAT
  std::cout << "std::complex<float>, generalized_vector_of_vector map_array"
            << std::endl;
  test_my_matrix<
      ublas::generalized_vector_of_vector<
          std::complex<float>, ublas::row_major,
...
#ifdef USE_DOUBLE
  std::cout << "std::complex<double>, generalized_vector_of_vector map_array"
            << std::endl;
  test_my_matrix<
      ublas::generalized_vector_of_vector<
          std::complex<double>, ublas::row_major,
  ...
  test_my_matrix<ublas::generalized_vector_of_vector<
                     float, ublas::row_major,
                     ublas::vector<ublas::mapped_vector<
                         float, std::map<std::size_t, float> > > >,
                 3>()();
  test_my_matrix<
      ublas::generalized_vector_of_vector<
          float, ublas::row_major,
          ublas::mapped_vector<
              ublas::mapped_vector<float, std::map<std::size_t, float> >,
              std::map<std::size_t,
                       ublas::mapped_vector<
                           float, std::map<std::size_t, float> > > > >,
      3>()();
  ...
  test_my_matrix<ublas::generalized_vector_of_vector<
                     double, ublas::row_major,
                     ublas::vector<ublas::mapped_vector<
                         double, std::map<std::size_t, double> > > >,
                 3>()();
  test_my_matrix<
      ublas::generalized_vector_of_vector<
          double, ublas::row_major,
...
#ifdef USE_STD_COMPLEX
#ifdef USE_FLOAT
  std::cout << "std::complex<float>, generalized_vector_of_vector std::map"
            << std::endl;
  test_my_matrix<ublas::generalized_vector_of_vector<
                     std::complex<float>, ublas::row_major,
                     ublas::vector<ublas::mapped_vector<
...
#ifdef USE_DOUBLE
  std::cout << "std::complex<double>, generalized_vector_of_vector std::map"
            << std::endl;
  test_my_matrix<ublas::generalized_vector_of_vector<
                     std::complex<double>, ublas::row_major,
                     ublas::vector<ublas::mapped_vector<
...
#ifdef USE_STD_COMPLEX
#ifdef USE_FLOAT
  std::cout << "std::complex<float> mapped_vector_of_mapped_vector"
            << std::endl;
  test_my_matrix<ublas::mapped_vector_of_mapped_vector<std::complex<float> >,
                 3>()();
#endif

#ifdef USE_DOUBLE
  std::cout << "std::complex<double> mapped_vector_of_mapped_vector"
            << std::endl;
  test_my_matrix<ublas::mapped_vector_of_mapped_vector<std::complex<double> >,
                 3>()();
#endif
#endif
#endif
