...
struct test_my_matrix_vector {
...
#ifdef USE_RANGE
      ublas::matrix_vector_range<M> mvr1(m1, ublas::range(0, N),
                                         ublas::range(0, N)),
...
#ifdef USE_SLICE
      ublas::matrix_vector_slice<M> mvs1(m1, ublas::slice(0, 1, N),
                                         ublas::slice(0, 1, N)),
  ...
  void operator()(int) const {
#ifdef USE_ADAPTOR
    {
      ...
      ublas::matrix_column<ublas::banded_adaptor<M> > mc1(bam1, 1),
          mc2(bam1, 1);
      test_with(mc1, mc2, bam1);

#ifdef USE_RANGE
      ublas::matrix_vector_range<ublas::banded_adaptor<M> > mvr1(
          bam1, ublas::range(0, N), ublas::range(0, N)),
          mvr2(bam1, ublas::range(0, N), ublas::range(0, N));
      test_with(mvr1, mvr2, bam1);
#endif

#ifdef USE_SLICE
      ublas::matrix_vector_slice<ublas::banded_adaptor<M> > mvs1(
          bam1, ublas::slice(0, 1, N), ublas::slice(0, 1, N)),
      ...
      ublas::matrix_column<ublas::diagonal_adaptor<M> > mc1(dam1, 1),
          mc2(dam1, 1);
      test_with(mc1, mc2, dam1);

#ifdef USE_RANGE
      ublas::matrix_vector_range<ublas::diagonal_adaptor<M> > mvr1(
          dam1, ublas::range(0, N), ublas::range(0, N)),
          mvr2(dam1, ublas::range(0, N), ublas::range(0, N));
      test_with(mvr1, mvr2, dam1);
#endif

#ifdef USE_SLICE
      ublas::matrix_vector_slice<ublas::diagonal_adaptor<M> > mvs1(
          dam1, ublas::slice(0, 1, N), ublas::slice(0, 1, N)),
...
void test_matrix_vector() {
  ...
  test_my_matrix_vector<
      ublas::vector<float, ublas::bounded_array<float, 3> >,
      ublas::banded_matrix<float, ublas::row_major,
  ...
  test_my_matrix_vector<
      ...
      ublas::banded_matrix<double, ublas::row_major,
  ...
  test_my_matrix_vector<
      ublas::vector<std::complex<float>,
                    ublas::bounded_array<std::complex<float>, 3> >,
      ublas::banded_matrix<std::complex<float>, ublas::row_major,
  ...
  test_my_matrix_vector<
      ublas::vector<std::complex<double>,
                    ublas::bounded_array<std::complex<double>, 3> >,
      ublas::banded_matrix<std::complex<double>, ublas::row_major,
  ...
  test_my_matrix_vector<
      ublas::vector<float, std::vector<float> >,
      ublas::banded_matrix<float, ublas::row_major, std::vector<float> >,
      3>()();
  test_my_matrix_vector<
      ublas::vector<float, std::vector<float> >,
  ...
  test_my_matrix_vector<
      ...
      ublas::banded_matrix<double, ublas::row_major, std::vector<double> >,
      3>()();
  test_my_matrix_vector<
      ublas::vector<double, std::vector<double> >,
      ublas::banded_matrix<double, ublas::row_major, std::vector<double> >,
  ...
  test_my_matrix_vector<
      ublas::vector<std::complex<float>, std::vector<std::complex<float> > >,
      ublas::banded_matrix<std::complex<float>, ublas::row_major,
  ...
  test_my_matrix_vector<
      ublas::vector<float, ublas::bounded_array<float, 3> >,
      ublas::diagonal_matrix<float, ublas::row_major,
                             ublas::bounded_array<float, 3 * 3> >,
      3>()();
  test_my_matrix_vector<
      ublas::vector<float, ublas::bounded_array<float, 3> >,
  ...
  test_my_matrix_vector<
      ublas::vector<std::complex<float>,
                    ublas::bounded_array<std::complex<float>, 3> >,
      ublas::diagonal_matrix<std::complex<float>, ublas::row_major,
                             ublas::bounded_array<std::complex<float>, 3 * 3> >,
      3>()();
  test_my_matrix_vector<
      ublas::vector<std::complex<float>,
  ...
  test_my_matrix_vector<
      ublas::vector<float, std::vector<float> >,
      ublas::diagonal_matrix<float, ublas::row_major, std::vector<float> >,
      3>()();
  test_my_matrix_vector<
      ublas::vector<float, std::vector<float> >,
      ublas::diagonal_matrix<float, ublas::row_major, std::vector<float> >,
  ...
  test_my_matrix_vector<
      ublas::vector<double, std::vector<double> >,
      ublas::diagonal_matrix<double, ublas::row_major, std::vector<double> >,
      3>()();
  test_my_matrix_vector<
      ublas::vector<double, std::vector<double> >,
      ublas::diagonal_matrix<double, ublas::row_major, std::vector<double> >,
