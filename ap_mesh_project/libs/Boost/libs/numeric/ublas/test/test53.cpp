...
#ifdef USE_RANGE
      ublas::matrix_range<ublas::triangular_adaptor<M> > mr1(
...
#ifdef USE_SLICE
      ublas::matrix_slice<ublas::triangular_adaptor<M> > ms1(
...
void test_matrix() {
  ...
  test_my_matrix<ublas::triangular_matrix<float, ublas::lower, ublas::row_major,
  ...
  test_my_matrix<ublas::triangular_matrix<
  ...
  test_my_matrix<ublas::triangular_matrix<std::complex<float>, ublas::lower,
                                          ublas::row_major,
  ...
  test_my_matrix<ublas::triangular_matrix<std::complex<double>, ublas::lower,
                                          ublas::row_major,
