  ...
  void operator()() const {
    {
      ...
      ublas::vector_range<V> vr1(v1, ublas::range(0, N)),
          vr2(v2, ublas::range(0, N)), vr3(v3, ublas::range(0, N));
      test_with(vr1, vr2, vr3);
#endif

#ifdef USE_SLICE
      ublas::vector_slice<V> vs1(v1, ublas::slice(0, 1, N)),
          vs2(v2, ublas::slice(0, 1, N)), vs3(v3, ublas::slice(0, 1, N));
...
void test_vector() {
  ...
  test_my_vector<ublas::vector<boost::numeric::interval<float>,
  ...
  test_my_vector<ublas::vector<boost::numeric::interval<double>,
