...
int expected_index(size_t index, column_major) {
  ...
  int mapping[] = {0,  11, 21, 31, 12, 22, 32, 42, 23, 33,
                   43, 53, 34, 44, 54, 0,  45, 55, 0,  0};
...
int expected_index(size_t index, row_major) {
  ...
  int mapping[] = {0,  0,  11, 12, 0,  21, 22, 23, 31, 32,
                   33, 34, 42, 43, 44, 45, 53, 54, 55, 0};
  return mapping[index];
}
...
int expected_index_6_by_5(size_t index, column_major) {
  // read column-by-column, aka column_major
  int mapping[] = {0,  11, 21, 31, 12, 22, 32, 42, 23, 33,
                   43, 53, 34, 44, 54, 64, 45, 55, 65, 0};
  return mapping[index];
}

int expected_index_6_by_5(size_t index, row_major) {
  // read row-by-row, aka row_major
  int mapping[] = {0,  0,  11, 12, 0,  21, 22, 23, 31, 32, 33, 34,
                   42, 43, 44, 45, 53, 54, 55, 0,  64, 65, 0,  0};
  return mapping[index];
}

int expected_index_5_by_6(size_t index, column_major) {
  // read column-by-column, aka column_major
  int mapping[] = {0,  11, 21, 31, 12, 22, 32, 42, 23, 33, 43, 53,
                   34, 44, 54, 0,  45, 55, 0,  0,  56, 0,  0,  0};
  return mapping[index];
}
...
BOOST_UBLAS_TEST_DEF(banded_matrix_column_major) {
  BOOST_UBLAS_TEST_TRACE(
      "Test case: storage layout banded_matrix < column_major >");
...
BOOST_UBLAS_TEST_DEF(banded_matrix_row_major) {
  BOOST_UBLAS_TEST_TRACE(
      "Test case: storage layout banded_matrix < row_major >");
...
BOOST_UBLAS_TEST_DEF(banded_matrix_column_major_6_by_5) {
  BOOST_UBLAS_TEST_TRACE(
      "Test case: storage layout banded_matrix < column_major > 6x5");
...
BOOST_UBLAS_TEST_DEF(banded_matrix_row_major_6_by_5) {
  BOOST_UBLAS_TEST_TRACE(
      "Test case: storage layout banded_matrix < row_major > 6x5");
...
BOOST_UBLAS_TEST_DEF(banded_matrix_column_major_5_by_6) {
  BOOST_UBLAS_TEST_TRACE(
      "Test case: storage layout banded_matrix < column_major > 5x6");
...
BOOST_UBLAS_TEST_DEF(banded_matrix_row_major_5_by_6) {
  BOOST_UBLAS_TEST_TRACE(
      "Test case: storage layout banded_matrix < row_major > 5x6");
