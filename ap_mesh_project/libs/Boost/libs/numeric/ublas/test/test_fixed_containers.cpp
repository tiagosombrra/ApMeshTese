...
bool test_vector(std::string type_name) {
...

  {
    ...
    vec3 v1(static_cast<component_type>(0.0), static_cast<component_type>(0.0),
    ...
    vec3 v6(static_cast<component_type>(5.0), static_cast<component_type>(8.0),
...
bool test_matrix(std::string type_name) {
  ...
  {
    mat34 m1((T)1, (T)2, (T)3, (T)3, (T)3, (T)2, (T)5, (T)4, (T)2, (T)6, (T)5,
             (T)2);
    mat43 m2((T)4, (T)5, (T)6, (T)3, (T)2, (T)2, (T)1, (T)4, (T)2, (T)6, (T)5,
             (T)2);
...
BOOST_UBLAS_TEST_DEF(test_fixed) {
  ...
  BOOST_UBLAS_TEST_CHECK(
      test_vector<std::complex<double> >("std::complex<double>"));
  BOOST_UBLAS_TEST_CHECK(
      test_vector<std::complex<float> >("std::complex<float>"));
