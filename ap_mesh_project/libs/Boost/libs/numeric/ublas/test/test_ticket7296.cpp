...
BOOST_UBLAS_TEST_DEF(check_close) {
  ...
  BOOST_UBLAS_TEST_CHECK_CLOSE(std::complex<float>(c1, c2),
                               std::complex<float>(c1, c2), tol);
  BOOST_UBLAS_TEST_CHECK_CLOSE(std::complex<double>(c1, c2),
                               std::complex<double>(c1, c2), tol);
...
BOOST_UBLAS_TEST_DEF(check_rel_close) {
  ...
  BOOST_UBLAS_TEST_CHECK_REL_CLOSE(std::complex<float>(c1, c2),
                                   std::complex<float>(c1, c2), tol);
  BOOST_UBLAS_TEST_CHECK_REL_CLOSE(std::complex<double>(c1, c2),
                                   std::complex<double>(c1, c2), tol);
...
BOOST_UBLAS_TEST_DEF(check_vector_close) {
  ...
  ublas::vector<std::complex<float> > cfv =
      ublas::scalar_vector<std::complex<float> >(n, std::complex<float>(1, 2));
  ublas::vector<std::complex<double> > cdv =
      ublas::scalar_vector<std::complex<double> >(n,
...
BOOST_UBLAS_TEST_DEF(check_vector_rel_close) {
  ...
  ublas::vector<std::complex<float> > cfv =
      ublas::scalar_vector<std::complex<float> >(n,
...
BOOST_UBLAS_TEST_DEF(check_matrix_close) {
  ...
  ublas::matrix<std::complex<float> > cfA =
      ublas::scalar_matrix<std::complex<float> >(nr, nc,
                                                 std::complex<float>(c1, c2));
  ublas::matrix<std::complex<double> > cdA =
      ublas::scalar_matrix<std::complex<double> >(nr, nc,
                                                  std::complex<double>(c1, c2));
