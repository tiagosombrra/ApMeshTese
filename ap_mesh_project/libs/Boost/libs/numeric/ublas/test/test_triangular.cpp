...
int main() {
  ...
  std::cerr << "Starting..." << std::endl;
  {
    boost::timer::auto_cpu_timer t(std::cerr,
                                   "col_low x: %t sec CPU, %w sec real\n");
  ...
  {
    boost::timer::auto_cpu_timer t(std::cerr,
                                   "row_low x: %t sec CPU, %w sec real\n");
    ublas::vector<double> x(b);
  ...
  {
    boost::timer::auto_cpu_timer t(std::cerr,
                                   "col_upp x: %t sec CPU, %w sec real\n");
    ublas::vector<double> x(b);
  ...
  {
    boost::timer::auto_cpu_timer t(std::cerr,
                                   "row_upp x: %t sec CPU, %w sec real\n");
    ublas::vector<double> x(b);
  ...
  {
    boost::timer::auto_cpu_timer t(std::cerr,
                                   "x col_low: %t sec CPU, %w sec real\n");
    ublas::vector<double> x(b);
  ...
  {
    boost::timer::auto_cpu_timer t(std::cerr,
                                   "x row_low: %t sec CPU, %w sec real\n");
    ublas::vector<double> x(b);
  ...
  {
    boost::timer::auto_cpu_timer t(std::cerr,
                                   "x col_upp: %t sec CPU, %w sec real\n");
    ublas::vector<double> x(b);
  ...
  {
    boost::timer::auto_cpu_timer t(std::cerr,
                                   "x row_upp: %t sec CPU, %w sec real\n");
    ublas::vector<double> x(b);
