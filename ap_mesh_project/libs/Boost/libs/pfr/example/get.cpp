...
*/
foo f{777, '!'};
auto& r1 = boost::pfr::get<0>(f);  // accessing field with index 0, returns
                                   // reference to `foo::some_integer`
auto& r2 = boost::pfr::get<1>(
    f);  // accessing field with index 1, returns reference to `foo::c`
//] [/pfr_example_get]
