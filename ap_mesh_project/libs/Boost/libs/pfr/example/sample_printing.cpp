...
//[pfr_sample_printing
/*`
    The following example shows how to write your own io-manipulator for
   printing:
*/
...
int main() {
  ...
  const char* huge_string =
      ...
      "And by 'huge' I mean really HUGE string with multiple statements and a "
      "lot of periods.........";

  oss.str({});
  oss << my_ns::my_io(two_big_strings{huge_string, huge_string});
