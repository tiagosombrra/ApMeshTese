...
struct function1 final {
  ...
  friend bool operator==(const function1& x, const function1& y) {
    return x.n == y.n;
  }
  int n;
};
...
inline bool operator==(const collection::value_type& x,
                       const collection::value_type& y) {
