...
void test_comparison() {
  ...
  }
  {
    ...
    fill<constraints<is_not_equality_comparable>, Types...>(p1, v, 2);
  ...
  }
  {
    ...
    fill<constraints<is_not_equality_comparable>, Types...>(p1, v, 1);
    fill<constraints<is_not_equality_comparable>, Types...>(p2, v, 2);
  ...
  }
  {
    ...
    check_throw<not_equality_comparable>([&] { (void)(cp1 == cp2); },
                                         [&] { (void)(cp1 != cp2); });
  }
  {
    PolyCollection p1, p2;
...
void test_comparison() {
  test_comparison<any_types::collection, auto_increment, any_types::t1,
                  any_types::t2, any_types::t3, any_types::t4, any_types::t5>();
  test_comparison<base_types::collection, auto_increment, base_types::t1,
                  base_types::t2, base_types::t3, base_types::t4,
                  base_types::t5>();
  test_comparison<function_types::collection, auto_increment,
