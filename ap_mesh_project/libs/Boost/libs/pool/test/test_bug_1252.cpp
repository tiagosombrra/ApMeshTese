...
void test_alignment(T) {
  ...
  for (unsigned i = 0; i < limit; ++i) {
    ...
    // Trample over the memory just to be sure the allocated block is big
    // enough, if it's not, we'll trample over the next block as well (and our
