...
//
// UWP is available on Windows SDK 8.0 or later, or on MinGW-w64 major release 3
// or later
//
#if (defined(__MINGW64__) && (__MINGW64_VERSION_MAJOR >= 3)) || \
    (BOOST_PLAT_WINDOWS_SDK_VERSION >= 9200)
...
//
// If BOOST_PLAT_WINDOWS_UWP is not available, none of the other
// BOOST_PLAT_WINDOWS_* are either except for BOOST_PLAT_WINDOWS_DESKTOP which
...
//
// If BOOST_PLAT_WINDOWS_UWP is available, and the SDK supports a particular
// family, and if WINAPI_FAMILY is set to it, then it and only it should be
// available.
//

#if !defined(WINAPI_FAMILY)
#error \
    "windows_uwp.h should have included <winapifamily.h> which should have defined supported families"
#endif
...
#if defined(WINAPI_FAMILY_SERVER_APP) && \
    WINAPI_FAMILY == WINAPI_FAMILY_SERVER_APP
#if BOOST_PLAT_WINDOWS_DESKTOP
#error "BOOST_PLAT_WINDOWS_DESKTOP should not be available"
#endif
#if BOOST_PLAT_WINDOWS_PHONE
...
#if defined(WINAPI_FAMILY_SYSTEM_APP) && \
    WINAPI_FAMILY == WINAPI_FAMILY_SYSTEM_APP
#if BOOST_PLAT_WINDOWS_DESKTOP
#error "BOOST_PLAT_WINDOWS_DESKTOP should not be available"
#endif
#if BOOST_PLAT_WINDOWS_PHONE
