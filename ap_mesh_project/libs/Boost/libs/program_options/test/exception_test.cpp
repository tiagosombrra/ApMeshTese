...
void test_ambiguous() {
  ...
  desc.add_options()("cfgfile,c", value<string>()->multitoken(),
                     "the config file")("output,c", value<string>(),
                                        "the output file")(
...
void test_ambiguous_long() {
  ...
  const char* cmdline[] = {"program", "--cfgfile", "file", "--output",
                           "anotherfile"};
...
void test_ambiguous_multiple_long_names() {
  ...
  desc.add_options()("cfgfile,foo,c", value<string>()->multitoken(),
                     "the config file")("output,foo,o", value<string>(),
                                        "the output file");
...
void test_multiple_values() {
  options_description desc;
  desc.add_options()("cfgfile,c", value<string>()->multitoken(),
                     "the config file")("output,o", value<string>(),
                                        "the output file");
  ...
  try {
    ...
    //   because: untyped_value always has one value and this is filtered before
    //   reach specific validation and parsing
    //
    BOOST_CHECK_EQUAL(e.get_option_name(), "--cfgfile");
    BOOST_CHECK_EQUAL(string(e.what()),
...
void test_multiple_occurrences_with_different_names() {
  options_description desc;
  desc.add_options()("cfgfile,config-file,c", value<string>(),
                     "the configfile");

  const char* cmdline[] = {"program", "--config-file", "file", "--cfgfile",
                           "anotherfile"};
  ...
  try {
    ...
    BOOST_CHECK((e.get_option_name() == "--cfgfile") ||
                (e.get_option_name() == "--config-file"));
    BOOST_CHECK((string(e.what()) ==
                 "option '--cfgfile' cannot be specified more than once") ||
                (string(e.what()) ==
...
void test_multiple_occurrences_with_non_key_names() {
  ...
  const char* cmdline[] = {"program", "--config-file", "file", "-c",
                           "anotherfile"};
