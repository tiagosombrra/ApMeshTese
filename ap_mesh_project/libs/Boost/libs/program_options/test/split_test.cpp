...
void split_quotes(const options_description& description) {
  const char* cmdline =
      "prg --input \"input.txt input.txt\" --optimization 4 --opt \"option1 "
      "option2\"";
...
void split_escape(const options_description& description) {
  const char* cmdline =
      "prg --input \\\"input.txt\\\" --optimization 4 --opt \\\"option1\\ "
      "option2\\\"";
...
void split_defaults(const options_description& description) {
  const char* cmdline =
      "prg --input \t \'input file.txt\' \t   --optimization 4 --opt "
      "\\\"option1\\ option2\\\"";
...
int main(int /*ac*/, char** /*av*/) {
  ...
  desc.add_options()("input,i", value<string>(), "the input file")(
