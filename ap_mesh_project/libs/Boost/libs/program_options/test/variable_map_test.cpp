...
void test_variable_map() {
  ...
  desc.add_options()("foo,f", new untyped_value)("bar,b", po::value<string>())(
      "biz,z", po::value<string>())("baz", new untyped_value())(
  ...
  int i;
  desc.add_options()("zee", bool_switch(), "")("zak", po::value<int>(&i), "")(
      "opt", bool_switch(), "");
  ...
  desc2.add_options()("vee", po::value<string>()->default_value("42"))(
      "voo", po::value<string>())("iii", po::value<int>()->default_value(123));
  ...
  desc3.add_options()("imp", po::value<int>()->implicit_value(100))(
...
void test_semantic_values() {
  options_description desc;
  desc.add_options()("foo", new untyped_value())("bar", po::value<int>())(
...
void test_priority() {
  ...
  desc.add_options()
      ...
      ("second", po::value<vector<int> >()->default_value(
                     vector<int>(1, 1), ""))("aux", po::value<vector<int> >())
      // This will have values in both sources, and values should be combined
      ("include", po::value<vector<int> >()->composing());

  const char* cmdline1_[] = {"--first=1", "--aux=10", "--first=3",
                             "--include=1"};
