    ...
    : proto::or_<
          ...
          proto::when<
              ...
              proto::fold<_, mpl::int_<0>(),
                          mpl::max<CalculatorGrammar, proto::_state>()> >
...
struct calculator_arity : boost::result_of<CalculatorGrammar(Expr)> {};
...
struct calculator_expression
  ...
  typedef proto::extends<Expr, calculator_expression<Expr>, calculator_domain>
      base_type;
...
calculator_expression<proto::terminal<placeholder<mpl::int_<1> > >::type> const
    _1;
calculator_expression<proto::terminal<placeholder<mpl::int_<2> > >::type> const
    _2;
