...
struct FutureGroup
    : proto::or_<
          ...
          proto::when<
              ...
              fusion::joint_view<boost::add_const<FutureGroup(proto::_left)>,
          ...
          proto::when<
              ...
              pick_left<FutureGroup(proto::_left), FutureGroup(proto::_right)>(
...
// tuple.
template <class E>
struct future_expr : proto::extends<E, future_expr<E>, future_dom> {
  explicit future_expr(E const &e) : future_expr::proto_extends(e) {}

  typename fusion::result_of::as_vector<
      typename boost::result_of<FutureGroup(E)>::type>::type
  get() const {
...
// member function.
template <class T>
struct future : future_expr<typename proto::terminal<T>::type> {
  future(T const &t = T())
      : future::proto_derived_expr(future::proto_base_expr::make(t)) {}

  T get() const { return proto::value(*this); }
};
