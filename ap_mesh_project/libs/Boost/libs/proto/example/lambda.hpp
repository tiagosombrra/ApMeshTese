...
struct catch_all_ {
  typedef catch_all_ exception_type;
};
};  // namespace tag
...
struct Arity
    : proto::or_<
          ...
          proto::otherwise<proto::fold<proto::_, mpl::int_<0>(),
                                       mpl::max<proto::_state, Arity>()> > > {};
    ...
    : proto::or_<
          ...
          proto::otherwise<
              proto::fold<proto::_, mpl::true_(),
                          mpl::and_<proto::_state, IsNullary>()> > > {};

struct Eval;

template <typename Expr, typename State, typename Data>
typename boost::result_of<Eval(Expr &, State &, Data &)>::type eval_lambda(
    Expr &e, State &s, Data &d);
...
struct EvalException : proto::transform<EvalException> {
  ...
  struct impl : proto::transform_impl<Expr, State, Data> {
    ...
    typename impl::state_param operator()(typename impl::expr_param,
                                          typename impl::state_param state,
...
struct EvalSwitch : proto::transform<EvalSwitch> {
  template <typename Expr, typename State, typename Data, long Arity,
            typename BackTag>
  struct impl2;

#define M0(Z, N, DATA)                                                 \
  case proto::tag_of<                                                  \
      typename proto::result_of::child_c<Expr, N>::type>::type::value: \
...
#define M1(Z, N, DATA)                                                      \
  ...
  struct impl2<Expr, State, Data, N, BackTag>                               \
    ...
    typedef void result_type;                                               \
                                                                            \
    void operator()(typename impl2::expr_param expr,                        \
                    typename impl2::state_param state,                      \
                    typename impl2::data_param data) const {                \
      switch (eval_lambda(proto::child_c<0>(expr), state, data)) {          \
        BOOST_PP_REPEAT_FROM_TO_##Z(1, N, M0, ~) default : break;           \
      }                                                                     \
    }                                                                       \
  };                                                                        \
                                                                            \
  ...
  struct impl2<Expr, State, Data, N, tag::default_>                         \
    ...
    void operator()(typename impl2::expr_param expr,                        \
                    ...
                    typename impl2::data_param data) const {                \
      switch (eval_lambda(proto::child_c<0>(expr), state, data)) {          \
        BOOST_PP_REPEAT_FROM_TO_##Z(1, BOOST_PP_DEC(N), M0, ~) default:;    \
...
#undef M1
  ...
  template <typename Expr, typename State, typename Data>
  struct impl
      : impl2<Expr, State, Data, proto::arity_of<Expr>::value,
              typename proto::tag_of<typename proto::result_of::child_c<
                  Expr, proto::arity_of<Expr>::value - 1>::type>::type> {};
};
...
struct Cases {
  ...
  struct case_ : proto::otherwise<proto::_default<Eval> > {};

  template <typename E>
  struct case_<tag::catch_<E> > : proto::otherwise<Eval(proto::_child)> {};

  template <int I>
  struct case_<tag::case_<I> > : proto::otherwise<Eval(proto::_child)> {};
};

template <>
struct Cases::case_<tag::while_> : proto::otherwise<EvalWhile> {};
template <>
struct Cases::case_<tag::for_> : proto::otherwise<EvalFor> {};
template <>
struct Cases::case_<tag::if_> : proto::otherwise<EvalIf> {};
template <>
struct Cases::case_<tag::if_else_> : proto::otherwise<EvalIfElse> {};
template <>
struct Cases::case_<tag::do_while_> : proto::otherwise<EvalDoWhile> {};
template <>
struct Cases::case_<tag::switch_> : proto::otherwise<EvalSwitch> {};
template <>
struct Cases::case_<tag::protect> : proto::otherwise<proto::_child> {};
template <>
struct Cases::case_<tag::default_> : proto::otherwise<Eval(proto::_child)> {};
template <>
struct Cases::case_<tag::catch_all_> : proto::otherwise<Eval(proto::_child)> {};
...
struct Cases::case_<proto::tag::terminal>
    : proto::or_<
          ...
          proto::when<proto::terminal<exception_placeholder>, EvalException>,
          proto::when<proto::terminal<reference_wrapper<proto::_> >,
                      unwrap_ref(proto::_value)>,
          proto::otherwise<proto::_default<Eval> > > {};

template <>
struct Cases::case_<proto::tag::function>
    : proto::or_<proto::when<proto::function<proto::terminal<rethrow_fun> >,
                             rethrow_fun(proto::_state)>,
                 proto::otherwise<proto::_default<Eval> > > {};

struct Eval : proto::switch_<Cases> {};
...
struct Grammar : proto::switch_<struct AssignOps> {};

struct AssignOps {
  template <typename Tag>
  struct case_ : proto::_ {};
};

template <>
struct AssignOps::case_<proto::tag::shift_left_assign> : proto::not_<proto::_> {
};
template <>
struct AssignOps::case_<proto::tag::shift_right_assign>
    : proto::not_<proto::_> {};
template <>
struct AssignOps::case_<proto::tag::multiplies_assign> : proto::not_<proto::_> {
};
template <>
struct AssignOps::case_<proto::tag::divides_assign> : proto::not_<proto::_> {};
template <>
struct AssignOps::case_<proto::tag::modulus_assign> : proto::not_<proto::_> {};
template <>
struct AssignOps::case_<proto::tag::plus_assign> : proto::not_<proto::_> {};
template <>
struct AssignOps::case_<proto::tag::minus_assign> : proto::not_<proto::_> {};
template <>
struct AssignOps::case_<proto::tag::bitwise_and_assign>
    : proto::not_<proto::_> {};
template <>
struct AssignOps::case_<proto::tag::bitwise_or_assign> : proto::not_<proto::_> {
};
template <>
struct AssignOps::case_<proto::tag::bitwise_xor_assign>
    : proto::not_<proto::_> {};
...
struct Generator : proto::pod_generator<llexpr> {};

// The domain for the lambda library.
struct lldomain : proto::domain<Generator, Grammar, proto::default_domain> {
  ...
  struct as_child<T[N]> : proto_base_domain::as_child<T[N]> {};
};
...
struct llresult<This()>
    : mpl::if_c<result_of<IsNullary(This &)>::type::value,
                result_of<Eval(This &, no_exception_type const &,
                               fusion::vector0<> &)>,
...
struct llexpr {
  ...
  template <typename Sig>
  struct result : llresult<Sig> {};

  typename result<llexpr const()>::type operator()() const {
    fusion::vector0<> args;
...
#define M3(R, SIZE, PRODUCT)                                                   \
  ...
  typename result<llexpr const(                                                \
      BOOST_PP_SEQ_FOR_EACH_I_R(R, M5, ~, PRODUCT))>::type                     \
  operator()(BOOST_PP_SEQ_FOR_EACH_I_R(R, M4, ~, PRODUCT)) const {             \
    BOOST_MPL_ASSERT_RELATION(result_of<Arity(Expr const &)>::type::value, <=, \
                              SIZE);                                           \
    BOOST_PP_CAT(fusion::vector,                                               \
                 SIZE)<BOOST_PP_SEQ_FOR_EACH_I_R(R, M5, ~, PRODUCT)>           \
        args(BOOST_PP_SEQ_FOR_EACH_I_R(R, M6, ~, PRODUCT));                    \
    return eval_lambda(*this, no_exception, args);                             \
  }                                                                            \
  /**/
...
#define M6(R, _, I, ELEM) BOOST_PP_COMMA_IF(I) BOOST_PP_CAT(a, I) /**/
...
#define BOOST_PP_ITERATION_PARAMS_1 \
  (3, (1, BOOST_LAMBDA_MAX_ARITY, "lambda.hpp"))
...
typedef llexpr<proto::terminal<placeholder<mpl::int_<0> > >::type>
    placeholder1_type;
typedef llexpr<proto::terminal<placeholder<mpl::int_<1> > >::type>
    placeholder2_type;
typedef llexpr<proto::terminal<placeholder<mpl::int_<2> > >::type>
    placeholder3_type;
...
struct byref {
  ...
  template <typename T>
  boost::reference_wrapper<llexpr<T> const> operator()(
      llexpr<T> const &t) const {
    return boost::ref(t);
  }
};
...
#define BOOST_LAMBDA_DEFINE_ASSIGN_OP(OP, TAG)                         \
  ...
  typename proto::result_of::make_expr<                                \
      TAG, lldomain, typename boost::result_of<byref(T &)>::type,      \
      U &>::type const                                                 \
  operator OP(T &t, U &u) {                                            \
...
template <typename T>
llexpr<typename proto::terminal<T &>::type> const var(T &t) {
...
struct constant_type
    : proto::result_of::make_expr<proto::tag::terminal, lldomain, T const &> {};

template <typename T>
typename constant_type<T>::type const constant(T const &t) {
...
template <typename T>
llexpr<typename proto::terminal<T const &>::type> const constant_ref(
    T const &t) {
...
struct while_generator {
  explicit while_generator(Cond const &c) : cond(c) {}

  template <typename Body>
  typename proto::result_of::make_expr<tag::while_, lldomain, Cond const &,
                                       Body const &>::type const
  operator[](Body const &body) const {
    return proto::make_expr<tag::while_, lldomain>(boost::ref(this->cond),
                                                   boost::ref(body));
  }
...
struct else_generator {
  ...
  explicit else_generator(Expr const &expr) : if_(expr) {}

  template <typename Body2>
  typename proto::result_of::make_expr<tag::if_else_, lldomain, condition_type,
                                       body1_type, Body2 const &>::type const
  operator[](Body2 const &body2) const {
    return proto::make_expr<tag::if_else_, lldomain>(
        boost::ref(proto::left(this->if_)), boost::ref(proto::right(this->if_)),
        boost::ref(body2));
  }
...
struct with_else : Expr {
  template <typename T>
  with_else(T const &expr) : Expr(expr), else_(*this) {}
...
template <typename Cond>
struct if_generator {
  explicit if_generator(Cond const &c) : cond(c) {}

  template <typename Body>
  with_else<typename proto::result_of::make_expr<
      tag::if_, lldomain, Cond const &, Body const &>::type> const
  operator[](Body const &body) const {
    return proto::make_expr<tag::if_, lldomain>(boost::ref(this->cond),
                                                boost::ref(body));
  }
...
struct for_generator {
  explicit for_generator(Init const &i, Cond const &c, Oper const &o)
      : init(i), cond(c), oper(o) {}

  template <typename Body>
  typename proto::result_of::make_expr<tag::for_, lldomain, Init const &,
                                       Cond const &, Oper const &,
                                       Body const &>::type const
  operator[](Body const &body) const {
    return proto::make_expr<tag::for_, lldomain>(
        boost::ref(this->init), boost::ref(this->cond), boost::ref(this->oper),
        boost::ref(body));
  }
...
template <typename Init, typename Cond, typename Oper>
for_generator<Init, Cond, Oper> for_(Init const &i, Cond const &c,
                                     Oper const &o) {
...
struct do_while_generator {
  explicit do_while_generator(Body const &b) : body(b) {}

  template <typename Cond>
  typename proto::result_of::make_expr<tag::do_while_, lldomain, Body const &,
                                       Cond const &>::type const
  operator()(Cond const &cond) const {
    return proto::make_expr<tag::do_while_, lldomain>(boost::ref(this->body),
                                                      boost::ref(cond));
  }
...
template <typename Body>
struct do_body {
  explicit do_body(Body const &body) : while_(body) {}
...
typedef llexpr<proto::function<llexpr<proto::terminal<noop_fun>::type> >::type>
    noop_type;
...
typename proto::result_of::make_expr<tag::for_, lldomain, Init const &,
                                     Cond const &, Oper const &,
                                     noop_type const &>::type const
for_loop(Init const &init, Cond const &cond, Oper const &oper) {
  return proto::make_expr<tag::for_, lldomain>(
      boost::ref(init), boost::ref(cond), boost::ref(oper), boost::ref(noop));
}
...
for_loop(Init const &init, Cond const &cond, Oper const &oper,
         Body const &body) {
  return proto::make_expr<tag::for_>(boost::ref(init), boost::ref(cond),
                                     boost::ref(oper), boost::ref(body));
}
...
while_loop(Cond const &cond, Body const &body) {
  return proto::make_expr<tag::while_, lldomain>(boost::ref(cond),
                                                 boost::ref(body));
}
...
do_while_loop(Cond const &cond, Body const &body) {
  return proto::make_expr<tag::do_while_, lldomain>(boost::ref(body),
                                                    boost::ref(cond));
}

template <typename Cond>
typename proto::result_of::make_expr<
    tag::do_while_, lldomain, noop_type const &, Cond const &>::type const
do_while_loop(Cond const &cond) {
  return proto::make_expr<tag::do_while_, lldomain>(boost::ref(noop),
                                                    boost::ref(cond));
}

template <typename Cond, typename Body1>
typename proto::result_of::make_expr<tag::if_, lldomain, Cond const &,
                                     Body1 const &>::type const
if_then(Cond const &cond, Body1 const &body1) {
  return proto::make_expr<tag::if_, lldomain>(boost::ref(cond),
                                              boost::ref(body1));
}

template <typename Cond, typename Body1, typename Body2>
typename proto::result_of::make_expr<tag::if_else_, lldomain, Cond const &,
                                     Body1 const &, Body2 const &>::type const
if_then_else(Cond const &cond, Body1 const &body1, Body2 const &body2) {
  return proto::make_expr<tag::if_else_, lldomain>(
      boost::ref(cond), boost::ref(body1), boost::ref(body2));
}

template <typename Cond, typename Body1, typename Body2>
typename proto::result_of::make_expr<proto::tag::if_else_, lldomain,
                                     Cond const &, Body1 const &,
                                     Body2 const &>::type const
...
#define M1(N, typename_A, A_const_ref, A_const_ref_a, ref_a)           \
  ...
  typename proto::result_of::make_expr<proto::tag::function, lldomain, \
                                       A_const_ref(N)>::type const     \
...
proto::unexpr<Lambda> const unlambda(Lambda const &lambda) {
  return proto::unexpr<Lambda>(lambda);
}

template <typename Lambda>
typename proto::result_of::make_expr<tag::protect, lldomain,
                                     Lambda const &>::type const
...
template <typename T, typename U>
typename proto::result_of::make_expr<proto::tag::function, lldomain,
                                     ll_static_cast_fun<T>, U const &>::type
...
template <typename T, typename U>
typename proto::result_of::make_expr<proto::tag::function, lldomain,
                                     ll_const_cast_fun<T>, U const &>::type
...
template <typename T, typename U>
typename proto::result_of::make_expr<proto::tag::function, lldomain,
                                     ll_dynamic_cast_fun<T>, U const &>::type
...
template <typename T, typename U>
typename proto::result_of::make_expr<
    proto::tag::function, lldomain, ll_reinterpret_cast_fun<T>, U const &>::type
...
struct new_array {
  typedef T *result_type;
  T *operator()(std::size_t n) const { return new T[n]; }
};
...
struct try_catch_cons : Tail {
  ...
  try_catch_cons(Head const &head, Tail const &tail) : Tail(tail), head(head) {}

  template <typename State, typename Data>
  typename result_of<Tail const(State const &, Data &)>::type operator()(
      State const &state, Data &data) const {
 ...
 private:
  ...
  typename result_of<Tail const(State const &, Data &)>::type invoke(
      State const &state, Data &data, type2type<Exception>) const {
    typedef
        typename result_of<Tail const(State const &, Data &)>::type result_type;
    try {
  ...
  template <typename State, typename Data>
  typename result_of<Tail const(State const &, Data &)>::type invoke(
      State const &state, Data &data, type2type<tag::catch_all_>) const {
    typedef
        typename result_of<Tail const(State const &, Data &)>::type result_type;
    try {
      return static_cast<result_type>(this->Tail::operator()(state, data));
      ...
      return static_cast<result_type>(
          eval_lambda(this->head, tag::catch_all_(), data));
    }
  }
...
struct try_catch_cons<Head, try_catch_nil> : proto::callable {
  try_catch_cons(Head const &head, try_catch_nil const &) : head(head) {}
  ...
  template <typename State, typename Data>
  typename result_of<Eval(Head const &, State, Data)>::type operator()(
      State const &state, Data &data) const {
...
struct try_catch_fun : proto::callable {
  ...
  struct result<This(Fun, State, Data)> : result_of<Fun(State, Data)> {};

  template <typename Fun, typename State, typename Data>
  typename result_of<Fun(State const &, Data &)>::type operator()(
      Fun const &fun, State const &state, Data &data) const {
...
struct Cases::case_<tag::try_>
    : proto::otherwise<try_catch_fun(
          proto::fold<proto::_, try_catch_nil(),
                      try_catch_cons<proto::_, proto::_state>(proto::_,
                                                              proto::_state)>,
          proto::_state, proto::_data)> {};

template <typename E, typename Expr>
typename proto::result_of::make_expr<tag::catch_<E>, lldomain,
...
template <typename Expr>
typename proto::result_of::make_expr<tag::catch_all_, lldomain,
                                     Expr const &>::type const
catch_all(Expr const &expr) {
  return proto::make_expr<tag::catch_all_, lldomain>(boost::ref(expr));
}

inline proto::result_of::make_expr<tag::catch_all_, lldomain,
                                   noop_type const &>::type const
catch_all() {
...
#define M1(N, typename_A, A_const_ref, A_const_ref_a, ref_a)       \
  template <typename_A(N)>                                         \
  typename proto::result_of::make_expr<tag::try_, lldomain,        \
                                       A_const_ref(N)>::type const \
...
template <typename Expr>
typename proto::result_of::make_expr<proto::tag::function, lldomain, throw_fun,
                                     Expr const &>::type const
throw_exception(Expr const &expr) {
  throw_fun fun;
  return proto::make_expr<proto::tag::function, lldomain>(fun,
                                                          boost::ref(expr));
}

inline proto::result_of::make_expr<proto::tag::function, lldomain,
                                   rethrow_fun>::type const
rethrow() {
...
template <typename Expr>
typename proto::result_of::make_expr<proto::tag::function, lldomain,
                                     make_void_fun, Expr const &>::type const
...
#define M1(N, typename_A, A_const_ref, A_const_ref_a, ref_a)       \
  template <typename_A(N)>                                         \
  typename proto::result_of::make_expr<tag::switch_, lldomain,     \
                                       A_const_ref(N)>::type const \
...
typename proto::result_of::make_expr<tag::case_<I>, lldomain,
                                     Expr const &>::type const
...
template <typename Expr>
typename proto::result_of::make_expr<tag::default_, lldomain,
                                     Expr const &>::type const
default_statement(Expr const &expr) {
  return proto::make_expr<tag::default_, lldomain>(boost::ref(expr));
}

inline proto::result_of::make_expr<tag::default_, lldomain,
                                   noop_type const &>::type const
default_statement() {
...
BOOST_PP_SEQ_FOR_EACH_PRODUCT(M2, BOOST_PP_REPEAT(BOOST_PP_ITERATION(), M1, ~))
