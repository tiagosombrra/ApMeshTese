...
struct LazyVectorGrammar
    : proto::or_<proto::terminal<std::vector<_> >,
...
struct lazy_subscript_context {
  ...
  struct eval : proto::default_eval<Expr, lazy_subscript_context> {};
  ...
  struct eval<Expr, proto::tag::terminal> {
    ...
    result_type operator()(Expr const &expr,
                           lazy_subscript_context &ctx) const {
