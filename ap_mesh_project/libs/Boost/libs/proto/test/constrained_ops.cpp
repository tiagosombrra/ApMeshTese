...
struct addition
    : proto::or_<proto::terminal<proto::_>, proto::plus<addition, addition> > {
};
...
struct my_lhs_domain
    : proto::domain<proto::pod_generator<lhs_extension>, addition, my_domain> {
};
...
struct my_rhs_domain
    : proto::domain<proto::pod_generator<rhs_extension>, addition, my_domain> {
};

template <class Expr>
struct extension {
  BOOST_PROTO_BASIC_EXTENDS(Expr, extension<Expr>, my_domain)
...
template <class Expr>
struct lhs_extension {
  BOOST_PROTO_BASIC_EXTENDS(Expr, lhs_extension<Expr>, my_lhs_domain)
};

template <class Expr>
struct rhs_extension {
  BOOST_PROTO_BASIC_EXTENDS(Expr, rhs_extension<Expr>, my_rhs_domain)
};
