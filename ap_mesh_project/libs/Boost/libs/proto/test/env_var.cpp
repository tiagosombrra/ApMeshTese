...
void test_comma() {
  ...
  proto::env<proto::data_type, void (&)()> e8 =
      (proto::data = boost::ref(test_as_env));
  BOOST_CHECK_EQUAL(&e8[proto::data], &test_as_env);
#else
  ...
  proto::env<tag0_type, char const(&)[6], proto::env<proto::data_type, int> >
  ...
  proto::env<tag0_type, int,
             proto::env<tag0_type, char const(&)[6],
  ...
  proto::env<proto::data_type, char const(&)[6], proto::env<tag0_type, int> >
...
void test_result_of_env_var() {
  ...
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env0_type, proto::data_type>::type,
          proto::key_not_found>));
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env0_type &, proto::data_type>::type,
  ...
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env0_type const &, proto::data_type>::type,
          proto::key_not_found>));

  typedef proto::env<proto::data_type, int> env1_type;
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env1_type, proto::data_type>::type, int>));
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env1_type &, proto::data_type>::type,
          int>));
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env1_type const &, proto::data_type>::type,
          int>));

  typedef proto::env<proto::data_type, int &> env2_type;
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env2_type, proto::data_type>::type,
          int &>));
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env2_type &, proto::data_type>::type,
  ...
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env2_type const &, proto::data_type>::type,
          int &>));

  typedef proto::env<proto::data_type, double,
                     proto::env<tag0_type, abstract &> >
      env3_type;
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env3_type, proto::data_type>::type,
          double>));
  BOOST_MPL_ASSERT(
      (boost::is_same<proto::result_of::env_var<env3_type, tag0_type>::type,
                      abstract &>));
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env3_type &, proto::data_type>::type,
  ...
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env3_type const &, proto::data_type>::type,
          double>));
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env3_type const &, tag0_type>::type,
          abstract &>));

  typedef proto::env<tag0_type, double, proto::env<tag0_type, abstract &> >
      env4_type;
  BOOST_MPL_ASSERT(
      (boost::is_same<proto::result_of::env_var<env4_type, tag0_type>::type,
                      double>));
  BOOST_MPL_ASSERT(
      (boost::is_same<proto::result_of::env_var<env4_type &, tag0_type>::type,
                      double>));
  BOOST_MPL_ASSERT(
      (boost::is_same<
          proto::result_of::env_var<env4_type const &, tag0_type>::type,
          double>));
}

void test_env_var() {
  proto::key_not_found x0 =
      proto::env_var<proto::data_type>(proto::empty_env());
...
void test_env_var_tfx() {
  ...
  // tests for _env
  BOOST_MPL_ASSERT((boost::is_same<boost::result_of<proto::_env(int_ &)>::type,
                                   proto::empty_env>));
  BOOST_MPL_ASSERT(
      (boost::is_same<boost::result_of<proto::_env(int_ &, int)>::type,
                      proto::empty_env>));
  BOOST_MPL_ASSERT((boost::is_same<
                    boost::result_of<proto::_env(int_ &, int &, float &)>::type,
                    float &>));

  // Bummer, is there any way around this?
#ifdef BOOST_RESULT_OF_USE_DECLTYPE
  BOOST_MPL_ASSERT(
      (boost::is_same<boost::result_of<proto::_env(int_ &, int &, float)>::type,
                      float const &>));
  BOOST_MPL_ASSERT(
      (boost::is_same<
          boost::tr1_result_of<proto::_env(int_ &, int &, float)>::type,
          float>));
#else
  BOOST_MPL_ASSERT(
      (boost::is_same<boost::result_of<proto::_env(int_ &, int &, float)>::type,
  ...
  proto::env<proto::data_type, int> e1 =
      proto::_env()(i, 0, proto::functional::as_env()(42));
  BOOST_CHECK_EQUAL(e1[proto::data], 42);

  proto::env<proto::data_type, int> e2 =
      proto::_env()(i, 0, (proto::data = 42));
  BOOST_CHECK_EQUAL(e2[proto::data], 42);

  proto::env<proto::data_type, int, proto::env<proto::data_type, int> > e3 =
      proto::_env()(i, 0, (42, proto::data = 43));
