...
struct Lambda
    : or_<when<terminal<placeholder<_> >,
               mpl::next<placeholder_arity<_value> >()>,
          when<terminal<_>, mpl::int_<0>()>,
          when<nary_expr<_, vararg<_> >,
               fold<_, mpl::int_<0>(), mpl::max<Lambda, _state>()> > > {};
}  // namespace grammar
...
struct lambda {
  ...
  typedef typename mpl::eval_if<
      typename lambda_arity<T>::type, mpl::identity<void>,
      proto::result_of::eval<T const, lambda_context<fusion::tuple<> > > >::type
      nullary_type;
...
#define M0(N, typename_A, A_const_ref, A_const_ref_a, ref_a)          \
  ...
  typename proto::result_of::eval<                                    \
      T const, lambda_context<fusion::tuple<A_const_ref(N)> > >::type \
