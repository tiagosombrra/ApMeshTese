...
struct Input
    : proto::or_<proto::shift_right<proto::terminal<std::istream &>, proto::_>,
                 proto::shift_right<Input, proto::_> > {};

struct Output
    : proto::or_<proto::shift_left<proto::terminal<std::ostream &>, proto::_>,
...
template <>
struct MyCases::case_<proto::tag::shift_right> : proto::_ {};

template <>
struct MyCases::case_<proto::tag::plus> : proto::_ {};
...
typedef mpl::integral_c<binary_representation_enum, two_complement>
    two_complement_c;
...
struct NumberGrammar
    : proto::or_<proto::terminal<number<proto::_, two_complement_c> >,
...
void test_matches() {
  ...
  proto::assert_matches<proto::terminal<proto::convertible_to<int> > >(
      proto::lit('a'));
  proto::assert_matches<proto::terminal<proto::convertible_to<int> > >(
      proto::as_child('a'));
  proto::assert_matches<proto::terminal<proto::convertible_to<int> > >(
  ...
  proto::assert_matches_not<proto::terminal<int> >(
      proto::lit((int_convertible())));
  proto::assert_matches_not<proto::terminal<int> >(
      proto::as_child((int_convertible())));
  proto::assert_matches_not<proto::terminal<int> >(
      proto::as_expr((int_convertible())));
  ...
  proto::assert_matches<proto::if_<boost::is_same<proto::_value, int>()> >(
      proto::lit(1));
  proto::assert_matches_not<proto::if_<boost::is_same<proto::_value, int>()> >(
      proto::lit('a'));
  ...
  proto::assert_matches<proto::terminal<char const *> >(
      proto::as_child("hello"));
  proto::assert_matches<proto::terminal<char const *> >(
      proto::as_expr("hello"));

  proto::assert_matches<proto::terminal<char const[6]> >(proto::lit("hello"));
  proto::assert_matches<proto::terminal<char const(&)[6]> >(
      proto::as_child("hello"));
  proto::assert_matches<proto::terminal<char const[6]> >(
      proto::as_expr("hello"));
  ...
  proto::assert_matches<proto::terminal<char const[proto::N]> >(
      proto::lit("hello"));
  proto::assert_matches<proto::terminal<char const(&)[proto::N]> >(
      proto::as_child("hello"));
  proto::assert_matches<proto::terminal<char const[proto::N]> >(
  ...
  proto::assert_matches<proto::terminal<char[proto::N]> >(
      proto::as_child("hello"));
  proto::assert_matches<proto::terminal<char[proto::N]> >(
      proto::as_expr("hello"));

  proto::assert_matches<proto::terminal<wchar_t const[proto::N]> >(
      proto::lit(L"hello"));
  proto::assert_matches<proto::terminal<wchar_t const(&)[proto::N]> >(
      proto::as_child(L"hello"));
  proto::assert_matches<proto::terminal<wchar_t const[proto::N]> >(
      proto::as_expr(L"hello"));

  proto::assert_matches<proto::terminal<wchar_t[proto::N]> >(
      proto::lit(L"hello"));
  proto::assert_matches<proto::terminal<wchar_t[proto::N]> >(
      proto::as_child(L"hello"));
  proto::assert_matches<proto::terminal<wchar_t[proto::N]> >(
  ...
  proto::assert_matches<proto::terminal<std::string> >(
  ...
  proto::assert_matches<proto::terminal<std::basic_string<proto::_> > >(
      proto::lit(std::string("hello")));
  proto::assert_matches<proto::terminal<std::basic_string<proto::_> > >(
      proto::as_child(std::string("hello")));
  proto::assert_matches<proto::terminal<std::basic_string<proto::_> > >(
  ...
  proto::assert_matches_not<proto::terminal<std::basic_string<proto::_> > >(
      proto::lit(1));
  proto::assert_matches_not<proto::terminal<std::basic_string<proto::_> > >(
      proto::as_child(1));
  proto::assert_matches_not<proto::terminal<std::basic_string<proto::_> > >(
  ...
  proto::assert_matches_not<
      proto::terminal<std::basic_string<proto::_, proto::_, proto::_> > >(
      proto::lit(1));
  proto::assert_matches_not<
      proto::terminal<std::basic_string<proto::_, proto::_, proto::_> > >(
      proto::as_child(1));
  ...
  proto::assert_matches<proto::terminal<std::basic_string<proto::_> const &> >(
      proto::lit(const_string("hello")));
  proto::assert_matches<proto::terminal<std::basic_string<proto::_> const &> >(
      proto::as_child(const_string("hello")));
  proto::assert_matches_not<
      proto::terminal<std::basic_string<proto::_> const &> >(
      proto::as_expr(const_string("hello")));

  proto::assert_matches<proto::terminal<void (&)()> >(proto::lit(a_function));
  proto::assert_matches<proto::terminal<void (&)()> >(
      proto::as_child(a_function));
  proto::assert_matches<proto::terminal<void (&)()> >(
      proto::as_expr(a_function));

  proto::assert_matches_not<proto::terminal<void (*)()> >(
      proto::lit(a_function));
  proto::assert_matches_not<proto::terminal<void (*)()> >(
      proto::as_child(a_function));
  proto::assert_matches_not<proto::terminal<void (*)()> >(
      proto::as_expr(a_function));

  proto::assert_matches<proto::terminal<proto::convertible_to<void (*)()> > >(
      proto::lit(a_function));
  proto::assert_matches<proto::terminal<proto::convertible_to<void (*)()> > >(
      proto::as_child(a_function));
  proto::assert_matches<proto::terminal<proto::convertible_to<void (*)()> > >(
  ...
  proto::assert_matches<proto::terminal<void (*const &)()> >(
      proto::lit(&a_function));
  proto::assert_matches<proto::terminal<void (*const &)()> >(
      proto::as_child(&a_function));
  proto::assert_matches_not<proto::terminal<void (*const &)()> >(
      proto::as_expr(&a_function));

  proto::assert_matches<
      proto::or_<proto::if_<boost::is_same<proto::_value, char>()>,
                 proto::if_<boost::is_same<proto::_value, int>()> > >(
      proto::lit(1));
  ...
  proto::assert_matches<proto::function<
      proto::terminal<int>, proto::vararg<proto::terminal<char> > > >(
      proto::lit(1)('a', 'b', 'c', 'd'));
  proto::assert_matches_not<proto::function<
      proto::terminal<int>, proto::vararg<proto::terminal<char> > > >(
      proto::lit(1)('a', 'b', 'c', "d"));

  proto::assert_matches<Anything>(cout_ << 1 << +proto::lit('a')
                                        << proto::lit(1)('a', 'b', 'c', "d"));
  ...
  {
    a_template<int[3]> a;
    proto::assert_matches<proto::terminal<a_template<proto::_> > >(
        proto::lit(a));
  }
  ...
  // Test that the actual derived expression type makes it through to proto::if_
  {
    ...
    proto::assert_matches<
        proto::if_<boost::is_same<proto::domain_of<proto::_>, my_domain>()> >(
        e);
  }
}
