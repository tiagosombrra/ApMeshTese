...
template <class E>
struct my_expr : proto::extends<E, my_expr<E>, my_domain> {
  my_expr(E const &e = E()) : proto::extends<E, my_expr<E>, my_domain>(e) {}
...
void test_impl(T const &) {
  ...
  BOOST_STATIC_ASSERT((
      boost::is_same<result_type,
                     my_expr<proto::basic_expr<
                         proto::tag::plus, proto::list1<my_expr<proto::terminal<
                                               int>::type> &> > > >::value));
}

// Test that we can call mpl algorithms on proto expression types, and get proto
// expression types back
void test_mpl() {
