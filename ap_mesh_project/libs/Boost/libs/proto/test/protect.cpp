...
struct TestWithMake : proto::make<proto::protect<_> > {};

struct TestWithMake1 : proto::make<identity<proto::protect<_> > > {};

struct TestWithMake2 : proto::make<identity<proto::protect<int> > > {};

struct TestWithMake3 : proto::make<identity<proto::protect<identity<_> > > > {};

struct TestWithMake4 : proto::make<identity<proto::protect<identity<int> > > > {
};
...
struct TestWithWhen1 : proto::when<_, identity<proto::protect<_> >()> {};

struct TestWithWhen2 : proto::when<_, identity<proto::protect<int> >()> {};
