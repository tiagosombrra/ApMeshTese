...
void test_ref_cast(T& v, P* ptr) {
  ...
  BOOST_TEST(
      (&mat_traits<T>::template write_element<0, 0>(v) == &ptr[0 * 2 + 0]));
  BOOST_TEST(
      (&mat_traits<T>::template write_element<0, 1>(v) == &ptr[0 * 2 + 1]));
  BOOST_TEST(
      (&mat_traits<T>::template write_element<1, 0>(v) == &ptr[1 * 2 + 0]));
  BOOST_TEST(
      (&mat_traits<T>::template write_element<1, 1>(v) == &ptr[1 * 2 + 1]));
  BOOST_TEST(
      (&mat_traits<T>::template write_element<2, 0>(v) == &ptr[2 * 2 + 0]));
  BOOST_TEST(
      (&mat_traits<T>::template write_element<2, 1>(v) == &ptr[2 * 2 + 1]));
...
int main() {
  using namespace boost::qvm;
  {
    ...
    BOOST_TEST(
        (mat_traits<int const[3][3]>::read_element_idx(0, 0, arr) == 00));
    BOOST_TEST(
        (mat_traits<int const[3][3]>::read_element_idx(0, 1, arr) == 01));
    BOOST_TEST(
        (mat_traits<int const[3][3]>::read_element_idx(0, 2, arr) == 02));
    BOOST_TEST(
        (mat_traits<int const[3][3]>::read_element_idx(1, 0, arr) == 10));
    BOOST_TEST(
        (mat_traits<int const[3][3]>::read_element_idx(1, 1, arr) == 11));
    BOOST_TEST(
        (mat_traits<int const[3][3]>::read_element_idx(1, 2, arr) == 12));
    BOOST_TEST(
        (mat_traits<int const[3][3]>::read_element_idx(2, 0, arr) == 20));
    BOOST_TEST(
        (mat_traits<int const[3][3]>::read_element_idx(2, 1, arr) == 21));
    BOOST_TEST(
        (mat_traits<int const[3][3]>::read_element_idx(2, 2, arr) == 22));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element<0, 0>(arr) == &arr[0][0]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element<0, 1>(arr) == &arr[0][1]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element<0, 2>(arr) == &arr[0][2]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element<1, 0>(arr) == &arr[1][0]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element<1, 1>(arr) == &arr[1][1]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element<1, 2>(arr) == &arr[1][2]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element<2, 0>(arr) == &arr[2][0]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element<2, 1>(arr) == &arr[2][1]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element<2, 2>(arr) == &arr[2][2]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element_idx(0, 0, arr) == &arr[0][0]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element_idx(0, 1, arr) == &arr[0][1]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element_idx(0, 2, arr) == &arr[0][2]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element_idx(1, 0, arr) == &arr[1][0]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element_idx(1, 1, arr) == &arr[1][1]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element_idx(1, 2, arr) == &arr[1][2]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element_idx(2, 0, arr) == &arr[2][0]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element_idx(2, 1, arr) == &arr[2][1]));
    BOOST_TEST(
        (&mat_traits<int[3][3]>::write_element_idx(2, 2, arr) == &arr[2][2]));
  }
  {
    int arr[42] = {0};
    int* ptr = arr + 5;
