  ...
  for (float x1 = 0; x1 < 6.28f; x1 += 0.5f)
    for (float z2 = 0; z2 < 6.28f; z2 += 0.5f)
      for (float y3 = 0; y3 < 6.28f; y3 += 0.5f) {
        mat<float, D, D> const m2 =
            rotx_mat<D>(x1) * rotz_mat<D>(z2) * roty_mat<D>(y3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_xzy(m1, x1, z2, y3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_xzy(m1, x1, z2, y3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
  ...
  for (float x1 = 0; x1 < 6.28f; x1 += 0.5f)
    for (float y2 = 0; y2 < 6.28f; y2 += 0.5f)
      for (float z3 = 0; z3 < 6.28f; z3 += 0.5f) {
        mat<float, D, D> const m2 =
            rotx_mat<D>(x1) * roty_mat<D>(y2) * rotz_mat<D>(z3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_xyz(m1, x1, y2, z3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_xyz(m1, x1, y2, z3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
...
void test_yxz() {
  ...
  for (float y1 = 0; y1 < 6.28f; y1 += 0.5f)
    for (float x2 = 0; x2 < 6.28f; x2 += 0.5f)
      for (float z3 = 0; z3 < 6.28f; z3 += 0.5f) {
        mat<float, D, D> const m2 =
            roty_mat<D>(y1) * rotx_mat<D>(x2) * rotz_mat<D>(z3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_yxz(m1, y1, x2, z3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_yxz(m1, y1, x2, z3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
  ...
  for (float y1 = 0; y1 < 6.28f; y1 += 0.5f)
    for (float z2 = 0; z2 < 6.28f; z2 += 0.5f)
      for (float x3 = 0; x3 < 6.28f; x3 += 0.5f) {
        mat<float, D, D> const m2 =
            roty_mat<D>(y1) * rotz_mat<D>(z2) * rotx_mat<D>(x3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_yzx(m1, y1, z2, x3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_yzx(m1, y1, z2, x3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
...
void test_zyx() {
  ...
  for (float z1 = 0; z1 < 6.28f; z1 += 0.5f)
    for (float y2 = 0; y2 < 6.28f; y2 += 0.5f)
      for (float x3 = 0; x3 < 6.28f; x3 += 0.5f) {
        mat<float, D, D> const m2 =
            rotz_mat<D>(z1) * roty_mat<D>(y2) * rotx_mat<D>(x3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_zyx(m1, z1, y2, x3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_zyx(m1, z1, y2, x3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
...
void test_zxy() {
  ...
  for (float z1 = 0; z1 < 6.28f; z1 += 0.5f)
    for (float x2 = 0; x2 < 6.28f; x2 += 0.5f)
      for (float y3 = 0; y3 < 6.28f; y3 += 0.5f) {
        mat<float, D, D> const m2 =
            rotz_mat<D>(z1) * rotx_mat<D>(x2) * roty_mat<D>(y3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_zxy(m1, z1, x2, y3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_zxy(m1, z1, x2, y3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
...
void test_xzx() {
  ...
  for (float x1 = 0; x1 < 6.28f; x1 += 0.5f)
    for (float z2 = 0; z2 < 6.28f; z2 += 0.5f)
      for (float x3 = 0; x3 < 6.28f; x3 += 0.5f) {
        mat<float, D, D> const m2 =
            rotx_mat<D>(x1) * rotz_mat<D>(z2) * rotx_mat<D>(x3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_xzx(m1, x1, z2, x3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_xzx(m1, x1, z2, x3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
...
void test_xyx() {
  ...
  for (float x1 = 0; x1 < 6.28f; x1 += 0.5f)
    for (float y2 = 0; y2 < 6.28f; y2 += 0.5f)
      for (float x3 = 0; x3 < 6.28f; x3 += 0.5f) {
        mat<float, D, D> const m2 =
            rotx_mat<D>(x1) * roty_mat<D>(y2) * rotx_mat<D>(x3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_xyx(m1, x1, y2, x3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_xyx(m1, x1, y2, x3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
...
void test_yxy() {
  ...
  for (float y1 = 0; y1 < 6.28f; y1 += 0.5f)
    for (float x2 = 0; x2 < 6.28f; x2 += 0.5f)
      for (float y3 = 0; y3 < 6.28f; y3 += 0.5f) {
        mat<float, D, D> const m2 =
            roty_mat<D>(y1) * rotx_mat<D>(x2) * roty_mat<D>(y3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_yxy(m1, y1, x2, y3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_yxy(m1, y1, x2, y3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
...
void test_yzy() {
  ...
  for (float y1 = 0; y1 < 6.28f; y1 += 0.5f)
    for (float z2 = 0; z2 < 6.28f; z2 += 0.5f)
      for (float y3 = 0; y3 < 6.28f; y3 += 0.5f) {
        mat<float, D, D> const m2 =
            roty_mat<D>(y1) * rotz_mat<D>(z2) * roty_mat<D>(y3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_yzy(m1, y1, z2, y3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_yzy(m1, y1, z2, y3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
...
void test_zyz() {
  ...
  for (float z1 = 0; z1 < 6.28f; z1 += 0.5f)
    for (float y2 = 0; y2 < 6.28f; y2 += 0.5f)
      for (float z3 = 0; z3 < 6.28f; z3 += 0.5f) {
        mat<float, D, D> const m2 =
            rotz_mat<D>(z1) * roty_mat<D>(y2) * rotz_mat<D>(z3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_zyz(m1, z1, y2, z3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_zyz(m1, z1, y2, z3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
...
void test_zxz() {
  ...
  for (float z1 = 0; z1 < 6.28f; z1 += 0.5f)
    for (float x2 = 0; x2 < 6.28f; x2 += 0.5f)
      for (float z3 = 0; z3 < 6.28f; z3 += 0.5f) {
        mat<float, D, D> const m2 =
            rotz_mat<D>(z1) * rotx_mat<D>(x2) * rotz_mat<D>(z3);
        {
        ...
        {
          mat<float, D, D> m1;
          set_rot_zxz(m1, z1, x2, z3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
        {
          mat<float, D, D> m1 = identity_mat<float, D>();
          rotate_zxz(m1, z1, x2, z3);
          BOOST_QVM_TEST_CLOSE(m1.a, m2.a, 0.0002f);
        }
      }
}
