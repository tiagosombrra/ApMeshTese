...
BOOST_AUTO_TEST_CASE(test_param) {
...
#ifndef BOOST_NO_CXX11_HDR_INITIALIZER_LIST
  boost::random::discrete_distribution<>::param_type parm_il = {1, 2, 1, 4};
  ...
  boost::random::discrete_distribution<>::param_type parm_it(probs.begin(),
                                                             probs.end());
  CHECK_PROBABILITIES(parm_it.probabilities(), list_of(.125)(.25)(.125)(.5));

  boost::random::discrete_distribution<>::param_type parm_fun(4, 99, 115,
                                                              gen());
