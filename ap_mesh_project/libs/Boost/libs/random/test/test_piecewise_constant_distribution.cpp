...
BOOST_CONCEPT_ASSERT(
    (RandomNumberDistribution<piecewise_constant_distribution<> >));
...
BOOST_AUTO_TEST_CASE(test_constructors) {
  ...
  boost::random::piecewise_constant_distribution<> dist_il2 = {{99}, gen()};
  ...
  boost::random::piecewise_constant_distribution<> dist_r2(intervals2,
                                                           weights2);
  ...
  boost::random::piecewise_constant_distribution<> dist_fun2(1, 99, 115, gen());
...
BOOST_AUTO_TEST_CASE(test_param) {
  ...
  boost::random::piecewise_constant_distribution<>::param_type param =
      dist.param();
  ...
  boost::random::piecewise_constant_distribution<>::param_type param_copy =
      param;
  ...
  boost::random::piecewise_constant_distribution<>::param_type parm_fun2(
      1, 99, 115, gen());
