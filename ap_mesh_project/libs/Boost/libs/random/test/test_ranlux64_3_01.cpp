...
#define BOOST_RANDOM_VALIDATION_VALUE \
  INT64_C(141789170949364) / std::pow(2.0, 48)
#define BOOST_RANDOM_SEED_SEQ_VALIDATION_VALUE \
  UINT64_C(85538657982635) / std::pow(2.0, 48)
#define BOOST_RANDOM_ITERATOR_VALIDATION_VALUE \
  UINT64_C(101724473226966) / std::pow(2.0, 48)
