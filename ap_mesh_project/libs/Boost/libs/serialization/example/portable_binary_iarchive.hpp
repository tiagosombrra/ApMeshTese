...
class portable_binary_iarchive_exception
 ...
 public:
  enum exception_code { incompatible_integer_size } m_exception_code;
...
class portable_binary_iarchive
 ...
 public:
  ...
  portable_binary_iarchive(std::basic_streambuf<std::istream::char_type,
