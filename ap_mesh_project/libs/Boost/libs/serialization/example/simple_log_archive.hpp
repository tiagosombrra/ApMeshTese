...
class simple_log_archive {
  ...
  void save(const T &t) {
    typedef BOOST_DEDUCED_TYPENAME boost::mpl::eval_if<
        ...
        BOOST_DEDUCED_TYPENAME boost::mpl::eval_if<
            ...
            // else
            boost::mpl::identity<save_only<simple_log_archive> > > >::type
        typex;
    typex::invoke(*this, t);
  }
 ...
 public:
  ...
  simple_log_archive &operator<<(const boost::serialization::nvp<T> &t) {
    ...
    for (unsigned int i = 0; i < m_depth; ++i) m_os << ' ';
    ++m_depth;
  ...
  simple_log_archive(std::ostream &os) : m_os(os), m_depth(0) {}
};
