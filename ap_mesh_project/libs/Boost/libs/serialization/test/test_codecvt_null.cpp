...
template <>
wchar_t test_data<2>::wchar_encoding[] = {(wchar_t)0x0001, (wchar_t)0x007f,
                                          (wchar_t)0x0080, (wchar_t)0x07ff,
                                          (wchar_t)0x0800, (wchar_t)0x7fff};

template <>
wchar_t test_data<4>::wchar_encoding[] = {
    (wchar_t)0x00000001, (wchar_t)0x0000007f, (wchar_t)0x00000080,
    (wchar_t)0x000007ff, (wchar_t)0x00000800, (wchar_t)0x0000ffff,
    (wchar_t)0x00010000, (wchar_t)0x0010ffff, (wchar_t)0x001fffff,
    (wchar_t)0x00200000, (wchar_t)0x03ffffff, (wchar_t)0x04000000,
    (wchar_t)0x7fffffff};
...
int test_main(int /* argc */, char* /* argv */[]) {
  ...
  std::locale null_locale =
      std::locale(old_loc, new boost::archive::codecvt_null<wchar_t>);
