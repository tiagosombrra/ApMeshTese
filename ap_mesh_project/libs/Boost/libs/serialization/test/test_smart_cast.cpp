...
void test_static_reference_cast_2() {
  ...
  BOOST_CHECK_EQUAL(
      &b2,
      (&smart_cast<Base2 &, Derived &>(smart_cast<Derived &, Base1 &>(b1))));
}
...
void test_static_reference_cast_1() {
  ...
  BOOST_CHECK_EQUAL(
      &b2,
      (&smart_cast_reference<Base2 &>(smart_cast_reference<Derived &>(b1))));
}
...
void test_static_pointer_cast() {
  ...
  // though explicit cross cast will always work
  BOOST_CHECK_EQUAL(pB2, smart_cast<Base2 *>(smart_cast<Derived *>(pB1)));
}
...
void test_dynamic_reference_cast_2() {
  ...
  BOOST_CHECK_EQUAL(&b2, (&smart_cast<VBase2 &, VDerived &>(
...
void test_dynamic_reference_cast_1() {
  ...
  BOOST_CHECK_EQUAL(
      &b2,
      (&smart_cast_reference<VBase2 &>(smart_cast_reference<VDerived &>(b1))));
}
...
void test_dynamic_pointer_cast() {
  ...
  // though explicit cross cast will always work
  BOOST_CHECK_EQUAL(pB2, smart_cast<VBase2 *>(smart_cast<VDerived *>(pB1)));
}
