...
struct sub_grammar : parser<DerivedT> {
  ...
  struct result {
    typedef
        typename parser_result<typename DerivedT::start_t, ScannerT>::type type;
  };
  ...
  template <typename ScannerT>
  typename parser_result<self_t, ScannerT>::type parse(
