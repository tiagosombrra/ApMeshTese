...
void Draw(sstream_t& out, chset<CharT> a, char const* str) {
  out << "\t";
...
//////////////////////////////////
template <typename CharT>
void chset_tests(sstream_t& out, CharT const* a_, CharT b1_, CharT b2_,
                 CharT e1_) {
  chset<CharT> a(a_);
