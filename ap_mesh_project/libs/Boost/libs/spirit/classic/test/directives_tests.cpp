...
void directives_test1() {
  ...
  scanner<char const*, scanner_policies<iter_policy> > scanx(cpx_first,
                                                             cpx_last);
  ...
  scanner<char const*, scanner_policies<iter_policy> > scan(cp_first, cp_last);
