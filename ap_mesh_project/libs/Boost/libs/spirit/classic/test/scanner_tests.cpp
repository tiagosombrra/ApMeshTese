...
void scanner_tests() {
  ...
  scanner<char const*> pp1(cp_first, cp_last);
  ...
  scanner<std::list<char>::iterator> pp2(li_first, li_last);
  ...
  scanner<char const*, scanner_policies<to_upper_iter_policy> > pp3(cp_first,
                                                                    cp_last);
  ...
  scanner<char const*, scanner_policies<skip_white_iter_policy> > pp4(cp_first,
                                                                      cp_last);
