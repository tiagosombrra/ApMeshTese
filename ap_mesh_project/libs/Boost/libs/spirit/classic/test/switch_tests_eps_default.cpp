...
struct switch_grammar_direct_default4
  ...
  struct definition {
    definition(switch_grammar_direct_default4 const& /*self*/) {
      r = switch_p[(case_p<'a'>(int_p), case_p<'b'>(ch_p(',')),
                    case_p<'c'>(str_p("bcd")), default_p)];
    }
...
struct switch_grammar_direct_default5
  ...
  struct definition {
    definition(switch_grammar_direct_default5 const& /*self*/) {
      r = switch_p[(case_p<'a'>(int_p), case_p<'b'>(ch_p(',')), default_p,
                    case_p<'c'>(str_p("bcd")))];
    }
...
struct switch_grammar_direct_default6
  ...
  struct definition {
    definition(switch_grammar_direct_default6 const& /*self*/) {
      r = switch_p[(default_p, case_p<'a'>(int_p), case_p<'b'>(ch_p(',')),
                    case_p<'c'>(str_p("bcd")))];
    }
...
struct switch_grammar_parser_default4
  ...
  struct definition {
    definition(switch_grammar_parser_default4 const& /*self*/) {
      r = switch_p(anychar_p)[(case_p<'a'>(int_p), case_p<'b'>(ch_p(',')),
                               case_p<'c'>(str_p("bcd")), default_p)];
    }
...
struct switch_grammar_parser_default6
  ...
  struct definition {
    definition(switch_grammar_parser_default6 const& /*self*/) {
      r = switch_p(
          anychar_p)[(default_p, case_p<'a'>(int_p), case_p<'b'>(ch_p(',')),
                      case_p<'c'>(str_p("bcd")))];
    }
  ...
  struct definition {
    definition(switch_grammar_actor_default4 const& /*self*/) {
      ...
      r = select_p('a', 'b', 'c', 'd')[r.val = arg1] >>
          switch_p(r.val)[(case_p<0>(int_p), case_p<1>(ch_p(',')),
                           case_p<2>(str_p("bcd")), default_p)];
    }
...
struct switch_grammar_actor_default5
  ...
  struct definition {
    definition(switch_grammar_actor_default5 const& /*self*/) {
      using phoenix::arg1;
      r = select_p('a', 'b', 'c', 'd')[r.val = arg1] >>
          switch_p(r.val)[(case_p<0>(int_p), case_p<1>(ch_p(',')), default_p,
                           case_p<2>(str_p("bcd")))];
    }
...
struct switch_grammar_actor_default6
  ...
  struct definition {
    definition(switch_grammar_actor_default6 const& /*self*/) {
      using phoenix::arg1;
      r = select_p('a', 'b', 'c', 'd')[r.val = arg1] >>
          switch_p(r.val)[(default_p, case_p<0>(int_p), case_p<1>(ch_p(',')),
                           case_p<2>(str_p("bcd")))];
    }
