  ...
  struct definition {
    definition(switch_grammar_direct_default1 const& /*self*/) {
      r = switch_p[(case_p<'a'>(int_p), case_p<'b'>(ch_p(',')),
                    case_p<'c'>(str_p("bcd")), default_p(str_p("default")))];
    }
...
struct switch_grammar_direct_default2
  ...
  struct definition {
    definition(switch_grammar_direct_default2 const& /*self*/) {
      r = switch_p[(case_p<'a'>(int_p), case_p<'b'>(ch_p(',')),
                    default_p(str_p("default")), case_p<'c'>(str_p("bcd")))];
    }
...
struct switch_grammar_direct_default3
  ...
  struct definition {
    definition(switch_grammar_direct_default3 const& /*self*/) {
      r = switch_p[(default_p(str_p("default")), case_p<'a'>(int_p),
                    case_p<'b'>(ch_p(',')), case_p<'c'>(str_p("bcd")))];
    }
...
struct switch_grammar_parser_default1
  ...
  struct definition {
    definition(switch_grammar_parser_default1 const& /*self*/) {
      r = switch_p(
          anychar_p)[(case_p<'a'>(int_p), case_p<'b'>(ch_p(',')),
                      case_p<'c'>(str_p("bcd")), default_p(str_p("default")))];
    }
...
struct switch_grammar_parser_default3
  ...
  struct definition {
    definition(switch_grammar_parser_default3 const& /*self*/) {
      r = switch_p(
          anychar_p)[(default_p(str_p("default")), case_p<'a'>(int_p),
                      case_p<'b'>(ch_p(',')), case_p<'c'>(str_p("bcd")))];
    }
  ...
  struct definition {
    definition(switch_grammar_actor_default1 const& /*self*/) {
      ...
      r = select_p('a', 'b', 'c', 'd')[r.val = arg1] >>
          switch_p(
              r.val)[(case_p<0>(int_p), case_p<1>(ch_p(',')),
                      case_p<2>(str_p("bcd")), default_p(str_p("default")))];
    }
  ...
  struct definition {
    definition(switch_grammar_actor_default2 const& /*self*/) {
      ...
      r = select_p('a', 'b', 'c', 'd')[r.val = arg1] >>
          switch_p(
              r.val)[(case_p<0>(int_p), case_p<1>(ch_p(',')),
                      default_p(str_p("default")), case_p<2>(str_p("bcd")))];
    }
...
struct switch_grammar_actor_default3
  ...
  struct definition {
    definition(switch_grammar_actor_default3 const& /*self*/) {
      using phoenix::arg1;
      r = select_p('a', 'b', 'c', 'd')[r.val = arg1] >>
          switch_p(r.val)[(default_p(str_p("default")), case_p<0>(int_p),
                           case_p<1>(ch_p(',')), case_p<2>(str_p("bcd")))];
    }
