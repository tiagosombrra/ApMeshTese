...
struct create_generator<std::pair<int const, std::string> > {
  typedef proto::result_of::deep_copy<BOOST_TYPEOF(int_ << ':' << string)>::type
      type;

  static type call() { return proto::deep_copy(int_ << ':' << string); }
};
}  // namespace traits
}  // namespace spirit
}  // namespace boost
...
void output_container(std::ostream& os, Container const& c) {
  ...
  os << karma::format(auto_,  // format description
                      c       // data
                      )
     << std::endl
     << std::endl;
  ...
  os << karma::format_delimited(auto_,  // format description
                                space,  // delimiter
                                c       // data
                                )
     << std::endl
  ...
  os << karma::format('[' << (+auto_ | "empty") << ']',  // format description
                      c                                  // data
                      )
     << std::endl
     << std::endl;
  ...
  os << karma::format_delimited("<ol>" << *verbatim["<li>" << auto_ << "</li>"]
  ...
  os << karma::format_delimited(
            *verbatim["|" << right_align[auto_] << "|"],  // format description
            '\n',                                         // delimiter
            c                                             // data
            )
     << std::endl;
