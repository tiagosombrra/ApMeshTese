...
bool classify_character(OutputIterator sink, char c) {
  ...
  if (!boost::spirit::char_encoding::ascii::isascii_(c)) return false;

  return generate(
      sink,
      //  Begin grammar
      ("The character '" << char_ << "' is "
                         << (&digit << "a digit" | &xdigit << "a xdigit" |
                             &alpha << "a alpha" | &punct << "a punct" |
                             &space << "a space" | &cntrl << "a cntrl" |
                             "of unknown type")),
      //  End grammar
      c, c);
}
...
int main() {
  std::cout << "/////////////////////////////////////////////////////////\n\n";
  std::cout
      << "\t\tA character classification micro generator for Spirit...\n\n";
  std::cout << "/////////////////////////////////////////////////////////\n\n";
