...
int main() {
  ...
  std::cout << karma::format(*int_,  // format description
                             v       // data
                             )
            << std::endl
            << std::endl;
  ...
  std::cout << karma::format_delimited(*int_,  // format description
                                       space,  // delimiter
                                       v       // data
                                       )
            << std::endl
  ...
  std::cout << karma::format_delimited(
  ...
  std::cout << karma::format(double_ % ", ",  // format description
                             v                // data
                             )
            << std::endl
            << std::endl;
  ...
  std::cout
      << karma::format_delimited(
             *verbatim["|" << right_align[int_] << "|"],  // format description
             '\n',                                        // delimiter
             v                                            // data
             )
      << std::endl;
