...
expression<Iterator, Lexer>::expression(
  ...
  unary_expr = postfix_expr | (tokenid_mask(token_ids::op_unary) > unary_expr);

  postfix_expr = function_call | primary_expr;

  primary_expr =
      lexer.lit_uint | lexer.true_or_false | identifier | '(' > expr > ')';
  ...
  BOOST_SPIRIT_DEBUG_NODES((
      expr)(unary_expr)(postfix_expr)(primary_expr)(function_call)(argument_list)(identifier));
