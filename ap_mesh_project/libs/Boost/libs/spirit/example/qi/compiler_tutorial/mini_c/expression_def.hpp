...
expression<Iterator>::expression(error_handler<Iterator>& error_handler)
  ...
  ///////////////////////////////////////////////////////////////////////
  // Tokens
  logical_or_op.add("||", ast::op_or);

  logical_and_op.add("&&", ast::op_and);
  ...
  keywords.add("true")("false")("if")("else")("while")("int")("void")("return");
  ...
  primary_expr = uint_ | function_call | identifier | bool_ | '(' > expr > ')';
  ...
  BOOST_SPIRIT_DEBUG_NODES((
      expr)(logical_or_expr)(logical_and_expr)(equality_expr)(relational_expr)(additive_expr)(multiplicative_expr)(unary_expr)(primary_expr)(function_call)(argument_list)(identifier));
