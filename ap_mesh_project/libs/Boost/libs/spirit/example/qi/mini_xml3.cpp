...
struct mini_xml_grammar
    : qi::grammar<Iterator, mini_xml(), qi::locals<std::string>,
                  ascii::space_type> {
  mini_xml_grammar() : mini_xml_grammar::base_type(xml, "xml") {
    ...
    on_error<fail>(xml, std::cout << val("Error! Expecting ")
                                  << _4  // what failed?
                                  << val(" here: \"")
  ...
  qi::rule<Iterator, mini_xml(), qi::locals<std::string>, ascii::space_type>
      xml;
...
int main(int argc, char** argv) {
  ...
  typedef client::mini_xml_grammar<std::string::const_iterator>
      mini_xml_grammar;
