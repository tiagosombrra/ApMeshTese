...
int main() {
  ...
  // test literal finding
  {
    ...
    BOOST_TEST(test_attr("!@#$%^&*KEY:123", seek["KEY:"] >> int_, i) &&
               i == 123);
  }
  ...
  // test sequence finding
  {
    ...
    BOOST_TEST(test_attr("!@#$%^&* KEY : 123", seek[lit("KEY") >> ':'] >> int_,
                         i, space) &&
               i == 123);
  }
  ...
  // test attr finding
  {
    ...
    BOOST_TEST(  // expect partial match
        test_attr("a06b78c3d", +seek[int_], v, false) && v[0] == 6 &&
        v[1] == 78 && v[2] == 3);
  }
  ...
  // test action
  {
    ...
    BOOST_TEST(  // expect partial match
        test("abcdefg", seek["def"][ref(b) = true], false) && b);
  }
