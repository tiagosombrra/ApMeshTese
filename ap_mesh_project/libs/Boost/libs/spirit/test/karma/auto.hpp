...
bool test_create_generator(Char const* expected, T const& t) {
  ...
  spirit_test::print_if_failed("test_create_generator", result, generated,
                               expected);
...
bool test_create_generator_auto(Char const* expected, T const& t) {
  ...
  spirit_test::print_if_failed("test_create_generator (auto)", result,
                               generated, expected);
  return result && generated == expected;
}
...
bool test_rule(Char const* expected, Attribute const& attr) {
  ...
  karma::rule<sink_type, Attribute()> r = karma::create_generator<Attribute>();
