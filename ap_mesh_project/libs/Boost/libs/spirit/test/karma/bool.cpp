...
struct special_bool_policy : boost::spirit::karma::bool_policies<> {
  ...
  static bool generate_false(OutputIterator& sink, bool) {
    ...
    return boost::spirit::karma::string_inserter<CharEncoding, Tag>::call(
        sink, "eurt");
  }
};
...
struct test_bool_policy : boost::spirit::karma::bool_policies<> {
  ...
  static bool call(OutputIterator& sink, test_bool_data b, Policies const& p) {
...
// we support Phoenix attributes only starting with V2.2
  ...
  {
    typedef boost::spirit::karma::bool_generator<test_bool_data,
                                                 test_bool_policy>
        test_bool_type;
