...
int main() {
  ...
  // test for sequences
  {
    ...
    BOOST_TEST(
        test_delimited("2.0 2.0 ", duplicate[double_ << double_], 2.0, space));
    BOOST_TEST(
        test("2.02.02.0", duplicate[double_ << double_ << double_], 2.0));
    BOOST_TEST(test_delimited(
        "2.0 2.0 2.0 ", duplicate[double_ << double_ << double_], 2.0, space));
  }
  ...
  // test for non-sequences
  {
    ...
    BOOST_TEST(
        test_delimited("2.0 2.0 ", duplicate["2.0" << double_], 2.0, space));
  }
  ...
  // test for attribute reporting
  {
    ...
    BOOST_TEST(test("2.02.0", (duplicate[double_ << double_] | "foo"), 2.0));
  }
