...
struct test_minmax {
  ...
  void operator()(T) const {
    ...
    typedef typename boost::mpl::if_<
        ...
        karma::int_generator<T>, karma::uint_generator<T> >::type
        int_generator_type;
    ...
    BOOST_TEST(test_delimited(expected_minval + " ", gen(minval), char(' ')));
    BOOST_TEST(
        test_delimited(expected_maxval + " ", gen(maxval), maxval, char(' ')));
    BOOST_TEST(
        test_delimited(expected_minval + " ", gen(minval), minval, char(' ')));
