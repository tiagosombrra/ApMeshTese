...
int main() {
...

  {
    ...
    BOOST_TEST(
        test("-nan", double_, -std::numeric_limits<double>::quiet_NaN()));
    ...
    BOOST_TEST(
        test("-nan", signed_, -std::numeric_limits<double>::quiet_NaN()));
...

  {
    ...
    // test NaN and Inf
    BOOST_TEST(
        test("NAN", upper[double_], std::numeric_limits<double>::quiet_NaN()));
    BOOST_TEST(test("-NAN", upper[double_],
                    -std::numeric_limits<double>::quiet_NaN()));
    BOOST_TEST(
        test("INF", upper[double_], std::numeric_limits<double>::infinity()));
    BOOST_TEST(
        test("-INF", upper[double_], -std::numeric_limits<double>::infinity()));
    ...
    BOOST_TEST(
        test("+NAN", upper[signed_], std::numeric_limits<double>::quiet_NaN()));
    BOOST_TEST(test("-NAN", upper[signed_],
                    -std::numeric_limits<double>::quiet_NaN()));
    BOOST_TEST(
        test("+INF", upper[signed_], std::numeric_limits<double>::infinity()));
    BOOST_TEST(
        test("-INF", upper[signed_], -std::numeric_limits<double>::infinity()));
#if defined(BOOST_SPIRIT_ZERO_PROBLEM)
