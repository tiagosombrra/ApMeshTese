...
int main() {
...

  {
    ...
    BOOST_TEST(test_delimited(
        "nan ", double_, std::numeric_limits<double>::quiet_NaN(), char_(' ')));
    BOOST_TEST(test_delimited("-nan ", double_,
                              -std::numeric_limits<double>::quiet_NaN(),
                              char_(' ')));
    BOOST_TEST(test_delimited(
        "inf ", double_, std::numeric_limits<double>::infinity(), char_(' ')));
    ...
    BOOST_TEST(test_delimited("-nan ", signed_,
                              ...
                              char_(' ')));
    BOOST_TEST(test_delimited(
        "+inf ", signed_, std::numeric_limits<double>::infinity(), char_(' ')));
...

  {
    ...
    BOOST_TEST(
        test("1.235e-01", science, 0.12345));  // note the rounding error!
    ...
    BOOST_TEST(test("1.235E-01", upper[science],
                    0.12345));  // note the rounding error!
