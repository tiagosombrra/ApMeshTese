...
struct grammar : karma::grammar<OutputIterator, boost::optional<double>()> {
...
int main() {
  ...
  BOOST_TEST(karma::generate(sink_type(generated1), g, d1) &&
             generated1 == "NA");
  BOOST_TEST(karma::generate(sink_type(generated2), g, d2) &&
             generated2 == "1.0U");
