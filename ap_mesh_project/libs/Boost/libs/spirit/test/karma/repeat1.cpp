...
int main() {
...

  {
    ...
    BOOST_TEST(
        test_delimited("a a a a a a a a ", repeat(8)[char_], str8, space));
    BOOST_TEST(test_delimited("a a a ", repeat(3)[char_], str8, space));
    BOOST_TEST(
        !test_delimited("a a a a a a a a ", repeat(9)[char_], str8, space));
    ...
    BOOST_TEST(
        test_delimited("a a a a a a a a ", repeat(3, inf)[char_], str8, space));
...

  {
    ...
    v += 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h';
    BOOST_TEST(
        test("[6162636465666768]", '[' << repeat[hex[action(v)]] << ']'));
  }
