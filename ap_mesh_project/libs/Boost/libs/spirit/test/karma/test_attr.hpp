...
void print_if_failed(char const* func, bool result,
                     std::basic_string<Char> const& generated,
                     T const& expected) {
  if (!result)
...
inline bool test_delimited(Char const* expected, Generator const& g,
  ...
  std::back_insert_iterator<string_type> outit(generated);
  bool result =
      karma::generate_delimited(outit, g, d, BOOST_PP_ENUM_PARAMS(N, attr));
...
template <typename Char, typename Generator, typename Delimiter,
          BOOST_PP_ENUM_PARAMS(N, typename A)>
inline bool test_predelimited(
    Char const* expected, Generator const& g, Delimiter const& d,
  ...
  string_type generated;
  std::back_insert_iterator<string_type> outit(generated);
  bool result = karma::generate_delimited(outit, g, d, pre_delimit,
