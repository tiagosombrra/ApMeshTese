...
inline boost::iterator_range<Iterator> const& get_iterpair(
    boost::iterator_range<Iterator> const& itp) {
  return itp;
}
...
inline bool test(Lexer& lex, Char const* input, std::size_t token_id = 0,
