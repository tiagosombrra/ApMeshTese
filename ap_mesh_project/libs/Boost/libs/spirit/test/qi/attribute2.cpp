...
int main() {
...

  {
    ...
    //      BOOST_TEST(test_attr("1.0,2.2", qi::attr_cast(qi::double_) % ',',
    //      v)); BOOST_TEST(test_attr("1.0,2.2"
    //        , qi::attr_cast<test_int_data1>(qi::double_) % ',', v));

    BOOST_TEST(test_attr(
        "1.0,2.2", qi::attr_cast<test_int_data1, int>(qi::double_) % ',', v));
    BOOST_TEST(v.size() == 2 && v[0].i == 1 && v[1].i == 2);
...

  {
    ...
    v.clear();
    BOOST_TEST(
        test_attr("1,2", qi::attr_cast<test_int_data2>(qi::int_) % ',', v));
    BOOST_TEST(v.size() == 2 && v[0].i == 1 && v[1].i == 2);

    v.clear();
    BOOST_TEST(test_attr(
        "1,2", qi::attr_cast<test_int_data2, int>(qi::int_) % ',', v));
    BOOST_TEST(v.size() == 2 && v[0].i == 1 && v[1].i == 2);
  }
...

  {
    ...
    BOOST_TEST(test_attr(
        "1.0,2.2", qi::attr_cast<test_int_data2, int>(qi::double_) % ',', v));
    BOOST_TEST(v.size() == 2 && v[0].i == 1 && v[1].i == 2);
