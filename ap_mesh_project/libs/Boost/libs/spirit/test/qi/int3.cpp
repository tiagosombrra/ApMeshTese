...
int main() {
...
#ifdef BOOST_HAS_LONG_LONG
  {
    ...
    BOOST_TEST(!test("1234567890123456789", long_long(0)));
    BOOST_TEST(
        test_attr("1234567890123456789", long_long(1234567890123456789LL), ll));
    BOOST_TEST(ll == 1234567890123456789LL);
    BOOST_TEST(!test_attr("1234567890123456789", long_long(0), ll));
