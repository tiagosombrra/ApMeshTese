...
int main() {
  ...
  {  // basics
    ...
    sym.add("Joel")("Ruby")("Tenji")("Tutit")("Kim")("Joey")("Joeyboy");

    BOOST_TEST_TRAIT_TRUE(
        (boost::spirit::traits::is_parser<symbols<char, int> >));
  ...
  {  // attributes
    ...
    sym.add("Joel", 1)("Ruby", 2)("Tenji", 3)("Tutit", 4)("Kim", 5)("Joey", 6)(
        "Joeyboy", 7);
