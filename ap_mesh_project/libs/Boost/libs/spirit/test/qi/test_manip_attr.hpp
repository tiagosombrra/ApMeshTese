...
///////////////////////////////////////////////////////////////////////////
template <typename Char, typename Parser, BOOST_PP_ENUM_PARAMS(N, typename A)>
...
inline bool test_postskipped(Char const* in, Parser const& p,
                             Skipper const& skipper,
                             BOOST_SCOPED_ENUM(boost::spirit::qi::skip_flag)
                                 post_skip,
                             BOOST_PP_ENUM_BINARY_PARAMS(N, A, val)) {
  namespace qi = boost::spirit::qi;
  ...
  BOOST_PP_REPEAT(N, DEFINE_ATTRIBUTE, _);
  strm >>
      qi::phrase_match(p, skipper, post_skip, BOOST_PP_ENUM_PARAMS(N, attr));
