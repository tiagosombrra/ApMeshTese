...
struct attribute_of_parser {
  typedef typename boost::spirit::result_of::compile<
      boost::spirit::qi::domain, Expr>::type parser_expression_type;

  typedef typename boost::spirit::traits::attribute_of<
      parser_expression_type, boost::spirit::unused_type, Iterator>::type type;
};
...
int main() {
  ...
  // special attribute transformation for utree in alternatives
  {
    ...
    BOOST_TEST(compare_attribute_type<utree>(r1 | -r1 | *r1 | r2 | -r2 | *r2));
  }
