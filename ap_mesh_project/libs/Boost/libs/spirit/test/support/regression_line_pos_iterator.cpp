...
struct validation {
  validation() : line(), column(), current(), is_defined(false) {}
...
void test(std::string const& input, validations const& validations) {
  ...
  for (; position != input_end && expected != validations.end();
       ++position, ++expected) {
    if (!expected->is_defined) continue;

    boost::iterator_range<pos_iterator_t> const range =
        get_current_line(input_begin, position, input_end);
...
void testLRandCR(std::string const& line_break) {
  ...
  validations const validations =
      boost::assign::list_of<validation>(1, 1, "")()(2, 1, "")();
...
void testLRandCR_foo_bar_git(std::string const& line_break) {
  ...
  validations const validations =
      boost::assign::list_of<validation>(1, 1, "foo")(1, 2, "foo")(1, 3, "foo")(
          1, 4, "foo")()(2, 1, "bar")(2, 2, "bar")(2, 3, "bar")(2, 4, "bar")()(
...
void testLRandCR_bar_git(std::string const& line_break) {
  ...
  validations const validations =
      boost::assign::list_of<validation>(1, 1, "")()(2, 1, "bar")(2, 2, "bar")(
          2, 3, "bar")(2, 4, "bar")()(3, 1, "git")(3, 2, "git")(3, 3, "git");
  test(input, validations);
}
