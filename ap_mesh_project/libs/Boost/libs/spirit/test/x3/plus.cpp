...
int main() {
...

  {
    ...
    BOOST_TEST(test_attr("a b c d", +lexeme[+alpha], v, space) &&
  ...
  // $$$ Fixme $$$
  /*{
      // The following 2 tests show that omit does not inhibit explicit
  attributes
      ...
      s.clear();
      BOOST_TEST(test_attr("b b b b ", omit[+char_('b')], s, space) && s ==
  "bbbb");
  }*/
  ...
  {  // actions
    ...
    BOOST_TEST(test("bbbb", (+char_)[f]) && 4 == v.size() && v[0] == 'b' &&
               v[1] == 'b' && v[2] == 'b' && v[3] == 'b');
  }
  ...
  {  // more actions
    ...
    BOOST_TEST(test("1 2 3", (+int_)[f], space) && 3 == v.size() && v[0] == 1 &&
               v[1] == 2 && v[2] == 3);
  }
