...
int main() {
  ...
  // test literal finding
  {
    ...
    BOOST_TEST(test_attr("!@#$%^&*KEY:123", x3::seek["KEY:"] >> x3::int_, i) &&
               i == 123);
  }
  // test sequence finding
  {
    ...
    BOOST_TEST(test_attr("!@#$%^&* KEY : 123",
                         x3::seek[x3::lit("KEY") >> ':'] >> x3::int_, i,
                         x3::space) &&
               i == 123);
  }
  ...
  // test action
  {
    ...
    BOOST_TEST(  // expect partial match
        test("abcdefg", x3::seek["def"][action], false) && b);
  }
  ...
  // test container
  {
    ...
    BOOST_TEST(test_attr("abcInt:100Int:95Int:44",
                         x3::seek[+("Int:" >> x3::int_)], v) &&
