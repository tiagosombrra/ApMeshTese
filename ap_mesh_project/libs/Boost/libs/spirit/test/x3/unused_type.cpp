...
int main() {
  ...
  static_assert(std::is_same<decltype(unused = 123), unused_type const&>::value,
                "");
  static_assert(
      std::is_same<decltype(unused = unused), unused_type const&>::value, "");
  static_assert(
      std::is_same<decltype(unused = unused_mut), unused_type const&>::value,
      "");
  static_assert(std::is_same<decltype(unused_mut = 123), unused_type&>::value,
                "");
  static_assert(
      std::is_same<decltype(unused_mut = unused), unused_type&>::value, "");
  static_assert(
      std::is_same<decltype(unused_mut = unused_mut), unused_type&>::value, "");
