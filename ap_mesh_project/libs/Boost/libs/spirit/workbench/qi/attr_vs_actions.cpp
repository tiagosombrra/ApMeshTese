...
struct test_attr {
  test_attr() { std::cout << "default construct" << std::endl; }

  test_attr(char) { std::cout << "construct from char" << std::endl; }

  test_attr(test_attr const&) { std::cout << "copy construct" << std::endl; }
