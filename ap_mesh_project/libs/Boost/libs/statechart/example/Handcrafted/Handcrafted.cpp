...
class state : public state_base {
 public:
  ...
  static const Derived& instance() { return instance_; }
...
int main() {
  ...
  std::cout << "Machine configuration: " << 2 << " states interconnected with "
            << 2 << " transitions.\n\n";

  std::cout << "p<CR>: Performance test\n";
  std::cout << "e<CR>: Exits the program\n\n";
  std::cout << "You may chain commands, e.g. pe<CR> performs a test and then "
               "exits the program\n\n";
