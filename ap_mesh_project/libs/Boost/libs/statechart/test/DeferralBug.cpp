//////////////////////////////////////////////////////////////////////////////
// Copyright 2010 Igor R
// (http://thread.gmane.org/gmane.comp.lib.boost.user/62985) Copyright 2010
// Andreas Huber Doenni Distributed under the Boost Software License,
// Version 1.0. (See accompany- ing file LICENSE_1_0.txt or copy at
...
struct s1 : sc::simple_state<s1, fsm> {
  typedef mpl::list<sc::transition<ev1to2, s2>, sc::deferral<ev2to3>,
                    sc::deferral<ev3to4_1>, sc::deferral<ev3to4_2> >
      reactions;
};

struct s3;
struct s2 : sc::simple_state<s2, fsm> {
  typedef mpl::list<sc::transition<ev2to3, s3>, sc::deferral<ev3to4_1>,
...
struct s3 : sc::simple_state<s3, fsm> {
  typedef mpl::list<sc::transition<ev3to4_1, s4_1>,
