...
struct A : sc::simple_state<A, HistoryTest, B> {
  typedef mpl::list<sc::transition<EvToB, B>, sc::transition<EvToD, D>,
                    ...
                    sc::transition<EvToH, H>, sc::transition<EvToI, I>,
                    sc::transition<EvToM, M>, sc::transition<EvToQ, Q> >
      reactions;
};
...
struct G : sc::simple_state<G, E, H> {
  typedef mpl::list<sc::transition<EvToDShallowLocal, sc::shallow_history<D> >,
