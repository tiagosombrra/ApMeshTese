...
struct Default0 : InnermostDefault<Default0<Context>,
                                   typename Context::template orthogonal<0> > {
  typedef InnermostDefault<Default0, typename Context::template orthogonal<0> >
      base_type;
  typedef typename base_type::my_context my_context;
...
//////////////////////////////////////////////////////////////////////////////
template <class Context>
struct Default1 : InnermostDefault<Default1<Context>,
                                   typename Context::template orthogonal<1> > {
  typedef InnermostDefault<Default1, typename Context::template orthogonal<1> >
      base_type;
  typedef typename base_type::my_context my_context;
...
struct Default2 : InnermostDefault<Default2<Context>,
                                   typename Context::template orthogonal<2> > {
  typedef InnermostDefault<Default2, typename Context::template orthogonal<2> >
      base_type;
  typedef typename base_type::my_context my_context;
