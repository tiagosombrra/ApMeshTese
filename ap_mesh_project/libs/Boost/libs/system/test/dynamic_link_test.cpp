...
//  manifestations, particularly with GCC, is that a system_error exception
//  thrown from a DLL or DSO is not caught.
//
...
int main() {
  try {
    ...
    std::cout << "  error: caught std::runtime_error instead of "
