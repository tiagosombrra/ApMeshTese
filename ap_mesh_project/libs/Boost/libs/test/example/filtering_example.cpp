...
BOOST_AUTO_TEST_SUITE(s1, *bt::disabled() *
                              bt::description("initially disabled suite 1") *
                              bt::label("label1") * bt::label("label2"))
...
BOOST_AUTO_TEST_CASE(test2, *bt::description("initially defaulted case s1/t2") *
...
BOOST_AUTO_TEST_SUITE(s2, *bt::disabled() * bt::label("label1") *
...
boost::test_tools::assertion_result do_it(bt::test_unit_id) { return false; }
...
BOOST_AUTO_TEST_SUITE(s3, *bt::disabled())

BOOST_AUTO_TEST_CASE(test1) { BOOST_TEST("s3" == test1v); }

//____________________________________________________________________________//

BOOST_AUTO_TEST_CASE(test2, *bt::timeout(10)) { BOOST_TEST("s3" == test2v); }

//____________________________________________________________________________//

BOOST_AUTO_TEST_CASE(test3, *bt::enabled()) { BOOST_TEST("s3" == test3v); }

//____________________________________________________________________________//

BOOST_AUTO_TEST_SUITE(
    s14, *bt::depends_on("s3/s15") *
             bt::description("test suite which depends on another test suite"))

BOOST_AUTO_TEST_CASE(test1, *bt::depends_on("s2")) {
...
BOOST_AUTO_TEST_CASE(test1) { BOOST_TEST("s15" == test1v); }
...
BOOST_AUTO_TEST_CASE(test1, *bt::disabled() * bt::label("label2")) {
...
BOOST_AUTO_TEST_CASE(
    test3, *bt::depends_on("s4/test2") *
               bt::description("test case which depends on enabled s4/t2, but "
                               "indirectly on disabled s4/t1")) {
...
BOOST_AUTO_TEST_CASE(test3) { BOOST_TEST("s6" == test3v); }

//____________________________________________________________________________//

BOOST_AUTO_TEST_SUITE(
    s9, *bt::description("test suite with all test cases disabled"))

BOOST_AUTO_TEST_CASE(test1, *bt::disabled() * bt::label("label1")) {
  BOOST_TEST("s9" == test1v);
}

//____________________________________________________________________________//

BOOST_AUTO_TEST_CASE(test2, *bt::disabled()) { BOOST_TEST("s9" == test2v); }
...
BOOST_AUTO_TEST_CASE(test1,
                     *bt::depends_on("s13") *
                         bt::description("test test case which depends on test "
                                         "suite with all test cases skipped")) {
...
BOOST_AUTO_TEST_CASE(test1, *bt::depends_on("s13/test2")) {
  BOOST_TEST("s13" == test1v);
}

//____________________________________________________________________________//

BOOST_AUTO_TEST_CASE(test2, *bt::disabled()) { BOOST_TEST("s13" == test2v); }
