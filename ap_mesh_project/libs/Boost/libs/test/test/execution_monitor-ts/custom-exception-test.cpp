...
void throw_my_exception1() { throw my_exception1(12); }
...
void throw_my_exception2() { throw my_exception2(89); }
...
test_suite* init_unit_test_suite(int /*argc*/, char* /*argv*/[]) {
  ...
  unit_test_monitor.register_exception_translator<my_exception2>(
      &my_exception2_translator);
