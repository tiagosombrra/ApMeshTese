...
BOOST_TEST_CASE_TEMPLATE_FUNCTION(test2, Number) { throw Number(); }
...
typedef boost::mpl::vector<int, int const, int volatile, int const volatile>
    test_types_ints_variations;
...
typedef boost::mpl::vector<int, int&
...
typedef boost::mpl::vector<int, int*, int const*, int const volatile*,
                           int const* const, int*&>
    test_types_ints_pointer_variations;
