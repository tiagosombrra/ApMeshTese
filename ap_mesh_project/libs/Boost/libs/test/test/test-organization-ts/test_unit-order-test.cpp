...
//  Version     : $Revision$
//
//  Description : tests proper order of test unis in case of various
...
BOOST_FIXTURE_TEST_CASE(test_suite_normal_order, _2suites_4_cases) {
  ut::test_unit_id order[] = {master->p_id, s1->p_id,  tc1->p_id, tc2->p_id,
...
BOOST_FIXTURE_TEST_CASE(test_suite_simple_dep, _2suites_4_cases) {
  ...
  ut::test_unit_id order[] = {master->p_id, s1->p_id,  tc2->p_id, tc1->p_id,
...
BOOST_FIXTURE_TEST_CASE(test_suite_cross_dep1, _2suites_4_cases) {
  ...
  ut::test_unit_id order[] = {master->p_id, s2->p_id,  tc3->p_id, tc4->p_id,
