...
void test_int_1() {
...
#endif
    //    BOOST_TEST(boost::detail::invoke<int>(&A_int_1::mem2, A_int_1()) ==
    //    4);
    A_int_1* ap = &a;
#if defined BOOST_THREAD_PROVIDES_INVOKE
    BOOST_TEST((boost::detail::invoker<int (A_int_1::*)() const, A_int_1*>(
  ...
  // member data pointer
  {
    ...
    //
    //#if defined BOOST_THREAD_PROVIDES_INVOKE
    //    BOOST_TEST(boost::detail::invoker<int A_int_1::*>(&A_int_1::data_, ap)
    //    == 6); boost::detail::invoker<int A_int_1::*>(&A_int_1::data_, ap) =
    //    7; BOOST_TEST(boost::detail::invoker<int A_int_1::*>(&A_int_1::data_,
    //    ap) == 7);
    //
