...
void test_void_1() {
  ...
  // const member function pointer
  {
    ...
    boost::detail::invoker<void (A_void_1::*)() const, A_void_1>(fp,
                                                                 A_void_1())();
    BOOST_TEST(count == save_count + 2);
    save_count = count;
    A_void_1 a;
...
//    BOOST_TEST(boost::detail::invoke<int>(A_int_1(), 4) == 3);
  ...
  {
#if defined BOOST_THREAD_PROVIDES_INVOKE
    BOOST_TEST((boost::detail::invoker<int (A_int_1::*)(), A_int_1>(
                    &A_int_1::mem1, A_int_1())() == 3));
//    BOOST_TEST(boost::detail::invoke<int>(&A_int_1::mem1, A_int_1()) == 3);
  ...
  // const member function pointer
  {
    BOOST_TEST((boost::detail::invoker<int (A_int_1::*)() const, A_int_1>(
                    &A_int_1::mem2, A_int_1())() == 4));
    A_int_1 a;
    BOOST_TEST((boost::detail::invoker<int (A_int_1::*)() const, A_int_1*>(
                    &A_int_1::mem2, &a)() == 4));
  }
  ...
  {
#if defined BOOST_THREAD_PROVIDES_INVOKE
//    BOOST_TEST((boost::detail::invoker<int A_int_1::*>(&A_int_1::data_,
//    A_int_1())() == 5));
////    BOOST_TEST(boost::detail::invoke<int>(&A_int_1::data_, A_int_1()) == 5);
//    A_int_1 a;
//    BOOST_TEST((boost::detail::invoker<int A_int_1::*>(&A_int_1::data_, a)()
//    == 5)); boost::detail::invoker<int A_int_1::*>(&A_int_1::data_, a)() = 6;
//    BOOST_TEST((boost::detail::invoker<int A_int_1::*>(&A_int_1::data_, a)()
//    == 6)); BOOST_TEST((boost::detail::invoker<int
//    A_int_1::*>(&A_int_1::data_, &a)() == 6)); boost::detail::invoker<int
//    A_int_1::*>(&A_int_1::data_, &a)() = 7;
//    BOOST_TEST((boost::detail::invoker<int A_int_1::*>(&A_int_1::data_, &a)()
//    == 7));
#endif
  }
