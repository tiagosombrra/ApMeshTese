...
int main() {
  ...
  std::cout << __FILE__ << "[" << __LINE__ << "]" << std::endl;
  {
    try {
      A a(3);
      boost::future<long> f =
          boost::async(boost::launch::deferred, &A::doit, &a);
      boost::this_thread::sleep_for(ms(300));
      int res;
      {
        check_timer timer(ms(500));
  ...
  {
    try {
      boost::future<int> f = boost::async(boost::launch::async,
  ...
  {
    try {
      boost::future<int> f = boost::async(boost::launch::deferred,
                                          BOOST_THREAD_MAKE_RV_REF(MoveOnly()));
      boost::this_thread::sleep_for(ms(300));
      int res;
      {
  ...
  {
    try {
      boost::future<boost::csbl::unique_ptr<int> > f =
          boost::async(boost::launch::async, &f3, 3);
      boost::this_thread::sleep_for(ms(300));
      boost::csbl::unique_ptr<int> res;
      {
        check_timer timer(ms(500));
  ...
  std::cout << __FILE__ << "[" << __LINE__ << "]" << std::endl;
  {
    try {
      boost::future<boost::csbl::unique_ptr<int> > f =
          boost::async(boost::launch::deferred, &f3, 3);
      // boost::this_thread::sleep_for(ms(300));
      boost::csbl::unique_ptr<int> res;
      {
        check_timer timer(ms(500));
  ...
  {
    try {
      boost::future<boost::csbl::unique_ptr<int> > f = boost::async(
          boost::launch::async, &f4, boost::csbl::unique_ptr<int>(new int(3)));
      boost::this_thread::sleep_for(ms(300));
      boost::csbl::unique_ptr<int> res;
      {
        check_timer timer(ms(500));
  ...
  std::cout << __FILE__ << "[" << __LINE__ << "]" << std::endl;
  {
    try {
      boost::future<boost::csbl::unique_ptr<int> > f =
          boost::async(boost::launch::deferred, &f4,
                       boost::csbl::unique_ptr<int>(new int(3)));
      // boost::this_thread::sleep_for(ms(300));
      boost::csbl::unique_ptr<int> res;
      {
        check_timer timer(ms(500));
  ...
  std::cout << __FILE__ << "[" << __LINE__ << "]" << std::endl;
  {
    try {
      boost::future<boost::csbl::unique_ptr<int> > f =
          boost::async(&f4, boost::csbl::unique_ptr<int>(new int(3)));
      boost::this_thread::sleep_for(ms(300));
      boost::csbl::unique_ptr<int> res;
      {
        check_timer timer(ms(500));
