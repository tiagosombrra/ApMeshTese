...
struct test_initially_unlocked_if_other_thread_has_lock {
  ...
  void operator()() {
    ...
    typedef test_initially_unlocked_if_other_thread_has_lock<Mutex, Lock>
        this_type;
    ...
    try {
      {
        ...
        BOOST_CHECK(
            done_cond.timed_wait(lk, boost::posix_time::seconds(2),
...
struct test_initially_unlocked_with_try_lock_if_other_thread_has_unique_lock {
  ...
  void operator()() {
    ...
    typedef test_initially_unlocked_with_try_lock_if_other_thread_has_unique_lock<
        Mutex, Lock>
        this_type;
...
struct test_initially_locked_if_other_thread_has_shared_lock {
  ...
  void operator()() {
    ...
    typedef test_initially_locked_if_other_thread_has_shared_lock<Mutex, Lock>
        this_type;
...
struct test_unlocked_after_try_lock_if_other_thread_has_lock {
  ...
  void operator()() {
    ...
    typedef test_unlocked_after_try_lock_if_other_thread_has_lock<Mutex, Lock>
        this_type;
...
typedef boost::mpl::vector<boost::mutex, boost::timed_mutex,
                           boost::recursive_mutex, boost::recursive_timed_mutex>
    mutex_types_with_scoped_lock;

BOOST_AUTO_TEST_CASE_TEMPLATE(test_scoped_lock_concept, Mutex,
                              mutex_types_with_scoped_lock) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_unique_lock_is_scoped_lock, Mutex,
                              all_mutex_types) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_scoped_try_lock_concept, Mutex,
                              mutex_types_with_scoped_try_lock) {
...
struct dummy_shared_mutex {
  ...
  void lock_shared() { shared_locked = true; }

  void unlock() {}

  void unlock_shared() { shared_unlocked = true; }
...
//
//     typedef
//     boost::mpl::vector<boost::mutex,boost::try_mutex,boost::timed_mutex,
//         boost::recursive_mutex,boost::recursive_try_mutex,boost::recursive_timed_mutex>
//         mutex_types_with_scoped_lock;
//
//     test->add(BOOST_TEST_CASE_TEMPLATE(test_scoped_lock_concept,mutex_types_with_scoped_lock));
//
//     typedef boost::mpl::vector<boost::try_mutex,boost::timed_mutex,
//         boost::recursive_try_mutex,boost::recursive_timed_mutex>
//         mutex_types_with_scoped_try_lock;
//
...
//     typedef
//     boost::mpl::vector<boost::mutex,boost::try_mutex,boost::timed_mutex,
//         boost::recursive_mutex,boost::recursive_try_mutex,boost::recursive_timed_mutex,boost::shared_mutex>
//         all_mutex_types;
//
