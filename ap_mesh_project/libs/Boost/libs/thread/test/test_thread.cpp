...
BOOST_AUTO_TEST_CASE(test_creation) { timed_test(&do_test_creation, 1); }
...
struct long_running_thread {
  ...
  long_running_thread() : done(false) {}
...
BOOST_AUTO_TEST_CASE(test_timed_join) { timed_test(&do_test_timed_join, 10); }
