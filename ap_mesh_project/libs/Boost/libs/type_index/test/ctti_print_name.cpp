...
// * outputs full ctti name so that TypeIndex library could be adjust to new
// compiler without requesting regression tester's help
...
int main() {
  ...
  std::cout << "int: " << ctti_type_index::type_id<int>() << '\n';
