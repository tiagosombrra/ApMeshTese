...
void comparing_types_between_modules() {
  boost::typeindex::type_index t_const_int =
...
// MSVC supports detect_missmatch pragma, but /GR- silently switch disable the
// link time check. /GR- undefies the _CPPRTTI macro. Using it to detect working
// detect_missmatch pragma.
