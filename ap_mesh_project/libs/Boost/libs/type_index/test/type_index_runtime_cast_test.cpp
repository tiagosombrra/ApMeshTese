...
void no_base() {
  ...
  BOOST_TEST_EQ(runtime_pointer_cast<single_derived>(&b),
                (single_derived*)NULL);
  BOOST_TEST_EQ(runtime_pointer_cast<unrelatedV1>(&b), (unrelatedV1*)NULL);
  BOOST_TEST_EQ(runtime_pointer_cast<unrelated_with_base>(&b),
                (unrelated_with_base*)NULL);
}
...
void multiple_base() {
  ...
  BOOST_TEST_EQ(runtime_pointer_cast<unrelated_with_base>(b1),
                (unrelated_with_base*)NULL);
}
...
void virtual_base() {
  ...
  base* b = &d;
  multiple_virtual_derived* d2 =
      runtime_pointer_cast<multiple_virtual_derived>(b);
...
void boost_shared_ptr() {
  ...
  boost::shared_ptr<single_derived> d2 =
      runtime_pointer_cast<single_derived>(b);
