...
struct self_assign_base : public test::exception_base {
  ...
  self_assign_base(std::size_t count = 0)
...
struct assign_values : assign_base<T> {
  assign_values(unsigned int count1, unsigned int count2, int tag1, int tag2,
                test::random_generator gen = test::default_generator,
...
template <class T>
struct assign_test2a : assign_values<T> {
...
template <class T>
struct assign_test3a : assign_values<T> {
...
template <class T>
struct assign_test4b : assign_values<T> {
