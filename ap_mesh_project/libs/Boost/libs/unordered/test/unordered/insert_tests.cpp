...
void unique_emplace_tests1(X*, test::random_generator generator) {
  ...
  for (typename test::random_values<X>::iterator it = v.begin(); it != v.end();
       ++it) {
    typename X::size_type old_bucket_count = x.bucket_count();
    float b = x.max_load_factor();
...
void map_insert_range_test1(X*, test::random_generator generator) {
  ...
  typedef test::list<std::pair<typename X::key_type, typename X::mapped_type> >
      list;
  test::random_values<X> v(1000, generator);
...
boost::unordered_multimap<test::object, test::object, test::hash,
                          test::equal_to, std::allocator<test::object> >*
...
UNORDERED_TEST(map_tests2,
               ((test_map))((default_generator)(generate_collisions)))
...
UNORDERED_AUTO_TEST(map_emplace_test) {
  {
    boost::unordered_map<
        int, overloaded_constructor, test::hash, test::equal_to,
...
UNORDERED_AUTO_TEST(map_emplace_test2) {
  ...
  {
    boost::unordered_map<
        overloaded_constructor, overloaded_constructor,
