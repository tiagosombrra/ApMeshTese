...
struct test_iter
    : public boost::random_access_iterator_helper<test_iter<T, R, P>, T,
                                                  std::ptrdiff_t, P, R> {
...
class test_opr : public test_opr_base {
...
test_opr_base::fruit_array_type test_opr_base::fruit = {
    "apple", "orange", "pear", "peach", "grape", "plum"};

template <typename T, typename R, typename P>
typename test_opr<T, R, P>::iter_type const test_opr<T, R, P>::fruit_begin =
    test_iter<T, R, P>(fruit);

template <typename T, typename R, typename P>
typename test_opr<T, R, P>::iter_type const test_opr<T, R, P>::fruit_end =
    test_iter<T, R, P>(fruit + fruit_length);
...
template <typename T, typename R, typename P>
void test_opr<T, R, P>::master_test(char const name[]) {
...
// Test post-increment
template <typename T, typename R, typename P>
void test_opr<T, R, P>::post_increment_test() {
...
// Test post-decrement
template <typename T, typename R, typename P>
void test_opr<T, R, P>::post_decrement_test() {
...
template <typename T, typename R, typename P>
void test_opr<T, R, P>::indirect_referral_test() {
...
template <typename T, typename R, typename P>
void test_opr<T, R, P>::offset_addition_test() {
...
template <typename T, typename R, typename P>
void test_opr<T, R, P>::reverse_offset_addition_test() {
...
template <typename T, typename R, typename P>
void test_opr<T, R, P>::offset_subtraction_test() {
...
// Test comparisons
template <typename T, typename R, typename P>
void test_opr<T, R, P>::comparison_test() {
  using std::cout;
  using std::ptrdiff_t;
...
// Test indexing
template <typename T, typename R, typename P>
void test_opr<T, R, P>::indexing_test() {
