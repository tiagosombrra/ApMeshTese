...
void test_padding() {
  ...
  // Test for padding
  {
    ...
    strm_ref << ctx.begin << std::setw(8) << string_view_type(ctx.abcd)
             << ctx.end;
  ...
  {
    ostream_type strm_ref;
    strm_ref << ctx.begin << std::setw(100) << string_view_type(ctx.abcd)
             << ctx.end;
  ...
  {
    ostream_type strm_ref;
    strm_ref << ctx.begin << std::setw(1) << string_view_type(ctx.abcd)
             << ctx.end;
