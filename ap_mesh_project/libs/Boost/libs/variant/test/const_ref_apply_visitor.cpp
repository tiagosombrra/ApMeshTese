...
struct construction_logger {
  ...
  construction_logger(const construction_logger& cl) : val_(cl.val_) {
    std::cout << val_ << " copy constructed\n";
  }

#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
  construction_logger(construction_logger&& cl) : val_(cl.val_) {
    std::cout << val_ << " move constructed\n";
  }
#endif

  friend std::ostream& operator<<(std::ostream& os,
                                  const construction_logger& cl) {
    return os << cl.val_;
  }
...
struct lex_streamer_explicit : boost::static_visitor<std::string> {
  ...
  std::string operator()(const T& val, const V& val2, const P& val3,
                         const S& val4) const {
...
struct lvalue_rvalue_detector : boost::static_visitor<std::string> {
  ...
  std::string operator()(T&& t, V&& v, P&& p) const {
    return operator()(std::forward<T>(t), std::forward<V>(v)) +
           ", " + operator()(std::forward<P>(p));
  }
  ...
  std::string operator()(T&, V&, P&, S&) const {
    return "lvalue reference, lvalue reference, lvalue reference, lvalue "
           "reference";
  }
#endif
};
...
void test_const_ref_parameter(const variant_type& test_var) {
  ...
  BOOST_TEST(boost::apply_visitor(lvalue_rvalue_detector(), test_var) ==
             "lvalue reference");
}

void test_const_ref_parameter2(const variant_type& test_var,
                               const variant_type& test_var2) {
  std::cout << "Testing const lvalue reference visitable\n";

  BOOST_TEST(
      boost::apply_visitor(lvalue_rvalue_detector(), test_var, test_var2) ==
      "lvalue reference, lvalue reference");
}

void test_const_ref_parameter4(const variant_type& test_var,
                               const variant_type& test_var2,
                               const variant_type& test_var3,
                               const variant_type& test_var4) {
...
void test_rvalue_parameter(variant_type&& test_var) {
  ...
  BOOST_TEST(boost::apply_visitor(lvalue_rvalue_detector(),
                                  std::move(test_var)) == "rvalue reference");
}

void test_rvalue_parameter2(variant_type&& test_var, variant_type&& test_var2) {
  std::cout << "Testing rvalue visitable\n";

  BOOST_TEST(boost::apply_visitor(lvalue_rvalue_detector(), std::move(test_var),
                                  std::move(test_var2)) ==
             "rvalue reference, rvalue reference");
}

void test_rvalue_parameter4(variant_type&& test_var, variant_type&& test_var2,
                            variant_type&& test_var3,
                            variant_type&& test_var4) {
#if !defined(BOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES) && \
    !defined(BOOST_NO_CXX11_HDR_TUPLE)
  std::cout << "Testing rvalue visitable with multivisitor\n";

  auto result = boost::apply_visitor(
      lvalue_rvalue_detector(), std::move(test_var), std::move(test_var2),
      std::move(test_var3), std::move(test_var4));
  std::cout << "result: " << result << std::endl;
  BOOST_TEST(
      result ==
      "rvalue reference, rvalue reference, rvalue reference, rvalue reference");
#else
  (void)test_var;
  (void)test_var2;
  (void)test_var3;
...
void test_cpp14_visitor(const variant_type& test_var) {
  ...
  BOOST_TEST(boost::apply_visitor(
                 [](auto&& v) { return lvalue_rvalue_detector()(FORWARD(v)); },
                 test_var) == "lvalue reference");
}

void test_cpp14_mutable_visitor(const variant_type& test_var) {
  std::cout << "Testing const lvalue visitable for c++14 with inline mutable "
               "lambda\n";

  BOOST_TEST(boost::apply_visitor(
                 [](auto&& v) mutable -> auto{
                   return lvalue_rvalue_detector()(FORWARD(v));
                 },
                 test_var) == "lvalue reference");
}
...
void test_cpp14_visitor(const variant_type& test_var,
  ...
  BOOST_TEST(boost::apply_visitor(
                 [](auto&& v, auto&& vv) {
                   return lvalue_rvalue_detector()(FORWARD(v), FORWARD(vv));
                 },
                 test_var, test_var2) == "lvalue reference, lvalue reference");
}
...
void test_cpp14_visitor(const variant_type& test_var,
  ...
  auto result = boost::apply_visitor(
      [](auto&& v, auto&& t, auto&& p) {
        return lvalue_rvalue_detector()(FORWARD(v), FORWARD(t), FORWARD(p));
      },
...
void test_cpp14_visitor(variant_type& test_var) {
  ...
  BOOST_TEST(
      boost::apply_visitor([](auto& v) { return lvalue_rvalue_detector()(v); },
                           test_var) == "lvalue reference");
}

void test_cpp14_mutable_visitor(variant_type& test_var) {
  std::cout
      << "Testing lvalue visitable for c++14 with inline mutable lambda\n";

  BOOST_TEST(
      boost::apply_visitor(
          [](auto& v) mutable -> auto{ return lvalue_rvalue_detector()(v); },
          test_var) == "lvalue reference");
}
...
void test_cpp14_visitor(variant_type& test_var, variant_type& test_var2) {
  ...
  BOOST_TEST(
      boost::apply_visitor(
          [](auto& v, auto& vv) { return lvalue_rvalue_detector()(v, vv); },
          test_var, test_var2) == "lvalue reference, lvalue reference");
}
...
void test_cpp14_visitor(variant_type& test_var, variant_type& test_var2,
  ...
  auto result = boost::apply_visitor(
      [](auto& v, auto& t, auto& p) {
        return lvalue_rvalue_detector()(v, t, p);
      },
      test_var, test_var2, test_var3);
  std::cout << "result: " << result << std::endl;
  BOOST_TEST(result == "lvalue reference, lvalue reference, lvalue reference");
...
void test_cpp14_visitor(variant_type&& test_var, variant_type&& test_var2) {
  ...
  BOOST_TEST(boost::apply_visitor(
                 ...
                 std::move(test_var),
                 std::move(test_var2)) == "rvalue reference, rvalue reference");
}
...
void run_rvalue_ref_tests() {
  ...
  test_rvalue_parameter4(boost::move(vv1), boost::move(vv2), boost::move(vv3),
                         boost::move(vv4));
#endif
}
...
void run_mixed_tests() {
  ...
  BOOST_TEST(
      boost::apply_visitor(lvalue_rvalue_detector(), v1, variant_type(10)) ==
      "lvalue reference, rvalue reference");

  std::cout << "Testing rvalue + lvalue visitable\n";
  BOOST_TEST(boost::apply_visitor(lvalue_rvalue_detector(), variant_type(10),
                                  v1) == "rvalue reference, lvalue reference");
  ...
  BOOST_TEST(
      boost::apply_visitor(lvalue_rvalue_detector(), v1, variant_type(10), v2,
                           variant_type(20)) ==
      "lvalue reference, rvalue reference, lvalue reference, rvalue reference");
#endif
  ...
  std::cout << "Testing lvalue + rvalue visitable\n";
  BOOST_TEST(boost::apply_visitor(lvalue_rvalue_detector(), v1, v1) ==
             "lvalue reference, lvalue reference");

  std::cout << "Testing rvalue + lvalue visitable\n";
  BOOST_TEST(
      boost::apply_visitor(lvalue_rvalue_detector(),
                           static_cast<const variant_type&>(variant_type(10)),
                           v1) == "lvalue reference, lvalue reference");

#if !defined(BOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES) && \
    !defined(BOOST_NO_CXX11_HDR_TUPLE)
  std::cout << "Testing rvalue + lvalue + rvalue visitable\n";
  BOOST_TEST(boost::apply_visitor(
                 lvalue_rvalue_detector(),
                 static_cast<const variant_type&>(variant_type(10)), v1,
                 static_cast<const variant_type&>(variant_type(20))) ==
             "lvalue reference, lvalue reference, lvalue reference");

  std::cout << "Testing lvalue + rvalue + lvalue + rvalue visitable\n";
  BOOST_TEST(
      boost::apply_visitor(
          lvalue_rvalue_detector(), v1,
          static_cast<const variant_type&>(variant_type(10)), v2,
          static_cast<const variant_type&>(variant_type(20))) ==
      "lvalue reference, lvalue reference, lvalue reference, lvalue reference");
#endif
#endif
...
void run_cpp14_mixed_tests() {
  ...
  BOOST_TEST(boost::apply_visitor(
                 [](auto&& v, auto&& t) {
                   return lvalue_rvalue_detector()(FORWARD(v), FORWARD(t));
                 },
  ...
  BOOST_TEST(boost::apply_visitor(
                 ...
                 variant_type(10), v1,
                 v2) == "rvalue reference, lvalue reference, lvalue reference");
  ...
  BOOST_TEST(boost::apply_visitor(
                 ...
                 v1, variant_type(10),
                 v2) == "lvalue reference, rvalue reference, lvalue reference");
#endif
#endif
}
