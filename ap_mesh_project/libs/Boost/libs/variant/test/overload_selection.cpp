...
bool foo(const boost::variant<A, B>&) { return false; }

bool foo(const boost::variant<C, D>&) { return true; }
...
//      warning C4522: 'assignment_tester' : multiple assignment operators
//      specified error C2666: variant::operator =' : 3 overloads have similar
//      conversions
...
void test_overload_selection_variant_assignment() { BOOST_TEST(true); }
...
struct info {
  ...
  typedef boost::variant<nil_, std::string, boost::recursive_wrapper<info>,
