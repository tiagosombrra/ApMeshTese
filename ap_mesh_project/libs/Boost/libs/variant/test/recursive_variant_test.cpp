...
struct printer : boost::static_visitor<std::string> {
  ...
  std::string operator()(const std::vector<T>& vec) const {
    ...
    for (; it != vec.end(); ++it) ost << printer()(*it);
...
void test_recursive_variant() {
  typedef boost::make_recursive_variant<
      int, std::vector<boost::recursive_variant_> >::type var1_t;
  ...
  result1 = printer()(var1_t(std::vector<var1_t>(vec1_copy)));
  std::cout << "result1++: " << result1 << '\n';
  BOOST_TEST(result1 == "( 3 5 ( 3 5 7 ) 7 ) ");

  var1_t vec1_another_copy(vec1_copy);
  vec1_copy[2].swap(vec1_another_copy);
  result1 = printer()(var1_t(vec1_copy));
  ...
  typedef boost::make_recursive_variant<
      ...
      std::vector<boost::recursive_variant_> >::type var2_t;
  ...
  typedef boost::make_recursive_variant<
      int, std::vector<boost::variant<
               double, std::vector<boost::recursive_variant_> > > >::type
      var3_t;
  ...
  typedef boost::make_recursive_variant<double, std::vector<var1_t> >::type
      var5_t;
  ...
  typedef boost::make_recursive_variant<
      int, std::map<int, boost::recursive_variant_> >::type var6_t;
  var6_t var6;

#if !defined(BOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES) && \
    !defined(BOOST_NO_CXX11_HDR_TUPLE)
  typedef boost::make_recursive_variant<
      int, std::tuple<int, boost::recursive_variant_> >::type var7_t;
  var7_t var7 =
      0;  // !!! Do not replace with `var7_t var7{0}` or `var7_t var7(0)` !!!
...
void test_recursive_variant_over() {
  typedef boost::make_recursive_variant_over<
      boost::mpl::vector<int, std::vector<boost::recursive_variant_> > >::type
      var1_t;
  ...
  typedef boost::make_recursive_variant_over<boost::mpl::vector<
  ...
  typedef boost::make_recursive_variant_over<boost::mpl::vector<
      int, std::vector<boost::make_variant_over<boost::mpl::vector<
               double, std::vector<boost::recursive_variant_> > >::type> > >::
      type var3_t;

  typedef boost::make_variant_over<boost::mpl::copy<
      boost::mpl::vector<double, std::vector<var3_t> > >::type>::type var4_t;
  ...
  typedef boost::make_recursive_variant_over<
      boost::mpl::vector<double, std::vector<var1_t> > >::type var5_t;
