...
struct Tracker {
  ...
  static void check() { BOOST_TEST(s_this_to_sn_.empty()); }
};
...
bool operator==(const jas& a, const jas& b) { return a.n_ == b.n_; }
...
struct compare_helper : boost::static_visitor<bool> {
  ...
  bool operator()(const ValueType& value) { return value == expected_; }
 ...
 public:
  ...
  bool operator()(const T& value) {
    typedef typename boost::is_same<T, ValueType>::type T_is_ValueType;
