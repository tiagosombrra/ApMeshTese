...
typedef boost::variant<char, unsigned char, signed char, unsigned short, int,
                       unsigned int>
    variant6_t;
...
struct test_visitor : boost::static_visitor<> {
  ...
  void operator()(char v0, unsigned char v1, signed char v2,
                  unsigned short v3) const {
    BOOST_TEST(v0 == 0);
    BOOST_TEST(v1 == 1);
    BOOST_TEST(v2 == 2);
    BOOST_TEST(v3 == 3);
  ...
  void operator()(char v0, unsigned char v1, signed char v2, unsigned short v3,
                  int v4) const {
    BOOST_TEST(v0 == 0);
    BOOST_TEST(v1 == 1);
    BOOST_TEST(v2 == 2);
  ...
  void operator()(my_noncopyable&, my_noncopyable&, my_noncopyable&,
                  my_noncopyable&) const {
    BOOST_TEST(true);
  }
  void operator()(my_noncopyable&, my_noncopyable&, my_noncopyable&,
                  my_noncopyable&, my_noncopyable&) const {
    BOOST_TEST(true);
  }
  void operator()(my_noncopyable&, my_noncopyable&, my_noncopyable&,
                  my_noncopyable&, my_noncopyable&, my_noncopyable&) const {
    BOOST_TEST(true);
  }
};
...
// Following test also pass, but requires many Gigabytes of RAM for compilation
// and compile for about 15 minutes
//#define BOOST_VARIANT_MULTIVISITORS_TEST_VERY_EXTREME
  ...
  boost::apply_visitor(v, v_array6[0], v_array6[1], v_array6[2], v_array6[3],
                       v_array6[4]);
  boost::apply_visitor(test_visitor(), v_array6[0], v_array6[1], v_array6[2],
                       v_array6[3], v_array6[4]);
#endif

  bool_like_t v0(1), v1(true), v2(1.0);

  BOOST_TEST(boost::apply_visitor(if_visitor(), v0, v1, v2) ==
             arithmetics_t(true));

#if !defined(BOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES)
  if_visitor if_vis;
  BOOST_TEST(boost::apply_visitor(if_vis)(v0, v1, v2) == arithmetics_t(true));
#endif
