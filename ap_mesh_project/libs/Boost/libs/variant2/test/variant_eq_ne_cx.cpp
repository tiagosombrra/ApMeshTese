...
BOOST_PRAGMA_MESSAGE(
    "Skipping constexpr op==, op!= test because BOOST_MP11_HAS_CXX14_CONSTEXPR "
    "is not defined")
...
int main() {
  ...
  {
    constexpr variant<int, int, float> v1, v2, v3(in_place_index_t<1>{}),
        v4(in_place_index_t<1>{}), v5(3.14f), v6(3.14f);
