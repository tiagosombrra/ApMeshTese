...
int main() {
  {
    ...
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get<0>(std::move(v))), int&&>));
...

  {
    ...
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get<0>(std::move(v))), int const&&>));
...

  {
    ...
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get<0>(v)), int const volatile&>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get<0>(std::move(v))), int const volatile&&>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get_if<0>(&v)), int const volatile*>));
  }
...

  {
    ...
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get<1>(std::move(v))), float&&>));
...

  {
    ...
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get<1>(std::move(v))), float const&&>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get_if<1>(&v)), float const*>));
  }

  {
    ...
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get<1>(std::move(v))), float volatile&&>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get_if<1>(&v)), float volatile*>));
  }

  {
    ...
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get<1>(v)), float const volatile&>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get<1>(std::move(v))), float const volatile&&>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_same<decltype(get_if<1>(&v)), float const volatile*>));
  }
