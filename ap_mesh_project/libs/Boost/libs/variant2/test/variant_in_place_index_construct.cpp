...
int main() {
  ...
  {
    variant<int, int, float, float, std::string, std::string> v(
        in_place_index_t<0>{}, 1);
  ...
  {
    variant<int, int, float, float, std::string, std::string> v(
        in_place_index_t<5>{}, {'a', 'b', 'c'}, std::allocator<char>());
