...
int main() {
  ...
  {
    constexpr variant<int, int, float, float, X, X> v(in_place_index_t<2>{},
                                                      3.14f);
  ...
  {
    constexpr variant<int, int, float, float, X, X> v(in_place_index_t<3>{},
                                                      3.14f);
  ...
  {
    constexpr variant<int, int, float, float, X, X> v(in_place_index_t<5>{}, 0,
                                                      0);
