...
int main() {
  ...
  {
    variant<int, int, float, float, std::string> v(
        in_place_type_t<std::string>{}, "text");
  ...
  {
    variant<int, int, float, float, std::string> v(
        in_place_type_t<std::string>{}, 4, 'a');
  ...
  {
    variant<int, int, float, float, std::string> v(
        in_place_type_t<std::string>{}, {'a', 'b', 'c'});
