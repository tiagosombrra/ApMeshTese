...
int main() {
...

  {
    ...
    BOOST_TEST_TRAIT_TRUE(
        (std::is_nothrow_move_assignable<variant<int, float>>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_nothrow_move_assignable<variant<int, int, float, float>>));
    ...
    BOOST_TEST_TRAIT_FALSE(
        (std::is_nothrow_move_assignable<variant<X1, int, float>>));

    BOOST_TEST_TRAIT_FALSE((std::is_nothrow_move_assignable<variant<int, X1>>));
    BOOST_TEST_TRAIT_FALSE(
        (std::is_nothrow_move_assignable<variant<int, int, X1>>));

    BOOST_TEST_TRAIT_FALSE((std::is_nothrow_move_assignable<variant<X1, X2>>));
    BOOST_TEST_TRAIT_FALSE(
        (std::is_nothrow_move_assignable<variant<X1, X2, int, int>>));
