...
int main() {
...

  {
    ...
    BOOST_TEST_TRAIT_TRUE(
        (std::is_nothrow_move_constructible<variant<int const>>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_nothrow_move_constructible<variant<int, int>>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_nothrow_move_constructible<variant<int, float>>));
    BOOST_TEST_TRAIT_TRUE(
        (std::is_nothrow_move_constructible<variant<int, int, float, float>>));

    BOOST_TEST_TRAIT_FALSE((std::is_nothrow_move_constructible<variant<X1>>));
    BOOST_TEST_TRAIT_FALSE(
        (std::is_nothrow_move_constructible<variant<X1, int>>));
    BOOST_TEST_TRAIT_FALSE(
        (std::is_nothrow_move_constructible<variant<X1, int, float>>));

    BOOST_TEST_TRAIT_FALSE(
        (std::is_nothrow_move_constructible<variant<int, X1>>));
    BOOST_TEST_TRAIT_FALSE(
        (std::is_nothrow_move_constructible<variant<int, int, X1>>));

    BOOST_TEST_TRAIT_FALSE(
        (std::is_nothrow_move_constructible<variant<X1, X2>>));
    BOOST_TEST_TRAIT_FALSE(
        (std::is_nothrow_move_constructible<variant<X1, X2, int, int>>));
    ...
    BOOST_TEST_TRAIT_FALSE(
        (std::is_move_constructible<variant<int, float, Y>>));
