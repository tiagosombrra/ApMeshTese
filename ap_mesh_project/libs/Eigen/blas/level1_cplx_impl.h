...
int EIGEN_BLAS_FUNC(EIGEN_CAT(REAL_SCALAR_SUFFIX,
                              rot))(int *n, RealScalar *px, int *incx,
                                    RealScalar *py, int *incy, RealScalar *pc,
                                    RealScalar *ps) {
  if (*n <= 0) return 0;
...
int EIGEN_BLAS_FUNC(EIGEN_CAT(REAL_SCALAR_SUFFIX,
                              scal))(int *n, RealScalar *palpha, RealScalar *px,
                                     int *incx) {
  if (*n <= 0) return 0;
