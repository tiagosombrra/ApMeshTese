...
void NodeAdaptive::InsertElement(std::shared_ptr<ElementAdaptive> element) {
...
std::shared_ptr<ElementAdaptive> NodeAdaptive::GetElement(
  ...
  std::list<std::shared_ptr<ElementAdaptive>>::iterator it =
...
const std::list<std::shared_ptr<ElementAdaptive>> &NodeAdaptive::GetElements()
    const {
  return elements_;
}
