...
#if USE_MPI
int GeneratorAdaptive::Execute(char* argv[], std::shared_ptr<Timer> &timer, MPI_Status status)
#else
...
std::shared_ptr<Geometry> GeneratorAdaptive::UnpakGeometry(double patches[], int size_patches) {
    std::shared_ptr<Geometry> geometry (new Geometry);
...
int size_thread)
#else
void GeneratorAdaptive::Generator(Model& model, std::shared_ptr<Timer> &timer, int id_range,
...
void GeneratorAdaptive::AdaptDomain(std::shared_ptr<Geometry> geometry, MeshAdaptive* mesh) {
...
int GeneratorAdaptive::GeneratorOmp(Model& model, std::shared_ptr<Timer> &timer, int id_range,
                                    [[maybe_unused]] int size_rank,
int size_thread)
...
void GeneratorAdaptive::AdaptDomainOmp(std::shared_ptr<Geometry> geo, MeshAdaptive* malha,
                                       std::shared_ptr<Timer> &timer, int sizeThread,
                                       int sizePatch) {
...
double GeneratorAdaptive::ErrorGlobal(MeshAdaptive* malha, std::shared_ptr<Timer> &timer,
                                      [[maybe_unused]] int rank,
...
void GeneratorAdaptive::GeneratorInitialMesh(std::shared_ptr<Geometry> geometry,
                                             MeshAdaptive* mesh, std::shared_ptr<Timer> &timer,
