#ifndef _DATA_WEDGE_H_
#define _DATA_WEDGE_H_
...
namespace Data
{
	class Wedge : public Data::Polyhedron
#if USE_POOL
		, public Data::Poolable<Data::Wedge>
#endif //#if USE_POOL
	{
#if USE_POOL
		USING_POOLABLE(Data::Wedge)
#endif //#if USE_POOL

	public:

		Wedge(Point *p1 = NULL, Point *p2 = NULL, Point *p3 = NULL, Point *p4 = NULL,
			Point *p5 = NULL, Point *p6 = NULL);
		virtual ~Wedge();
		...
		virtual void setPoints(Point *p1, Point *p2, Point *p3, Point *p4, Point *p5, Point *p6);
		...
		virtual Wedge &operator=(const Wedge &b);
