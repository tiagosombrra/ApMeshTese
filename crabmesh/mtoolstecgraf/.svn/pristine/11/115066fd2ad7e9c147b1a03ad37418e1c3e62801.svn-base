#ifndef _CRAB_MESH_PMTOOLS2_MODULE_H_
#define _CRAB_MESH_PMTOOLS2_MODULE_H_
...
namespace CRAbMesh
{
	class PMTools2Module : public CRAbMesh::PMJMesh2Module
	{
	public:

		PMTools2Module(Frame *frame = NULL, Canvas *canvas = NULL, bool makeMainDrive = true);
		virtual ~PMTools2Module();
...
#endif //#ifndef _CRAB_MESH_PMTOOLS2_MODULE_H_
