#ifndef _CRAB_MESH_MTOOLS_MODULE_H_
#define _CRAB_MESH_MTOOLS_MODULE_H_
...
namespace CRAbMesh
{
	class MToolsModule : public CRAbMesh::MeshModule
	{
	public:

		MToolsModule(Frame *frame = NULL, Canvas *canvas = NULL, bool makeMainDrive = true);
		virtual ~MToolsModule();
		...
		virtual enum MTools::MainDrive::Versions GetVersion() const;
	...
	protected:
		...
		/*typedef std::map<std::string, enum MTools::MainDrive::Versions> VersionMap;
...
#endif //#ifndef _CRAB_MESH_MTOOLS_MODULE_H_
