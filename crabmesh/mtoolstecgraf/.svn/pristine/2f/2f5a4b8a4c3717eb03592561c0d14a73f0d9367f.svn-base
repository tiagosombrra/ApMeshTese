...
std::string PJmesh::help(const std::string &programName)
{
	std::stringstream str;

	str << "Usage: " << programName << " PJmesh <input_filename> <options>\n"
		<< "Options:\n"
...
int PJmesh::execute(int argc, char *argv[])
{
	PJmesh::MainDrive *drive = new PJmesh::MainDrive();
