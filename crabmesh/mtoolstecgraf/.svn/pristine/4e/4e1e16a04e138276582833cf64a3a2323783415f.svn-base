...
/*                                                                           */
/*  Program:   predicate.c                                                   */
/*  Module:    $RCSfile: predicates.c,v $                                    */
/*  Language:  C++                                                           */
/*  Date:      $Date: 2000/08/03 22:25:01 $                                  */
...
/* return FPU precision to estimate round-off errors */
/* this requires exactinit() to be executed first    */
...
#ifdef __linux__
#ifndef __PGI
  /*  __setfpucw(_FPU_DEFAULT & ~_FPU_EXTENDED | _FPU_DOUBLE); glibc < 2.1*/
  unsigned short the_cw = (_FPU_DEFAULT & ~_FPU_EXTENDED | _FPU_DOUBLE) ;
  _FPU_SETCW( the_cw );
#endif
#endif
...
#else /* not SINGLE */
#ifdef WIN64
  // _control87() não aceita _MCW_PC ou _MCW_IC como máscara de bits na versão
  // 64 bits.
  _control87(_PC_64, 0);      /* set FPU control word for double precision */
#else
  _control87(_PC_53, MCW_PC);     /* set FPU control word for double
precision */
#endif
#endif /* not SINGLE */
#endif
...
/*****************************************************************************/
/*                                                                           */
/*  pcompress()   Compress an expansion.                                      */
/*                                                                           */
