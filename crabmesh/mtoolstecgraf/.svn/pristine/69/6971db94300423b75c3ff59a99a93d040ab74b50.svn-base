...
int Msh3DGeneration(
 ...
 int    *num_elems,
 int    **elems,
 int    pjmesh_oct_refi,                         // added by markos
 void (*callback_advanced_faces_ptr)(int, int) ) // added by markos
{
    ...
    status = Msh3DBdryContraction( ver, offset, num_node, num_face, nodes,
      tnodes, faces, num_gen_nodes, generated_nodes, tgenerated_nodes,
      num_elems, elems, callback_advanced_faces_ptr ) ;
