...
std::string TecGraf::Msh2D::help(const std::string &programName)
{
	std::stringstream str;

	str << "Usage: " << programName << " TecGrafMsh2D <input_filename> <options>\n"
		<< "Options:\n"
...
int TecGraf::Msh2D::execute(int argc, char *argv[])
{
	TecGraf::Msh2D::MainDrive *drive = new TecGraf::Msh2D::MainDrive();
