...
namespace Numerical
{
    ...
    public:
        ...
        static constexpr UInt numElements(UInt rows)
        {
    ...
    class TSymmetricMatrix :
        ...
        public Numerical::TMatrix<Real, 1, Numerical::ISymmetricMatrix::numElements(rows)>
    {
    public:
...
Numerical::TSymmetricMatrix<rows>::TSymmetricMatrix() :
    ...
    Numerical::TMatrix<Real, 1, Numerical::ISymmetricMatrix::numElements(rows)>::TMatrix()
{
...
Numerical::TSymmetricMatrix<rows>::TSymmetricMatrix(const TSymmetricMatrix<rows> &m) :
    Numerical::ISymmetricMatrix::ISymmetricMatrix(),
    Numerical::TMatrix<Real, 1, Numerical::ISymmetricMatrix::numElements(rows)>::TMatrix(m)
{
...
{
    return Numerical::TMatrix<Real, 1, Numerical::ISymmetricMatrix::numElements(rows)>::element(0, i);
}
