...
namespace Numerical
{
    ...
    protected:
        ...
        static UInt numElements(UInt rows);
    ...
    class TLowerTriangularMatrix :
        ...
        public Numerical::TMatrix<Real, 1, Numerical::ITriangularMatrix::numElements(rows)>
    {
    public:
...
Numerical::TLowerTriangularMatrix<rows>::TLowerTriangularMatrix() :
    ...
    Numerical::TMatrix<Real, 1, Numerical::ITriangularMatrix::numElements(rows)>::TMatrix()
{
...
Numerical::TLowerTriangularMatrix<rows>::TLowerTriangularMatrix(const TLowerTriangularMatrix<rows> &m) :
    Numerical::ILowerTriangularMatrix::ILowerTriangularMatrix(),
    Numerical::TMatrix<Real, 1, Numerical::ITriangularMatrix::numElements(rows)>::TMatrix(m)
{
...
{
    return Numerical::TMatrix<Real, 1, Numerical::ITriangularMatrix::numElements(rows)>::element(0, i);
}
