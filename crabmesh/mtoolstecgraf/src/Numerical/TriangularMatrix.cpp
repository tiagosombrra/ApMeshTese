...
UInt Numerical::ITriangularMatrix::numElements(UInt rows)
{
...
{
    return this->element(this->numElements(i) + j);
}
...
Numerical::LowerTriangularMatrix::LowerTriangularMatrix(UInt rows) :
    Numerical::ILowerTriangularMatrix::ILowerTriangularMatrix(),
    Numerical::TDMatrix<Real>::TDMatrix(1, Numerical::ITriangularMatrix::numElements(rows))
{
...
{
    this->reallocate(1, Numerical::ITriangularMatrix::numElements(rows));
}
