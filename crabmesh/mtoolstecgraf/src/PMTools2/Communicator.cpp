...
PMTools2::Communicator::Communicator(bool sharedParallelismEnabled) :
	Parallel::TMCommunicator::TMCommunicator(sharedParallelismEnabled)
{

}

PMTools2::Communicator::~Communicator()
{

}

bool PMTools2::Communicator::isMaster() const
{
	return (this->rank() == this->root());
}

Parallel::Transferable *PMTools2::Communicator::unpack(Parallel::Package &p) const
{
