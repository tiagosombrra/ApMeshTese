...
//     }
  ...
  */
  ...
  //     {
  //       w->coeffRef(nonzeroCoords[i].x(),nonzeroCoords[i].y()) =
  //       refMat.coeff(nonzeroCoords[i].x(),nonzeroCoords[i].y());
  //     }
  //   }
  //   VERIFY_IS_APPROX(m, refMat);
  ...
  // test basic computations
  {
    ...
    VERIFY_IS_APPROX(m1.col(0).eigen2_dot(refM2.row(0)),
                     refM1.col(0).eigen2_dot(refM2.row(0)));
  ...
  // test innerVectors()
  {
    ...
    // refMat2.block(0,j0,rows,n0) = refMat2.block(0,j0,rows,n0) +
