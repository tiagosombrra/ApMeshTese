...
const char features[] = {
    ...
    __has_feature(cxx_aggregate_nsdmi)
    "1"
#else
    "0"
#endif
    ...
    "CXX_FEATURE:"
#if ((__clang_major__ * 100) + __clang_minor__) >= 400 && \
    __has_feature(cxx_decltype_incomplete_return_types)
    "1"
#else
    "0"
#endif
    ...
    "CXX_FEATURE:"
#if ((__clang_major__ * 100) + __clang_minor__) >= 400 && \
    __has_feature(cxx_delegating_constructors)
    "1"
#else
    "0"
#endif
    ...
    "CXX_FEATURE:"
#if ((__clang_major__ * 100) + __clang_minor__) >= 400 && \
    __has_feature(cxx_inheriting_constructors)
    "1"
#else
    "0"
#endif
    ...
    "CXX_FEATURE:"
#if ((__clang_major__ * 100) + __clang_minor__) >= 400 && \
    __has_feature(cxx_init_captures)
    "1"
#else
    "0"
#endif
    ...
    "CXX_FEATURE:"
#if ((__clang_major__ * 100) + __clang_minor__) >= 400 && \
    __has_feature(cxx_user_literals)
    "1"
#else
    "0"
#endif
