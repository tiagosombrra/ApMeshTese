...
struct scalar_sum_op {
  ...
  EIGEN_STRONG_INLINE const Packet packetOp(const Packet& a,
...
struct scalar_product_op {
  ...
  EIGEN_STRONG_INLINE const result_type operator()(const LhsScalar& a,
...
struct scalar_hypot_op {
  ...
  EIGEN_STRONG_INLINE const Scalar operator()(const Scalar& _x,
...
// quick meta to indicate whether a functor allows linear access, just always
// answering 'yes' except for scalar_identity_op.
...
// have the same scalar type, except for multiplication where the mixing of
// different types is handled by scalar_product_traits In particular, real *
// complex<real> is allowed.
// FIXME move this to functor_traits adding a functor_default
template <typename Functor>
 ...
 * entries. \sa class CwiseUnaryOp, Cwise::inverse()
 */
template <typename Scalar>
