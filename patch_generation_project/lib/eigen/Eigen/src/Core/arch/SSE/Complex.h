...
struct conj_helper<Packet4f, Packet2cf, false, false> {
  ...
  EIGEN_STRONG_INLINE Packet2cf pmul(const Packet4f& x,
                                     const Packet2cf& y) const {
...
struct conj_helper<Packet2cf, Packet4f, false, false> {
  ...
  EIGEN_STRONG_INLINE Packet2cf pmul(const Packet2cf& x,
                                     const Packet4f& y) const {
...
struct conj_helper<Packet2d, Packet1cd, false, false> {
  ...
  EIGEN_STRONG_INLINE Packet1cd pmul(const Packet2d& x,
                                     const Packet1cd& y) const {
...
struct conj_helper<Packet1cd, Packet2d, false, false> {
  ...
  EIGEN_STRONG_INLINE Packet1cd pmul(const Packet1cd& x,
