...
// template parameter to define a template specialization. To be more precise,
// in the following specializations, it is not allowed to use Dim+1 instead of
// HDim.
 ...
 * which is available through the matrix() method.
 *
...
class Transform {
 ...
 public:
   ...
   * transform \a b The transformation matrix \a a must have a Dim+1 x Dim+1
   * sizes. */
  template <typename OtherDerived>
