 ...
 * square sense via the following steps: 1 - center the data to the mean 2 -
 * compute the covariance matrix 3 - pick the eigenvector corresponding to the
 * smallest eigenvalue of the covariance matrix The ratio of the smallest
 * eigenvalue and the second one gives us a hint about the relevance of the
 * solution. This value is optionally returned in \a soundness.
 *
 * \sa linearRegression()
 */
