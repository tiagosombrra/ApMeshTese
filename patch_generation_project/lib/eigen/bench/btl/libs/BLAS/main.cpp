...
int main() {
  ...
  bench<Action_partial_lu<blas_interface<REAL_TYPE> > >(MIN_MM, MAX_MM,
                                                        NB_POINT);

#ifdef HAS_LAPACK
  bench<Action_lu_decomp<blas_interface<REAL_TYPE> > >(MIN_MM, MAX_MM,
                                                       NB_POINT);
  bench<Action_hessenberg<blas_interface<REAL_TYPE> > >(MIN_MM, MAX_MM,
                                                        NB_POINT);
  bench<Action_tridiagonalization<blas_interface<REAL_TYPE> > >(MIN_MM, MAX_MM,
                                                                NB_POINT);
#endif
