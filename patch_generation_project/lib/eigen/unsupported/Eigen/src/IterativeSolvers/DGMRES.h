...
class DGMRES
 ...
 public:
   ...
   * of A \a x0 as an initial solution.
   *
   * \sa compute()
   */
  ...
  solveWithGuess(const MatrixBase<Rhs>& b, const Guess& x0) const {
    ...
    eigen_assert(Base::rows() == b.rows() &&
                 "DGMRES::solve(): invalid number of rows of the right hand "
                 "side matrix b");
    return internal::solve_retval_with_guess<DGMRES, Rhs, Guess>(
        *this, b.derived(), x0);
  }
 ...
 protected:
  ...
  int dgmresCycle(const MatrixType& mat, const Preconditioner& precond, Dest& x,
                  DenseVector& r0, RealScalar& beta, const RealScalar& normRhs,
                  int& nbIts) const;
  // Compute data to use for deflation
  int dgmresComputeDeflationData(const MatrixType& mat,
...
template <typename _MatrixType, typename _Preconditioner>
template <typename Dest>
int DGMRES<_MatrixType, _Preconditioner>::dgmresCycle(
...
template <typename _MatrixType, typename _Preconditioner>
int DGMRES<_MatrixType, _Preconditioner>::dgmresComputeDeflationData(
...
template <typename _MatrixType, typename _Preconditioner>
template <typename RhsType, typename DestType>
int DGMRES<_MatrixType, _Preconditioner>::dgmresApplyDeflation(
