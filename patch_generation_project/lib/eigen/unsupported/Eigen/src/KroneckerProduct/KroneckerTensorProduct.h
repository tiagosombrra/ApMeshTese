...
class KroneckerProduct : public ReturnByValue<KroneckerProduct<Lhs, Rhs> > {
 ...
 public:
  /*! \brief Constructor. */
  KroneckerProduct(const Lhs& A, const Rhs& B) : m_A(A), m_B(B) {}
...
class KroneckerProductSparse
    : public EigenBase<KroneckerProductSparse<Lhs, Rhs> > {
 private:
  typedef typename internal::traits<KroneckerProductSparse>::Index Index;

 public:
  /*! \brief Constructor. */
  KroneckerProductSparse(const Lhs& A, const Rhs& B) : m_A(A), m_B(B) {}
...
struct traits<KroneckerProduct<_Lhs, _Rhs> > {
  ...
  enum {
    ...
    CoeffReadCost =
        Lhs::CoeffReadCost + Rhs::CoeffReadCost + NumTraits<Scalar>::MulCost
  };
...
struct traits<KroneckerProductSparse<_Lhs, _Rhs> > {
  ...
  typedef typename promote_storage_type<typename traits<Lhs>::StorageKind,
      ...
      StorageKind;
  typedef typename promote_index_type<typename Lhs::Index,
                                      typename Rhs::Index>::type Index;
