...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::compute2x2(const MatrixType& A,
                                                   MatrixType& result) {
  using std::abs;
  using std::ceil;
  using std::imag;
  ...
  if (A(0, 0) == A(1, 1)) {
  ...
  } else if ((abs(A(0, 0)) < 0.5 * abs(A(1, 1))) ||
    ...
    result(0, 1) = A(0, 1) *
                   (Scalar(2) * numext::atanh2(y, x) +
                    Scalar(0, 2 * M_PI * unwindingNumber)) /
                   y;
  }
}
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computeBig(const MatrixType& A,
                                                   MatrixType& result) {
  using std::pow;
  ...
  const RealScalar maxNormForPade =
      maxPadeDegree <= 5 ? 5.3149729967117310e-1 :  // single precision
          maxPadeDegree <= 7 ? 2.6429608311114350e-1
                             :  // double precision
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade(MatrixType& result,
                                                    const MatrixType& T,
                                                    int degree) {
  switch (degree) {
    case 3:
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade3(MatrixType& result,
                                                     const MatrixType& T) {
  const int degree = 3;
  const RealScalar nodes[] = {0.1127016653792583114820734600217600L,
                              0.5000000000000000000000000000000000L,
                              0.8872983346207416885179265399782400L};
  const RealScalar weights[] = {0.2777777777777777777777777777777778L,
                                0.4444444444444444444444444444444444L,
  ...
  for (int k = 0; k < degree; ++k)
    result += weights[k] *
              (MatrixType::Identity(T.rows(), T.rows()) + nodes[k] * TminusI)
                  .template triangularView<Upper>()
                  .solve(TminusI);
}

template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade4(MatrixType& result,
                                                     const MatrixType& T) {
  const int degree = 4;
  const RealScalar nodes[] = {0.0694318442029737123880267555535953L,
                              0.3300094782075718675986671204483777L,
                              0.6699905217924281324013328795516223L,
                              0.9305681557970262876119732444464048L};
  const RealScalar weights[] = {0.1739274225687269286865319746109997L,
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade5(MatrixType& result,
                                                     const MatrixType& T) {
  const int degree = 5;
  const RealScalar nodes[] = {0.0469100770306680036011865608503035L,
                              0.2307653449471584544818427896498956L,
                              0.5000000000000000000000000000000000L,
                              0.7692346550528415455181572103501044L,
                              0.9530899229693319963988134391496965L};
  const RealScalar weights[] = {0.1184634425280945437571320203599587L,
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade6(MatrixType& result,
                                                     const MatrixType& T) {
  const int degree = 6;
  const RealScalar nodes[] = {0.0337652428984239860938492227530027L,
                              0.1693953067668677431693002024900473L,
  ...
  const RealScalar weights[] = {0.0856622461895851725201480710863665L,
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade7(MatrixType& result,
                                                     const MatrixType& T) {
  const int degree = 7;
  const RealScalar nodes[] = {0.0254460438286207377369051579760744L,
                              0.1292344072003027800680676133596058L,
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade8(MatrixType& result,
                                                     const MatrixType& T) {
  const int degree = 8;
  const RealScalar nodes[] = {0.0198550717512318841582195657152635L,
                              0.1016667612931866302042230317620848L,
  ...
  const RealScalar weights[] = {0.0506142681451881295762656771549811L,
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade9(MatrixType& result,
                                                     const MatrixType& T) {
  const int degree = 9;
  const RealScalar nodes[] = {0.0159198802461869550822118985481636L,
  ...
  const RealScalar weights[] = {0.0406371941807872059859460790552618L,
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade10(MatrixType& result,
                                                      const MatrixType& T) {
  const int degree = 10;
  const RealScalar nodes[] = {0.0130467357414141399610179939577740L,
                              0.0674683166555077446339516557882535L,
  ...
  const RealScalar weights[] = {0.0333356721543440687967844049466659L,
...
template <typename MatrixType>
void MatrixLogarithmAtomic<MatrixType>::computePade11(MatrixType& result,
                                                      const MatrixType& T) {
  const int degree = 11;
  const RealScalar nodes[] = {0.0108856709269715035980309994385713L,
                              0.0564687001159523504624211153480364L,
  ...
  const RealScalar weights[] = {0.0278342835580868332413768602212743L,
...
class MatrixLogarithmReturnValue
 ...
 public:
   ...
   *
   * \param[out]  result  Logarithm of \p A, where \A is as specified in the
   * constructor.
   */
  ...
  inline void evalTo(ResultType& result) const {
    ...
    typedef Matrix<ComplexScalar, Dynamic, Dynamic, Options, RowsAtCompileTime,
                   ColsAtCompileTime>
        DynMatrixType;
