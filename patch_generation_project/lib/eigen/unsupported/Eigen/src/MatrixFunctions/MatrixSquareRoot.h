 ...
 * \brief Class for computing matrix square roots of upper quasi-triangular
 * matrices. \tparam  MatrixType  type of the argument of the matrix square
 * root, expected to be an instantiation of the Matrix class template.
 *
...
class MatrixSquareRootQuasiTriangular {
 public:
   ...
   */
  MatrixSquareRootQuasiTriangular(const MatrixType& A) : m_A(A) {
 ...
 private:
  ...
  void compute2x2diagonalBlock(MatrixType& sqrtT, const MatrixType& T,
  ...
  static void solveAuxiliaryEquation(SmallMatrixType& X,
...
// blocks of T
template <typename MatrixType>
void MatrixSquareRootQuasiTriangular<MatrixType>::computeDiagonalPartOfSqrt(
    MatrixType& sqrtT, const MatrixType& T) {
  using std::sqrt;
...
template <typename MatrixType>
void MatrixSquareRootQuasiTriangular<MatrixType>::computeOffDiagonalPartOfSqrt(
    MatrixType& sqrtT, const MatrixType& T) {
  const Index size = m_A.rows();
...
template <typename MatrixType>
void MatrixSquareRootQuasiTriangular<MatrixType>::compute2x2diagonalBlock(
...
template <typename MatrixType>
void MatrixSquareRootQuasiTriangular<MatrixType>::compute1x1offDiagonalBlock(
    MatrixType& sqrtT, const MatrixType& T, typename MatrixType::Index i,
    typename MatrixType::Index j) {
...
template <typename MatrixType>
void MatrixSquareRootQuasiTriangular<MatrixType>::compute1x2offDiagonalBlock(
    MatrixType& sqrtT, const MatrixType& T, typename MatrixType::Index i,
    typename MatrixType::Index j) {
...
// similar to compute1x1offDiagonalBlock()
template <typename MatrixType>
void MatrixSquareRootQuasiTriangular<MatrixType>::compute2x1offDiagonalBlock(
    MatrixType& sqrtT, const MatrixType& T, typename MatrixType::Index i,
    typename MatrixType::Index j) {
...
// similar to compute1x1offDiagonalBlock()
template <typename MatrixType>
void MatrixSquareRootQuasiTriangular<MatrixType>::compute2x2offDiagonalBlock(
    MatrixType& sqrtT, const MatrixType& T, typename MatrixType::Index i,
    typename MatrixType::Index j) {
...
template <typename MatrixType>
template <typename SmallMatrixType>
void MatrixSquareRootQuasiTriangular<MatrixType>::solveAuxiliaryEquation(
    SmallMatrixType& X, const SmallMatrixType& A, const SmallMatrixType& B,
    const SmallMatrixType& C) {
  EIGEN_STATIC_ASSERT(
      (internal::is_same<SmallMatrixType, Matrix<Scalar, 2, 2> >::value),
...
class MatrixSquareRootTriangular {
 public:
  MatrixSquareRootTriangular(const MatrixType& A) : m_A(A) {
    eigen_assert(A.rows() == A.cols());
  }
...
void MatrixSquareRootTriangular<MatrixType>::compute(ResultType& result) {
  ...
  for (Index j = 1; j < m_A.cols(); j++) {
    for (Index i = j - 1; i >= 0; i--) {
      ...
      result.coeffRef(i, j) =
          (m_A.coeff(i, j) - tmp) / (result.coeff(i, i) + result.coeff(j, j));
    }
  }
}
...
class MatrixSquareRoot<MatrixType, 0> {
 public:
  MatrixSquareRoot(const MatrixType& A) : m_A(A) {
    eigen_assert(A.rows() == A.cols());
  }
