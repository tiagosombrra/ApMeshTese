...
struct SkylineProductReturnType {
  typedef const typename internal::nested<Lhs, Rhs::RowsAtCompileTime>::type
      LhsNested;
  typedef const typename internal::nested<Rhs, Lhs::RowsAtCompileTime>::type
      RhsNested;
...
struct internal::traits<SkylineProduct<LhsNested, RhsNested, ProductMode> > {
  ...
  typedef typename internal::conditional<
      ...
      MatrixBase<SkylineProduct<LhsNested, RhsNested, ProductMode> > >::type
      Base;
};
