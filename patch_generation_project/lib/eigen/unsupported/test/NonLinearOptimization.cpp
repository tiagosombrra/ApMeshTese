...
void testNistLanczos1(void) {
  ...
  // check norm^2
  VERIFY_IS_APPROX(lm.fvec.squaredNorm(),
                   1.430899764097e-25);  // should be 1.4307867721E-25, but nist
                                         // results are on 128-bit floats
  // check x
  ...
  // check norm^2
  VERIFY_IS_APPROX(lm.fvec.squaredNorm(),
                   1.428595533845e-25);  // should be 1.4307867721E-25, but nist
                                         // results are on 128-bit floats
  // check x
  VERIFY_IS_APPROX(x[0], 9.5100000027E-02);
  VERIFY_IS_APPROX(x[1], 1.0000000001E+00);
