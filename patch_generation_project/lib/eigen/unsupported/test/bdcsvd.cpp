...
void bdcsvd_compare_to_full(const MatrixType& m,
  ...
  svd_compare_to_full<MatrixType, BDCSVD<MatrixType> >(m, computationOptions,
                                                       referenceSvd);
...
void test_bdcsvd() {
  ...
  CALL_SUBTEST_14(
      (bdcsvd_verify_assert<Matrix<std::complex<double>, Dynamic, Dynamic> >(
          Matrix<std::complex<double>, Dynamic, Dynamic>(22, 22))));
  CALL_SUBTEST_14(
      (compare_bdc_jacobi<Matrix<std::complex<double>, Dynamic, Dynamic> >(
  ...
  CALL_SUBTEST_7((bdcsvd<MatrixXf>(MatrixXf(
  ...
  CALL_SUBTEST_8((bdcsvd<MatrixXcd>(MatrixXcd(
