...
int main(int argc, char* argv[]) {
...
#ifdef __APPLE__
  // VectorTuple48d vectorPoints =
  // reader.fileReadingRIB("../../entrada/cone.rib");
  //  VectorTuple48d vectorPoints =
  //  reader.fileReadingOBJ("/Users/tiagosombra/Documents/teaspoon.obj");
  // VectorTuple48d vectorPoints =
  // reader.readerObjOriginalTeapot("/Users/tiagosombra/Documents/teapot.obj");
  VectorTuple48d vectorPoints = reader.fileReadingOBJ_Surface_Order(
      "/Users/tiagosombra/Dropbox/tiago/ufc/MestradoTiago/GitHub/TMeshSurf/"
      "genBezierPatches/projeto/linux/entrada/monte_everest.obj");

#else
  // VectorTuple48d vectorPoints =
  // reader.convertRIBintoOBJ("../../entrada/cone.rib");
  //  VectorTuple48d vectorPoints =
  //  reader.fileReadingOBJ("../../entrada/4_patches_subdivisao.obj");
  // VectorTuple48d vectorPoints =
  // reader.fileReadingPatchesSiqueira("../../entrada/uteapot.siq");
  ...
  write.writeBPFile(
      "/Users/tiagosombra/Dropbox/tiago/ufc/MestradoTiago/GitHub/TMeshSurf/"
      "genBezierPatches/projeto/linux/saida/monte_ruapehu.bp",
      reader.convertBP(vectorPoints));
  cout << "SUCESSO >>> ARQUIVO SALVO." << endl;
#else
  // genWriter.writerPatchBezier("/home/tiago/Ufc/GitHub/apMesh/auxiliares/modelagem_patches/exemplos/boneco.pt",
  // genPatch.reduceAllPatches(genPatch.readerPatchesBezier(vectorPointsMesh),
  // SizeSubDivPatches));
  // write.writerPTFile("../../saida/cone.pt", vectorPoints);
